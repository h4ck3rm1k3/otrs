...
# --
# $Id: EmailParser.pm,v 1.51 2007/09/13 01:53:28 martin Exp $
# --
...
sub CheckMessageBody {
    ...
    if ($Self->GetReturnContentType() =~ /text\/html/i) {
        ...
        $Self->{MessageBody} =~ s/(&\#[xX]([0-9a-fA-F]+);?)/my $c = hex($2); $c < 256 ? chr($c) : $1/eg;
...
$Revision: 1.51 $ $Date: 2007/09/13 01:53:28 $
