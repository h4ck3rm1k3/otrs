...
# --
# $Id: Ticket.pm,v 1.346.2.2 2008/10/13 13:23:24 martin Exp $
# --
...
$VERSION = qw($Revision: 1.346.2.2 $) [1];
    ...
    if ( !$Escalation{FirstResponseTime} ) {
        ...
        $Self->{DBObject}->Prepare(
            SQL => 'SELECT a.create_time,a.id FROM'
                ...
                . ' a.ticket_id = ? AND'
                . ' ast.name = \'agent\' AND'
                . ' (art.name LIKE \'email-ext%\' OR art.name LIKE \'note-ext%\' OR art.name = \'phone\' OR art.name = \'fax\' OR art.name LIKE \'sms\')'
...
$Revision: 1.346.2.2 $ $Date: 2008/10/13 13:23:24 $
