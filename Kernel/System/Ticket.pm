...
# --
# $Id: Ticket.pm,v 1.510 2011/07/12 14:20:19 martin Exp $
# --
...
sub TicketSearch {
    ...
    my $SQL;
    if ( $Result eq 'COUNT' ) {
        $SQL = 'SELECT COUNT(DISTINCT(st.id, st.tn))';
...
$Revision: 1.510 $ $Date: 2011/07/12 14:20:19 $
