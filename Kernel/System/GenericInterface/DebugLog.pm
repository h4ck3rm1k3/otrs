...
# --
# $Id: DebugLog.pm,v 1.9 2011/02/24 18:41:13 cg Exp $
# --
...
sub LogDelete {
    ...
    my $SQLIndividual =
        'DELETE gdec FROM gi_debugger_entry_content AS gdec, gi_debugger_entry AS gde
...
$Revision: 1.9 $ $Date: 2011/02/24 18:41:13 $
