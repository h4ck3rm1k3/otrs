...
sub _GetTos {
    ...
    _CheckParam(\%Param, qw[Action QueueID UserID]);
...
sub _GetScreenElements {
    ...
    _CheckParam(\%Param, qw[Action QueueID]);
...
sub _GetComposeDefaults {
    ...
    if ( $Data{ReplyTo} ) {
        ...
        # try to remove some wrong text to from line (by way of regex)
