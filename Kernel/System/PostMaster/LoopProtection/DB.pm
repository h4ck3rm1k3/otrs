...
# --
# $Id: DB.pm,v 1.10 2007/10/02 10:34:46 mh Exp $
# --
...
sub SendEmail {
        ...
        )
    {
        ...
        # delete old enrties
        $Self->{DBObject}->Do( SQL => "DELETE FROM ticket_loop_protection WHERE "
...
sub Check {
    ...
    my $SQL
        = "SELECT count(*) FROM ticket_loop_protection "
        . " WHERE "
        . " sent_to = '"
        . $Self->{DBObject}->Quote($To) . "' " . " AND "
        . " sent_date = '$Self->{LoopProtectionDate}'";
