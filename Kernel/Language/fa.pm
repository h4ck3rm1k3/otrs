...
# --
# $Id: fa.pm,v 1.28 2007/09/29 10:36:40 mh Exp $
# --
...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'Please answer this ticket(s) to get back to the normal queue view!' =>
            'لطفا برای بازگشت به نمایش عادی صف تیکت ها به این تیکت پاسخ دهید!',
        ...
        'The recommended charset for your language is %s!' =>
            'charset پیشنهادی برای زبان شما  %s است!',
        'Passwords doesn\'t match! Please try it again!' =>
            'رمز عبور ها یکسان نیست لطفا مجددا سعی نمائید!',
        'Password is already in use! Please use an other password!' =>
            'این رمز عبور در حال استفاده است لطفا آنرا تغییر دهید!',
        'Password is already used! Please use an other password!' =>
            'این رمز عبور در حال استفاده است لطفا آنرا تغییر دهید!',
        'You need to activate %s first to use it!' =>
            'شما برای استفاده  %s ابتدا میبایست آنرا فعال نمائید!',
        'No suggestions' => 'هیچ پیشنهادی وجود ندارد',
        'Word'           => 'کلمه',
        'Ignore'         => 'صرف نظر',
        'replace with'   => 'جایگزین کن با',
        'There is no account with that login name.' =>
            'هیچ حسابی با نام کاربری وارد شده مطابقت ندارد',
        'Login failed! Your username or password was entered incorrectly.' =>
            'ورود ناموفق . اطلاعات وارد شده صحیح نمیباشد.',
        'Please contact your admin' => 'لطفا با مدیر سیستم تماس بگیرید',
        'Logout successful. Thank you for using OTRS!' =>
            'خروج با موفقیت انجام گرفت . از استفاده از سیستم پشتیبانی سورس باز متشکریم.',
        ...
        'Don\'t work with UserID 1 (System account)! Create new users!' =>
            'با نام کاربری سیستم کار نکنید برای ادامه یک نام کاربری جدید ایجاد نمائید.!',
        'Dispatching by email To: field.' =>
            'ارسال با پست الکترونیکی به:فیلد',
        'Dispatching by selected Queue.' => 'ارسال بوسیله صف انتخاب شده',
        'No entry found!'                => 'موردی پیدا نشد!',
        'Session has timed out. Please log in again.' =>
            'مهلت Session شما به اتمام رسید . لطفا مجددا وارد سیستم شوید..',
        'No Permission!' => 'دسترسی به این قسمت امکانپذیر نیست!',
        'To: (%s) replaced with database email!' =>
            'به: (%s) با آدرس e-mail موجود در بانک جایگزین شد!',
        ...
        'Select your QueueView refresh time.' =>
            'زمان بازیابی مجدد صف را انتخاب نمائید',
        ...
        'Select your frontend Theme.' =>
            'الگوی نمایش رابط را انتخاب نمائید',
        'Select your frontend QueueView.' =>
            'رابط نمایش صف را انتخاب نمائید',
        'Spelling Dictionary' => 'دیکشنری غلط یابی',
        'Select your default spelling dictionary.' =>
            'دیکشنری غلط یابی خود را انتخاب نمائید',
        'Max. shown Tickets a page in Overview.' =>
            'حداکثر تعداد نمایش تیکت ها در پیش نمایش',
        ...
        'Can\'t update password, need min. 8 characters!' =>
            'حداقل طول رمز عبور 8 رقم میباشد!',
        'Can\'t update password, need 2 lower and 2 upper characters!' =>
            'دست کم 2 حرف کوچک و 2 حرف بزرگ میبایست در رمز عبور استفاده شود!',
        'Can\'t update password, need min. 1 digit!' =>
            'دست کم 1 عدد مورد نیاز است!',
        'Can\'t update password, need min. 2 characters!' =>
            'دست کم 2 کاراکتر مورد نیاز است!',
        ...
        'No such Ticket Number "%s"! Can\'t link it!' =>
            'این شماره تیکت وجود ندارد "%s"! نمایش این تیکت امکانپذیر نیست',
        ...
        'Lock it to work on it!' =>
            'برای کار روی تیکت آن را در اختیار بگیرید',
        'Unlock to give it back to the queue!' =>
            'برای بازگرداندن تیکت به لیست آن را آزاد کنید',
        ...
        'Link this ticket to an other objects!' =>
            'این تیکت را به شیء دیگری لینک کن',
        ...
        'Your email with ticket number "<OTRS_TICKET>" is merged to "<OTRS_MERGE_TO_TICKET>".' =>
            'پیام شما با شماره تیکت  "<OTRS_TICKET>" با  "<OTRS_MERGE_TO_TICKET>" ادغام گردید.',
        ...
        'Send me a notification if there is a new ticket in "My Queues".' =>
            'دریافت تیکت جدید را به من اطلاع بده.',
        ...
        'Ticket lock timeout notification' =>
            'زمان اتمام مهلت در اختیار بودن تیکت به من اطلاع بده',
        'Send me a notification if a ticket is unlocked by the system.' =>
            'اگر تیکت توسط سیستم آزاد شد به من اطلاع بده',
        'Move notification' => 'اعلان جابجایی',
        'Send me a notification if a ticket is moved into one of "My Queues".' =>
            'انتقال یک تیکت به لیست تیکت های من را اطلاع بده.',
        'Your queue selection of your favourite queues. You also get notified about those queues via email if enabled.'
            => 'شما از طریق email از وضعیت لیست خود مطلع خواهید شد - در صورتیکه این گزینه در سیستم فعال باشد',
        'Custom Queue'           => 'لیست سفارشی',
        'QueueView refresh time' => 'زمان بازیابی لیست تیکت ها',
        'Screen after new ticket' =>
            'وضعیت نمایش پس از دریافت تیکت جدید',
        'Select your screen after creating a new ticket.' =>
            'وضعیت نمایش را بعد از تیکت جدید انتخاب کنید.',
        'Closed Tickets'       => 'تیکت بسته شده',
        'Show closed tickets.' => 'نمایش تیکت های بسته',
        'Max. shown Tickets a page in QueueView.' =>
            'حداکثر تعداد تیکت هادر صفحه نمایش',
        ...
        'This values are read only.' =>
            'این مقادیر فقط قابل خواندن هستند.',
        ...
        'Customer user will be needed to have a customer history and to login via customer panel.'
            => 'نام کاربری مشترکین برای ورود به سیستم مورد استفاده قرار خوهد گرفت',
        ...
        'Select the user:group permissions.' =>
            'حقوق دسترسی کاربر:گروه را انتخاب نمائید',
        'If nothing is selected, then there are no permissions in this group (tickets will not be available for the user).'
            => 'اگر هیچ گزینه ای انتخاب نشده باشد دسترسی به تیکت ها برای این گروه امکانپذیر نخواهد بود.',
        'Permission' => 'حقوق دسترسی',
        'ro'         => 'فقط خواندنی',
        'Read only access to the ticket in this group/queue.' =>
            'حق فقط خواندنی برای تیکت ها در این گروه /لیست.',
        'rw' => 'خواندنی و نوشتنی',
        ...
        'This command will be executed. ARG[0] will be the ticket number. ARG[1] the ticket id.' =>
            'این دستور اجرا خواهد شد. ARG[0] شماره تیکت و ARG[1] id آن خواهد بود.',
        'Delete tickets' => 'حذف تیکت ها',
        'Warning! This tickets will be removed from the database! This tickets are lost!' =>
            'توجه !این تیکت ها از بانک حذف خواهد شد . ',
        'Send Notification'                                               => '',
        'Param 1'                                                         => 'پارامتر 1',
        'Param 2'                                                         => 'پارامتر 2',
        'Param 3'                                                         => 'پارامتر 3',
        ...
        'The admin group is to get in the admin area and the stats group to get stats area.' =>
            'گروه admin برای دسترسی به محیط مدیریت سیستم میباشد.',
        ...
        'It\'s useful for ASP solutions.' =>
            'این مورد برای راه حل های ASP مناسب میباشد.',
        ...
        'Notifications are sent to an agent or a customer.' =>
            'اعلان به یک کارشناس یا مشترک ارسال شد.',
        ...
        'In this way you can directly edit the keyring configured in SysConfig.' =>
            'از این طریق شما میتوانید مستقیما کلید های خود را درسیستم تنظیم نمائید',
        ...
        'All incoming emails with one account will be dispatched in the selected queue!' =>
            'همه نامه ها از طریق یک آدرس به لیست تیکت ها منتقل خواهد شد !',
        'If your account is trusted, the already existing X-OTRS header at arrival time (for priority, ...) will be used! PostMaster filter will be used anyway.'
            => 'درصورتیکه آدرس شما مجاز و قابل اطمینان باشد زمان دریافت در header سیستم اولویل را تعیین کرده و پیام ها ارسال خواهد شد',
        ...
        'Ticket lock after a follow up' =>
            'تیکت بعد از پیگیری در اختیار قرارگیرد',
        ...
        'If an agent locks a ticket and he/she will not send an answer within this time, the ticket will be unlock automatically. So the ticket is viewable for all other agents.'
            => 'اگر یک کارشناس تیکت را در اختیار بگیرد و در این مدت زمان نتواند به آن پاسخ دهد تیکت آزاد شده و به لیست باز میگردد و قابل دسترس سایر کارشناسان خواهد شد',
        'Escalation time' => 'زمان جابجایی',
        'If a ticket will not be answered in this time, just only this ticket will be shown.' =>
            'اگر این تیکت پاسخ داده نشود فقط این تیکت نمایش داده شود',
        'If a ticket is closed and the customer sends a follow up the ticket will be locked for the old owner.'
            => 'اگر یک تیکت بسته شود و مشترک دوباره آنرا پیگیری کند بطور خودکار دراختیار صاحب تیکت قرار خواهد گرفت',
        'Will be the sender address of this queue for email answers.' =>
            'آدرس ارسال کننده این لیست برای پاسخ email استفاده خواهد شد.',
        'The salutation for email answers.' => 'عنوان نام برای پاسخ email',
        'The signature for email answers.'  => 'امضاء email پاسخ',
        'OTRS sends an notification email to the customer if the ticket is moved.' =>
            'اگر تیکت به شخص دیگری منتقل شد سیستم با Email اطلاع خواهد داد.',
        'OTRS sends an notification email to the customer if the ticket state has changed.' =>
            'اگر وضعیت تیکت تغییر کرد سیستم با Email اطلاع خواهد داد',
        'OTRS sends an notification email to the customer if the ticket owner has changed.' =>
            'اگر صاحب تیکت تغییر کرد سیستم با Email اطلاع خواهد داد.',
        ...
        'Don\'t forget to add a new response a queue!' =>
            'فراموش نکنید که یک پاسخ به لیست اضافه کنید !',
        ...
        'Create a role and put groups in it. Then add the role to the users.' =>
            'ایجاد یک وظیفه.ابتدا گروه را در آن قرار بده سپس کاربرها را به آن اضافه کن',
        'It\'s useful for a lot of users and groups.' =>
            'این برای اکثر کاربران و گروه ها قابل استفاده است',

        # Template: AdminRoleGroupChangeForm
        'Roles <-> Groups Management' => 'مدیریت وظیفه <-> گروه',
        'move_into'                   => 'انتقال به',
        'Permissions to move tickets into this group/queue.' =>
            'مجوز انتقال تیکت به این گروه/لیست.',
        'create' => 'créer',
        'Permissions to create tickets in this group/queue.' =>
            'مجوز ایجاد تیکت در این گروه/لیست.',
        'owner' => 'صاحب',
        'Permissions to change the ticket owner in this group/queue.' =>
            'مجوز تغییرتیکت در این گروه/لیست.',
        'priority' => 'اولویت',
        'Permissions to change the ticket priority in this group/queue.' =>
            'مجوز تغییر اولویت تیکت در این گروه/لیست.',
        ...
        'Select the role:user relations.' =>
            'ارتبتط هر کاربر را با وظیفه مربوط به آن مشخص کنید',
        ...
        'User will be needed to handle tickets.' =>
            'کاربر نیاز خواهد داشت که تیکت ها را کنترل کند.',
        'Don\'t forget to add a new user to groups and/or roles!' =>
            'فراموش نکنید که کاربر میبایست به گروه و وظیفه مربوطه لینک شود',
        ...
        'Discard all changes and return to the compose screen' =>
            'همه تغییرات را نادیده بگیر و به صفحه ارسال بازگرد',
        ...
        'Do you really want to delete this Object?' =>
            'آیا واقعا قصد حذف این مورد را دارید؟',
        ...
        'Click here to report a bug!' =>
            'برای گزارش یک اشکال اینجا کلیک کنید !',
        ...
        'DB Host' =>
            'ÃÂ³ÃÂ±ÃÂÃÂ± ÃÂ¨ÃÂ§ÃÂÃÂ© ÃÂ§ÃÂ·ÃÂÃÂ§ÃÂ¹ÃÂ§ÃÂªÃÂ',
        'Change roles <-> groups settings' =>
            'ÃÂªÃÂºÃÂÃÂ± ÃÂªÃÂÃÂ¸ÃÂÃÂÃÂ§ÃÂª ÃÂÃÂ¸ÃÂÃÂÃÂ <-> ÃÂ¯ÃÂ±ÃÂÃÂ',
        'Ticket Number Generator' =>
            'ÃÂªÃÂÃÂÃÂÃÂ¯ ÃÂ©ÃÂÃÂÃÂ¯ÃÂ ÃÂ´ÃÂÃÂ§ÃÂ±ÃÂ ÃÂªÃÂÃÂ©ÃÂª ÃÂÃÂ§',
        '(Ticket identifier. Some people want toset this to e. g. \'Ticket#\', \'Call#\' or \'MyTicket#\')'
            => '(ÃÂÃÂ´ÃÂ®ÃÂµÃÂ ÃÂªÃÂÃÂ©ÃÂª ÃÂÃÂ§. ÃÂ§ÃÂ©ÃÂ«ÃÂ± ÃÂ©ÃÂ§ÃÂ±ÃÂ¨ÃÂ±ÃÂ§ÃÂ ÃÂÃÂ§ÃÂÃÂÃÂÃÂ¯ÃÂ§ÃÂ² ÃÂ§ÃÂÃÂ ÃÂªÃÂ±ÃÂ©ÃÂÃÂ¨ ÃÂ§ÃÂ³ÃÂªÃÂÃÂ§ÃÂ¯ÃÂ ÃÂ©ÃÂÃÂÃÂ¯ ÃÂÃÂ«ÃÂ§ÃÂ: \'ÃÂ´ÃÂÃÂ§ÃÂ±ÃÂ ÃÂªÃÂÃÂ©ÃÂª\', \'ÃÂÃÂ§ÃÂ ÃÂ´ÃÂ±ÃÂ©ÃÂª#\' ÃÂÃÂ§ \'ÃÂÃÂ§ÃÂ ÃÂ¯ÃÂÃÂ®ÃÂÃÂ§ÃÂ #\')',
        'In this way you can directly edit the keyring configured in Kernel/Config.pm.' =>
            'ÃÂªÃÂÃÂ¸ÃÂÃÂ ÃÂÃÂ³ÃÂªÃÂÃÂÃÂ ÃÂ©ÃÂÃÂÃÂ¯ ÃÂÃÂ§ Kernel/Config.pm',
        'Create new Phone Ticket' => 'Ø§ÛØ¬Ø§Ø¯ ØªÛÚ©Øª ØªÙÙÙÛ',
        'Symptom'                 => 'ÃÂÃÂ´ÃÂ§ÃÂÃÂ',
        'A message should have a To: recipient!' =>
            'Ø¢Ø¯Ø±Ø³ Ø¯Ø±ÛØ§ÙØª Ú©ÙÙØ¯Ù Ù¾ÛØ§Ù ÙØ´Ø®Øµ ÙØ´Ø¯Ù Ø§Ø³Øª!',
        'Site' => 'ÃÂ³ÃÂ§ÃÂÃÂª',
        'Customer history search (e. g. "ID342425").' =>
            'ÃÂ¬ÃÂ³ÃÂªÃÂ¬ÃÂ ÃÂ¯ÃÂ± ÃÂ³ÃÂÃÂ§ÃÂ¨ÃÂ ÃÂÃÂ´ÃÂªÃÂ±ÃÂ© (ÃÂÃÂ«ÃÂ§ÃÂ: "ID342425")',
        'Close!'              => 'ÃÂ¨ÃÂ³ÃÂªÃÂ!',
        'for agent firstname' => 'Ø¨Ø±Ø§Û ÙØ§Ù Ú©Ø§Ø±Ø´ÙØ§Ø³',
        'The message being composed has been closed.  Exiting.' =>
            'Ù¾ÛØ§ÙÛ Ú©Ù Ø§Ø±Ø³Ø§Ù Ø´Ø¯ Ø¨Ø³ØªÙ Ø´Ø¯.',
        'A web calendar' => 'ÛÚ© ØªÙÙÛÙ',
        'to get the realname of the sender (if given)' =>
            'Ø¨Ø±Ø§Û Ú¯Ø±ÙØªÙ ÙØ§Ù ÙØ±Ø³ØªÙØ¯Ù',
        'OTRS DB Name' =>
            'ÃÂÃÂ§ÃÂ ÃÂ¨ÃÂ§ÃÂÃÂ© ÃÂ§ÃÂ·ÃÂÃÂ§ÃÂ¹ÃÂ§ÃÂªÃÂ ÃÂ³ÃÂÃÂ³ÃÂªÃÂ',
        'Notification (Customer)' => '',
        'Select Source (for add)' =>
            'ÙÙØ¨Ø¹ Ø±Ø§ Ø§ÙØªØ®Ø§Ø¨ ÙÙØ§Ø¦ÛØ¯ (Ø¨Ø±Ø§Û Ø§ÙØ²ÙØ¯Ù)',
        ...
        'Home'     => 'ØµÙØ­Ù Ø§ÙÙ',
        'Config options (e. g. <OTRS_CONFIG_HttpType>)' =>
            'Ú¯Ø²ÛÙÙ ÙØ§Û ØªÙØ¸ÛÙØ§Øª ',
        'System History' =>
            'ÃÂ³ÃÂÃÂ§ÃÂ¨ÃÂ ÃÂ³ÃÂÃÂ³ÃÂªÃÂ',
        'customer realname' =>
            'ÙØ§Ù Ù ÙØ§Ù Ø®Ø§ÙÙØ§Ø¯Ú¯Û ÙØ´ØªØ±Ú©',
        'Pending messages' => 'Ù¾ÛØ§ÙÙØ§Û Ø¯Ø± ØªØ¹ÙÛÙ',
        'Modules'          => 'ÃÂÃÂ§ÃÂÃÂÃÂ ÃÂÃÂ§',
        'for agent login' =>
            'Ø¨Ø±Ø§Û ÙØ±ÙØ¯ Ú©Ø§Ø±Ø´ÙØ§Ø³ Ø¨Ù Ø³ÛØ³ØªÙ',
        'Keyword'    => 'ÃÂ©ÃÂÃÂÃÂ ÃÂ©ÃÂÃÂÃÂ¯ÃÂ',
        'Close type' => 'ÃÂÃÂÃÂ¹ ÃÂ¨ÃÂ³ÃÂªÃÂ',
        'DB Admin User' =>
            'ÃÂÃÂ§ÃÂ ÃÂ©ÃÂ§ÃÂ±ÃÂ¨ÃÂ±ÃÂ ÃÂÃÂ¯ÃÂÃÂ± ÃÂ¨ÃÂ§ÃÂÃÂ© ÃÂ§ÃÂ·ÃÂÃÂ§ÃÂ¹ÃÂ§ÃÂªÃÂ ',
        'for agent user id' =>
            'Ø¨Ø±Ø§Û Ú©Ø¯ Ú©Ø§Ø±Ø¨Ø±Û Ú©Ø§Ø±Ø´ÙØ§Ø³',
        'sort upward' => 'ØµØ¹ÙØ¯Û',
        'Change user <-> group settings' =>
            'ÃÂªÃÂºÃÂÃÂÃÂ± ÃÂªÃÂÃÂ¸ÃÂÃÂÃÂ§ÃÂª ÃÂ©ÃÂ§ÃÂ±ÃÂ¨ÃÂ± <-> ÃÂ¯ÃÂ±ÃÂÃÂ',
        'Problem'   => 'ÃÂÃÂ´ÃÂ©ÃÂ',
        'next step' => 'ÃÂÃÂ¯ÃÂ ÃÂ¨ÃÂ¹ÃÂ¯ÃÂ',
        'Customer history search' =>
            'ÃÂ¬ÃÂ³ÃÂªÃÂ¬ÃÂ ÃÂ¯ÃÂ± ÃÂ³ÃÂÃÂ§ÃÂ¨ÃÂ ÃÂÃÂ´ÃÂªÃÂ±ÃÂ©',
        'Admin-Email' =>
            'e-mail ÃÂÃÂ¯ÃÂÃÂ± ÃÂ³ÃÂÃÂ³ÃÂªÃÂ',
        'Create new database' =>
            'ÃÂ§ÃÂÃÂ¬ÃÂ§ÃÂ¯ ÃÂ¨ÃÂ§ÃÂÃÂ© ÃÂ¬ÃÂ¯ÃÂÃÂ¯',
        'A message must be spell checked!' =>
            'Ù¾ÛØ§Ù Ø¨Ø§ÛØ¯ ØºÙØ· ÛØ§Ø¨Û Ø´Ø¯Ù Ø¨Ø§Ø´Ø¯!',
        ...
        'Your email with ticket number "<OTRS_TICKET>" is bounced to "<OTRS_BOUNCE_TO>". Contact this address for further informations.'
            => 'Ù¾ÛØ§Ù Ø´ÙØ§ Ø¯Ø± ØªÛÚ©Øª Ø¨Ù Ø´ÙØ§Ø±Ù "<OTRS_TICKET> Ø§Ø±Ø¬Ø§Ø¹ Ø´Ø¯ Ø¨Ù "<OTRS_BOUNCE_TO>". Ø¨Ø±Ø§Û Ø§Ø·ÙØ§Ø¹Ø§Øª Ø¨ÛØ´ØªØ± Ø¨Ø§ Ø§ÛÙ Ø¢Ø¯Ø±Ø³ ØªÙØ§Ø³ Ø¨Ú¯ÛØ±ÛØ¯',
        ...
        'Message for new Owner' =>
            'ÃÂ¾ÃÂÃÂ§ÃÂ ÃÂ¨ÃÂ±ÃÂ§ÃÂ ÃÂµÃÂ§ÃÂ­ÃÂ¨ ÃÂ¬ÃÂ¯ÃÂÃÂ¯ ÃÂªÃÂÃÂ©ÃÂª',
        'to get the first 5 lines of the email' =>
            'Ø¨Ø±Ø§Û Ú¯Ø±ÙØªÙ 5 Ø®Ø· Ø§ÙÙ email',
        'OTRS DB Password' =>
            'ÃÂ±ÃÂÃÂ² ÃÂ¹ÃÂ¨ÃÂÃÂ± ÃÂ¨ÃÂ§ÃÂÃÂ© ÃÂ§ÃÂ·ÃÂÃÂ§ÃÂ¹ÃÂ§ÃÂªÃÂ ÃÂ³ÃÂÃÂ³ÃÂªÃÂ',
        'Last update' =>
            'ÃÂ¢ÃÂ®ÃÂ±ÃÂÃÂ ÃÂ¨ÃÂ±ÃÂÃÂ²ÃÂ±ÃÂ³ÃÂ§ÃÂÃÂ',
        'to get the first 20 character of the subject' =>
            'Ø¨Ø±Ø§Û Ú¯Ø±ÙØªÙ 20 Ú©Ø§Ø±Ø§Ú©ØªØ± Ø§ÙÙ ÙÙØ¶ÙØ¹',
        'DB Admin Password' =>
            'ÃÂ±ÃÂÃÂ² ÃÂ¹ÃÂ¨ÃÂÃÂ± ÃÂÃÂ¯ÃÂÃÂ± ÃÂ³ÃÂÃÂ³ÃÂªÃÂ',
        'Drop Database' =>
            'ÃÂ­ÃÂ°ÃÂ ÃÂ©ÃÂ§ÃÂÃÂ ÃÂ¨ÃÂ§ÃÂÃÂ© ÃÂ§ÃÂ·ÃÂÃÂ§ÃÂ¹ÃÂ§ÃÂªÃÂ',
        'Advisory'    => 'ÙØ´ÙØ±ØªÛ',
        'FileManager' => 'ÙÛØ±ÛØª ÙØ§ÛÙ',
        'Options of the current customer user data (e. g. <OTRS_CUSTOMER_DATA_UserFirstname>)' =>
            'Ú¯Ø²ÛÙÙ ÙØ§Û ÙØ´ØªØ±Ú© ÙØ¹ÙÛ',
        'Pending type' => 'ÃÂÃÂÃÂ¹ ÃÂªÃÂ¹ÃÂÃÂÃÂ',
        'Comment (internal)' =>
            'ÃÂªÃÂÃÂ¶ÃÂÃÂ­ ÃÂ¯ÃÂ§ÃÂ®ÃÂÃÂ',
        'Ticket owner options (e. g. &lt;OTRS_OWNER_USERFIRSTNAME&gt;)' => '',
        'This window must be called from compose window' =>
            'Ø§ÛÙ Ù¾ÙØ¬Ø±Ù ÙÛØ¨Ø§ÛØ³Øª Ø§Ø² Ø·Ø±ÛÙ Ù¾ÙØ¬Ø±Ù Ø§Ø±Ø³Ø§Ù ÙØ±Ø§Ø®ÙØ§ÙÛ Ø´ÙØ¯',
        'You need min. one selected Ticket!' =>
            'Ø´ÙØ§ Ø¯Ø³Øª Ú©Ù Ø¨Ù ÛÚ© ØªÛÚ©Øª Ø§ÙØªØ®Ø§Ø¨ Ø´Ø¯Ù ÙÛØ§Ø² Ø¯Ø§Ø±ÛØ¯!',
        'Options of the ticket data (e. g. <OTRS_TICKET_Number>, <OTRS_TICKET_ID>, <OTRS_TICKET_Queue>, <OTRS_TICKET_State>)'
            => 'Ú¯Ø²ÛÙÙ ÙØ§Û Ø§Ø·ÙØ§Ø¹Ø§Øª ØªÛÚ©Øª ÙØ§',
        '(Used ticket number format)' =>
            '(ÃÂÃÂ±ÃÂÃÂª ÃÂ´ÃÂÃÂ§ÃÂ±ÃÂ ÃÂªÃÂÃÂ©ÃÂª)',
        'Fulltext' => 'ÃÂªÃÂÃÂ§ÃÂ ÃÂÃÂªÃÂ',
        'Incident' => 'Ø±ÙÛØ¯Ø§Ø¯',
        'OTRS DB connect host' =>
            'ÃÂ³ÃÂ±ÃÂÃÂ± ÃÂÃÂÃÂ²ÃÂ¨ÃÂ§ÃÂ ÃÂ¨ÃÂ§ÃÂÃÂ© ÃÂ§ÃÂ·ÃÂÃÂ§ÃÂ¹ÃÂ§ÃÂªÃÂ ',
        ' (work units)' => ' ÙØ§Ø­Ø¯ Ú©Ø§Ø±',
        'All Customer variables like defined in config option CustomerUser.' =>
            'ÙÙÙ ØªÙØ¸ÛÙØ§Øª ÙØ´ØªØ±Ú©ÛÙ Ø¯Ø± ÙØ§ÛÙ ØªÙØ¸ÛÙØ§Øª Ø³ÛØ³ØªÙ Ø°Ø®ÛØ±Ù Ø´Ø¯Ù Ø§Ø³Øª',
        'accept license' => 'Accepter la licence',
        'for agent lastname' =>
            'Ø¨Ø±Ø§Û ÙØ§Ù Ø®Ø§ÙÙØ§Ø¯Ú¯Û Ú©Ø§Ø±Ø´ÙØ§Ø³',
        'Options of the current user who requested this action (e. g. <OTRS_CURRENT_UserFirstname>)'
            => 'Ú¯Ø²ÛÙÙ ÙØ§Û ØªÙØ¸ÛÙØ§Øª ØµØ§Ø­Ø¨ ØªÛÚ©Øª',
        'Reminder messages' => 'Ù¾ÛØ§ÙÙØ§Û ÛØ§Ø¯Ø¢ÙØ±Û',
        'Change users <-> roles settings' =>
            'ÃÂªÃÂºÃÂÃÂÃÂ± ÃÂªÃÂÃÂ¸ÃÂÃÂÃÂ§ÃÂª ÃÂ©ÃÂ§ÃÂ±ÃÂ¨ÃÂ± <-> ÃÂÃÂ¸ÃÂÃÂÃÂ',
        'A message should have a subject!' =>
            'یک پیام میبایست دارای عنوان باشد',
        'TicketZoom' =>
            'ÃÂÃÂÃÂ§ÃÂÃÂ´ ÃÂ©ÃÂ§ÃÂÃÂ ÃÂªÃÂÃÂ©ÃÂª',
        ...
        'You need a email address (e. g. customer@example.com) in To:!' =>
            'Ø¢Ø¯Ø±Ø³ email ÙØ§Ø±Ø¯ Ø´Ø¯Ù ÙØ¹ØªØ¨Ø± ÙÛØ³Øª!',
        'CreateTicket' =>
            'ÃÂ§ÃÂÃÂ¬ÃÂ§ÃÂ¯ ÃÂªÃÂÃÂ©ÃÂª',
        'You need to account time!' => 'شما نیاز به محاسبه زمان دارید!',
        'System Settings' =>
            'ÃÂªÃÂÃÂ¸ÃÂÃÂÃÂ§ÃÂª ÃÂ³ÃÂÃÂ³ÃÂªÃÂ',
        ...
        'A web mail client' =>
            'ÛÚ© ÙØ­ÛØ· Ù¾Ø³Øª Ø§ÙÚ©ØªØ±ÙÙÛÚ©Û',
        'WebMail' => 'Ù¾Ø³Øª Ø§ÙÚ©ØªØ±ÙÙÛÚ©Û ØªØ­Øª ÙØ¨',
        'Options of the ticket data (e. g. <OTRS_TICKET_TicketNumber>, <OTRS_TICKET_TicketID>, <OTRS_TICKET_Queue>, <OTRS_TICKET_State>)'
            => 'ÃÂ¯ÃÂ²ÃÂÃÂÃÂ ÃÂÃÂ§ÃÂ ÃÂ§ÃÂ·ÃÂÃÂ§ÃÂ¹ÃÂ§ÃÂª ÃÂªÃÂÃÂ©ÃÂª',
        'Ticket owner options (e. g. <OTRS_OWNER_UserFirstname>)' =>
            'Options du propriÃ©taire d\'un ticket (ex: <OTRS_OWNER_UserFirstname>)',
        'Name is required!' =>
            'ÃÂÃÂ§ÃÂ ÃÂÃÂÃÂ±ÃÂ¯ ÃÂÃÂÃÂ§ÃÂ² ÃÂ§ÃÂ³ÃÂª!',
        'DB Type' =>
            'ÃÂÃÂÃÂ¹ ÃÂ¨ÃÂ§ÃÂÃÂ© ÃÂ§ÃÂ·ÃÂÃÂ§ÃÂ¹ÃÂ§ÃÂªÃÂ ÃÂ³ÃÂÃÂ³ÃÂªÃÂ',
        'kill all sessions' =>
            'ÙÙÙ Session ÙØ§ Ø±Ø§ Ø§Ø² Ø¨ÛÙ Ø¨Ø¨Ø±',
        'to get the from line of the email' =>
            'Ø¨Ø±Ø§Û Ú¯Ø±ÙØªÙ Ø®Ø· (Ø§Ø²) email',
        'Solution'  => 'ÃÂ±ÃÂ§ÃÂ ÃÂ­ÃÂ',
        'QueueView' => 'ÃÂÃÂÃÂ§ÃÂÃÂ´ ÃÂÃÂÃÂ³ÃÂª',
        'Welcome to OTRS' =>
            'Ø¨Ù Ø³ÛØ³ØªÙ Ù¾Ø´ØªÛØ¨Ø§ÙÛ Ø³ÙØ±Ø³ Ø¨Ø§Ø² Ø®ÙØ´ Ø¢ÙØ¯ÛØ¯',
        'modified' => 'ÃÂªÃÂºÃÂÃÂÃÂ± ÃÂÃÂ§ÃÂÃÂª',
        'Delete old database' =>
            'ÃÂ­ÃÂ°ÃÂ ÃÂ¨ÃÂ§ÃÂÃÂ© ÃÂÃÂ¨ÃÂÃÂ',
        'sort downward' => 'ÙØ²ÙÙÛ',
        'You need to use a ticket number!' =>
            'Ø´ÙØ§ Ø¨Ø§ÛØ¯ Ø§Ø² Ø´ÙØ§Ø±Ù ØªÛÚ©Øª Ø§Ø³ØªÙØ§Ø¯Ù ÙÙØ§Ø¦ÛØ¯!',
        'A web file manager' =>
            'ÛÚ© ÙØ­ÛØ· ÙØ¯ÛØ±ÛØª ÙØ§ÛÙ ØªØ­Øª ÙØ¨',
        'send'      => 'Ø§Ø±Ø³Ø§Ù',
        'Note Text' => 'ÃÂÃÂ§ÃÂ¯ÃÂ¯ÃÂ§ÃÂ´ÃÂª',
        'Options of the current customer user data (e. g. &lt;OTRS_CUSTOMER_DATA_USERFIRSTNAME&gt;)'
            => '',
        'System State Management' =>
            'ÙØ¯ÛØ±ÛØª ÙØ¶Ø¹ÛØª Ø³ÛØ³ØªÙ',
        'OTRS DB User' =>
            'ÃÂÃÂ§ÃÂ ÃÂ©ÃÂ§ÃÂ±ÃÂ¨ÃÂ±ÃÂ ÃÂ¨ÃÂ§ÃÂÃÂ© ÃÂ§ÃÂ·ÃÂÃÂ§ÃÂ¹ÃÂ§ÃÂªÃÂ ÃÂ³ÃÂÃÂ³ÃÂªÃÂ',
        'PhoneView' => 'ÃÂÃÂÃÂ§ÃÂÃÂ´ ÃÂªÃÂÃÂÃÂ',
        'Verion'    => 'ÃÂÃÂÃÂ±ÃÂ§ÃÂÃÂ´',
        'TicketID'  => 'شماره تیکت',
        'Modified' =>
            'ÃÂªÃÂºÃÂÃÂÃÂ± ÃÂÃÂ§ÃÂÃÂªÃÂ',
        'Ticket selected for bulk action!' =>
            'ØªÛÚ©Øª Ø¬ÙØª Ø¹ÙÙÛØ§Øª Ú©ÙÛ Ø§ÙØªØ®Ø§Ø¨ Ú¯Ø±Ø¯ÛØ¯!',
    };
