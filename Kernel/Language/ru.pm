...
# --
# $Id: ru.pm,v 1.55 2008/05/15 12:49:32 tr Exp $
# --
...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'The recommended charset for your language is %s!' =>
            'Рекомендуемая кодировка для вашего языка %s',
        'Passwords doesn\'t match! Please try it again!' => 'Неверный пароль!',
        'Password is already in use! Please use an other password!' =>
            'Пароль уже используется! Попробуйте использовать другой пароль',
        'Password is already used! Please use an other password!' =>
            'Пароль уже использовался! Попробуйте использовать другой пароль',
        'You need to activate %s first to use it!' =>
            'Вам необходимо сначало активировать %s чтобы использовать это',
        ...
        'Login failed! Your username or password was entered incorrectly.' =>
            'Неуспешная авторизация! Ваше имя или пароль неверны!',
        'Please contact your admin' => 'Свяжитесь с администратором',
        'Logout successful. Thank you for using OTRS!' =>
            'Выход успешен. Благодарим за пользование системой OTRS',
        ...
        'Session has timed out. Please log in again.' =>
            'Сессия завершена. Попробуйте войти заново.',
        ...
        'Security Note: You should activate %s because application is already running!' =>
            'Заметка о безопасности: Вы должны активировать %s т.к. приложение уже запущено!',
        'Unable to parse Online Repository index document!' =>
            'Невозможно распарсить индексный файл Онлайн Репозитория!',
        'No Packages for requested Framework in this Online Repository, but Packages for other Frameworks!'
            => 'Нет пакетов для запрошенного Framework в этом Онлайн Репозитории, но есть пакеты для других Framework-ов!',
        'No Packages or no new Packages in selected Online Repository!' =>
            'Нет пакетов или новых пакетов в выбранном Онлайн Репозитории!',
        ...
        'Max. shown Tickets a page in Overview.' =>
            'Макс. кол-во Тикетов на странице при отображении очереди',
        'Can\'t update password, passwords doesn\'t match! Please try it again!' =>
            'Невозможно сменить пароль, пароли несоответствуют!',
        'Can\'t update password, invalid characters!' =>
            'Невозможно сменить пароль, неверная кодировка!',
        'Can\'t update password, need min. 8 characters!' =>
            'Невозможно сменить пароль, необходимо не менее 8 символов!',
        'Can\'t update password, need 2 lower and 2 upper characters!' =>
            'Невозможно сменить пароль, необходимо 2 символа в нижнем и 2 в верхнем регистрах!',
        'Can\'t update password, need min. 1 digit!' =>
            'Невозможно сменить пароль, должна писутствовать как минимум 1 цифра!',
        'Can\'t update password, need min. 2 characters!' =>
            'Невозможно сменить пароль, необходимо минимум 2 символа!',
        ...
        'Please select one element for the X-axis!' =>
            'Пожалуйста, выбирите один элемент для оси X',
        'You have to select two or more attributes from the select field!' =>
            'Вам необходимо выбрать два или более пунктов из выбранного поля!',
        'Please select only one element or turn off the button \'Fixed\' where the select field is marked!'
            => 'Пожалуйста, выбирите только один элемент или снимите флаг \'Fixed\' у выбранного поля!',
        'If you use a checkbox you have to select some attributes of the select field!' =>
            'Если вы используете чекбокс, вы должны выбрать несколько пунктов из выбранного поля!',
        'Please insert a value in the selected input field or turn off the \'Fixed\' checkbox!' =>
            'Пожалуйста, вставьте значение в выбранное поле или снимите флаг \'Fixed\'!',
        'The selected end time is before the start time!' =>
            'Выбранное время окончания до времени начала!',
        ...
        'Please select only one or two elements via the checkbox!' =>
            'Пожалуйста, выбирите только одини или два пункта используя чекбоксы',
        'If you use a time scale element you can only select one element!' =>
            'Если вы используете элемент временного интервала , вы можете выбрать только один элемент!',
        'You have an error in your time selection!' => 'Ошибка выбора времени',
        'Your reporting time interval is too small, please use a larger time scale!' =>
            'Временной интервал отчетности слишком мал, пожалуйста, выбирете больший интервал',
        'The selected start time is before the allowed start time!' =>
            'Выбранное время начала отчета выходит за пределы разрешенного!',
        'The selected end time is after the allowed end time!' =>
            'Выбранное время конца отчета выходит за пределы разрешенного!',
        ...
        'This is a HTML email. Click here to show it.' =>
            'Этот e-mail в HTML формате. Кликните здесь для просмотра',
        ...
        'No such Ticket Number "%s"! Can\'t link it!' =>
            'Заявки с номером "%s" не существует, невозможно слинковать ее!',
        ...
        'Create new Email Ticket and send this out (Outbound)' =>
            'Создать новую e-mail заявку и отослать ее',
        ...
        'Send me a notification if a customer sends a follow up and I\'m the owner of this ticket.'
            => 'Прислать мне уведомление, если клиент прислал обновление и я собственник заявки.',
        'Ticket lock timeout notification' =>
            'Уведомление о истечении срока блокировки заявки системой',
        ...
        'Your queue selection of your favourite queues. You also get notified about those queues via email if enabled.'
            => 'Выбор очередей, которые вас интересуют. Вы также будете уведомляться по email, если эта функция включена. ',
        ...
        'Select your screen after creating a new ticket.' =>
            'Выбирете раздел после создания новой заявки',
        'Closed Tickets'       => 'Закрытые заявки',
        'Show closed tickets.' => 'Показывать закрытые заявки',
        'Max. shown Tickets a page in QueueView.' =>
            'Макс. кол-во заявок на странице в Просмотре Очереди',
        ...
        'To get the realname of the sender (if given).' =>
            'Чтобы видеть реальное имя отправителя(если указано)',
        'To get the article attribute (e. g. (<OTRS_CUSTOMER_From>, <OTRS_CUSTOMER_To>, <OTRS_CUSTOMER_Cc>, <OTRS_CUSTOMER_Subject> and <OTRS_CUSTOMER_Body>).'
            => 'Чтобы видеть опции заявки (например (<OTRS_CUSTOMER_From>, <OTRS_CUSTOMER_To>, <OTRS_CUSTOMER_Cc>, <OTRS_CUSTOMER_Subject> и <OTRS_CUSTOMER_Body>).',
        'Options of the current customer user data (e. g. <OTRS_CUSTOMER_DATA_UserFirstname>).' =>
            'Опции текущих данных клиента (например <OTRS_CUSTOMER_DATA_UserFirstname>).',
        'Ticket owner options (e. g. <OTRS_OWNER_UserFirstname>).' =>
            'Опции владельца заявки (например <OTRS_OWNER_UserFirstname>).',
        'Ticket responsible options (e. g. <OTRS_RESPONSIBLE_UserFirstname>).' =>
            'Опции ответственного за заявку (например <OTRS_RESPONSIBLE_UserFirstname>).',
        'Options of the current user who requested this action (e. g. <OTRS_CURRENT_UserFirstname>).'
            => 'Опции текущего пользователя, который запросил это действие(например <OTRS_CURRENT_UserFirstname>).',
        'Options of the ticket data (e. g. <OTRS_TICKET_TicketNumber>, <OTRS_TICKET_TicketID>, <OTRS_TICKET_Queue>, <OTRS_TICKET_State>).'
            => 'Опции данных заявки (например <OTRS_TICKET_TicketNumber>, <OTRS_TICKET_TicketID>, <OTRS_TICKET_Queue>, <OTRS_TICKET_State>).',
        'Config options (e. g. <OTRS_CONFIG_HttpType>).' =>
            'Опции конфигурации (например <OTRS_CONFIG_HttpType>).',
        ...
        'Customer user will be needed to have a customer history and to login via customer panel.'
            => 'Клиентский пользователь понадобиться чтобы обладать клиентской историей и входить через пользовательский интерфейс',
        ...
        'If nothing is selected, then there are no permissions in this group (tickets will not be available for the user).'
            => 'Если ничего не выбрано, то в данной группе нет доступа(заявки будут недоступны для пользователя)',
        'Permission' => 'Права',
        'ro'         => 'Только чтение',
        'Read only access to the ticket in this group/queue.' =>
            'Права только на чтение заявки в данной группе/очереди',
        'rw' => 'Чтение/запись',
        ...
        'Fulltext-Search in Article (e. g. "Mar*in" or "Baue*")' =>
            'Полнотекстовый поиск в заявке (например "Mar*in" или "Baue*")',
        ...
        'This command will be executed. ARG[0] will be the ticket number. ARG[1] the ticket id.' =>
            'Эта команда будет выполнена. ARG[0] - номер тикета. ARG[1] - id тикета',
        'Delete tickets' => 'Удалить заявки',
        'Warning! This tickets will be removed from the database! This tickets are lost!' =>
            'Внимание! Данные заявки будут удалены из базы!',
        ...
        'Yes means, send no agent and customer notifications on changes.' =>
            'Да значит не отсылать уведомления пользователям и клиентам при изменениях',
        'No means, send agent and customer notifications on changes.' =>
            'Нет значит отсылать уведомления пользователям и клиентам при изменениях',
        'Save' => 'Сохранить',
        '%s Tickets affected! Do you really want to use this job?' =>
            '%s заявок будет модифицировано! Вы действительно хотите выполнить это задание?',
        '"}' => '',
        ...
        'The admin group is to get in the admin area and the stats group to get stats area.' =>
            'Группа admin должна быть в admin зоне, а stats группа в stat зоне',
        'Create new groups to handle access permissions for different groups of agent (e. g. purchasing department, support department, sales department, ...).'
            => 'Создать новые группы для контроля доступа различных групп агентов (отдел закупок, отдел продаж, отдел техподдержки и т.п.)',
        ...
        'Notifications are sent to an agent or a customer.' =>
            'Уведомления посланы пользовтелю или клиенту',
        ...
        'Do you really want to reinstall this package (all manual changes get lost)?' =>
            'Вы действительно хотите переустановить этот пакет (все ручные изменения будут утеряны)?',
        'Continue'                    => 'Продолжить',
        'Install'                     => 'Установить',
        'Package'                     => 'Пакет',
        ...
        'Just use this feature if you want to log each request.' =>
            'Просто используйте эту функцию если вы хотите логгировать каждый запрос',
        'Of couse this feature will take some system performance it self!' =>
            'Конечно, данная функция сама съедает немного ресурсов!',
        ...
        'Logfile too large, you need to reset it!' =>
            'Лог-файл слишком большой, вам нужно очистить его!',
        'Range'            => 'Промежуток',
        'Interface'        => 'Интерфейс',
        'Requests'         => 'Запросов',
        ...
        'In this way you can directly edit the keyring configured in SysConfig.' =>
            'В данном случае вы можете изменить "keyring" прямо в Конфигурации Системы',
        ...
        'All incoming emails with one account will be dispatched in the selected queue!' =>
            'Все входящие письма с едной учетной записи будут перенесены в избранную очередь!',
        'If your account is trusted, the already existing X-OTRS header at arrival time (for priority, ...) will be used! PostMaster filter will be used anyway.'
            => 'Если ваш акаунт безопасный, уже существующий хедер X-OTRS будет использован при доставке(для приоритета, ...)! Фильтр PostMaster будет использован в любом случае.',
        ...
        'Do dispatch or filter incoming emails based on email X-Headers! RegExp is also possible.'
            => 'Отправлять или фильтровать входящие письма опираясь на X-хедеры!Возможно использование регексопв.',
        'If you want to match only the email address, use EMAILADDRESS:info@example.com in From, To or Cc.'
            => 'Если вы хотите фильтровать только по email-адресам, используйте EMAILADDRESS:info@example.com в From, To или Cc.',
        'If you use RegExp, you also can use the matched value in () as [***] in \'Set\'.' =>
            'Если вы используете регекспы, вы можете также использовать переменные в () как [***] \'Set\'.',
        ...
        'If an agent locks a ticket and he/she will not send an answer within this time, the ticket will be unlock automatically. So the ticket is viewable for all other agents.'
            => 'Если агент заблокировал заявку и не послал ответ клиенту в течение установленного времени, то заявка автоматически разблокируется и станет доступной для остальных агентов',
        ...
        'If a ticket is closed and the customer sends a follow up the ticket will be locked for the old owner.'
            => 'Если заявка закрыта, а клиент прислал дополнение,то заявка будет заблокирована для предыдущего владельца',
        'Will be the sender address of this queue for email answers.' =>
            'Установка адреса отправителя для ответов в этой очереди',
        ...
        'OTRS sends an notification email to the customer if the ticket is moved.' =>
            'OTRS отправит уведомление клиенту при перемещении заявки',
        'OTRS sends an notification email to the customer if the ticket state has changed.' =>
            'OTRS отправит уведомление клиенту при изменении статуса заявки',
        'OTRS sends an notification email to the customer if the ticket owner has changed.' =>
            'OTRS отправит уведомление клиенту при смене владельца заявки',
        ...
        'A response is default text to write faster answer (with default text) to customers.' =>
            'Ответ - заготовка текста для ответа кклиенту',
        ...
        'Create a role and put groups in it. Then add the role to the users.' =>
            'Создайте роль и наложите ее на группы. Затем примените роль к пользователям.',
        'It\'s useful for a lot of users and groups.' =>
            'Это полезно при использовании множества пользователей и групп',

        # Template: AdminRoleGroupChangeForm
        'Roles <-> Groups Management' => 'Управление ролями в группах',
        'move_into'                   => 'переместить',
        'Permissions to move tickets into this group/queue.' =>
            'Права на перемещение заявок в эту группу/очередь',
        'create' => 'создание',
        'Permissions to create tickets in this group/queue.' =>
            'Права на создание заявок в этой группе/очереди',
        'owner' => 'владелец',
        ...
        'In this way you can directly edit the certification and private keys in file system.' =>
            'В данном случае вы можете редактировать сертификаты и Private Keys прямо на файловой системе',
        ...
        'Take care that you also updated the default states in you Kernel/Config.pm!' =>
            'Вы можете также обновить дефолтные статусы в Kernel/Config.pm!',
        'See also' => 'См. также',
        ...
        'Download all system config changes.' =>
            'Скачать все изменения конфигурации, внесенные в систему',
        ...
        'All incoming emails with this "Email" (To:) will be dispatched in the selected queue!' =>
            'Все входящие сообщения с этим полем (Для:) будут направлены в выбранную очередь',
        ...
        'Don\'t forget to add a new user to groups and/or roles!' =>
            'Не забудьте добавить нового пользователя в группы и роли!',
        ...
        'Discard all changes and return to the compose screen' =>
            'Отказаться от всех изменений и вернуться в окно ввода',
        ...
        'Select the restrictions to characterise the stat' =>
            'Выбирете ограничения для определения статистики',
        'Fixed' => 'Фиксировано',
        'Please select only one element or turn off the button \'Fixed\'.' =>
            'Пожалуйста, выбирете только один Элемент или уберите флажок \'Fixed\'.',
        ...
        'Here you can make restrictions to your stat.' =>
            'Здесь вы можете внести ограничения в вашу статистику',
        'If you remove the hook in the "Fixed" checkbox, the agent generating the stat can change the attributes of the corresponding element.'
            => 'Если вы уберете галочку из чекбокса "Fixed", пользователь, который будет создавать отчеты сможет менять настройки соответствующего элемента',
        ...
        'In this form you can select the basic specifications.' =>
            'В данной форме вы можете выбрать основные требования.',
        'Attribute'          => 'Аттрибут',
        'Title of the stat.' => 'Название отчета',
        'Here you can insert a description of the stat.' =>
            'Здесь вы можете написать описание отчета',
        'Dynamic-Object' => 'Динамический-Объект',
        'Here you can select the dynamic object you want to use.' =>
            'Здесь вы можете выбрать динмический объект, который вы хотите использовать',
        '(Note: It depends on your installation how many dynamic objects you can use)' =>
            '(заметка: То, сколько объектов можно использовать, зависит от вашей инсталляции)',
        'Static-File' => 'Статический-Файл',
        'For very complex stats it is possible to include a hardcoded file.' =>
            'Для очень комплексных отчетов возможно подключить "hardcoded" файл',
        'If a new hardcoded file is available this attribute will be shown and you can select one.'
            => 'Если новый "hardcoded" файл доступен, этот аттрибут будет показан и вы сможете выбрать один из них.',
        'Permission settings. You can select one or more groups to make the configurated stat visible for different agents.'
            => 'Настройки доступа. Вы можете выбрать одну или несколько групп чтобы отчет был видел для разных пользователей.',
        'Multiple selection of the output format.' => 'Выбор форматов вывода.',
        'If you use a graph as output format you have to select at least one graph size.' =>
            'Если вы используете графики, вам необходимо выбрать хотябы один размер графика.',
        'If you need the sum of every row select yes' =>
            'Если вам необходима сумма каждого ряда выбирете Да',
        'If you need the sum of every column select yes.' =>
            'Если вам необходима сумма каждого столбца выбирете Да',
        'Most of the stats can be cached. This will speed up the presentation of this stat.' =>
            'Большинство отчетов могут кэшироваться. Это увеличит скорость презентации отчетов.',
        '(Note: Useful for big databases and low performance server)' =>
            '(Заметка: Полезно для больших баз данных или для серверов с низкой производительностью)',
        'With an invalid stat it isn\'t feasible to generate a stat.' =>
            'При статусе отчета "недействительный" отчет не может быть сформирован.',
        'This is useful if you want that no one can get the result of the stat or the stat isn\'t ready configurated.'
            => 'Это полезно если вы не хотите чтобы ктонибудь смог получить результаты отчета или отчет еще окончательно не сконфигурирован.',

        # Template: AgentStatsEditValueSeries
        'Select the elements for the value series' =>
            'Выбирете элементы для последовательности значений',
        'Scale'   => 'Масштаб',
        'minimal' => 'Минимальный',
        'Please remember, that the scale for value series has to be larger than the scale for the X-axis (e.g. X-Axis => Month, ValueSeries => Year).'
            => 'Помните, что масштаб для последовательности значений должен быть больше, чем масштаб для оси X (например Ось Х => Месяц, последовательность значений => Год).',
        ...
        'Here you can define the x-axis. You can select one element via the radio button. Then you you have to select two or more attributes of the element. If you make no selection all attributes of the element will be used if you generate a stat. As well a new attribute is added since the last configuration.'
            => 'Здесь вы можете определить ось X. Вы можете выбрать один элемент. Затем необходимо выбрать два или более аттрибутов элемента. Если вы совсем не выбирете аттрибутов элемента - все аттрибуты будут использованы для генерации отчета, а также вновь добавленные аттрибуты.',
        ...
        'With the input and select fields you can configurate the stat at your needs. Which elements of a stat you can edit depends on your stats administrator who configurated the stat.'
            => 'Вводя данные и выбирая поля вы можете конфигурировать отчет как вам необходимо. От администратора , создававшего данный отчет, зависит какие данные вы можете конфигурировать. ',
        ...
        'Set customer user and customer id of a ticket' =>
            'Установить клиентского пользователя и клиенсткий id для заявки',
        ...
        '(The identify of the system. Each ticket number and each http session id starts with this number)'
            => '(ID системы. Каждый номер Заявки и каждая http сессия будет начинаться с этого числа)',
        'System FQDN' => 'Системное FQDN',
        '(Full qualified domain name of your system)' =>
            '(Полное доменное имя (FQDN) вашей системы)',
        ...
        '(Logfile just needed for File-LogModule!)' =>
            '(Журнал-файл необходим только для модуля File-Log)',
        'Webfrontend'     => 'Web-интерфейс',
        'Default Charset' => 'Кодировка по умолчанию',
        'Use utf-8 it your database supports it!' =>
            'Используйте utf-8 если ваша БД это поддерживает!',
        'Default Language'        => 'язык по умолчанию',
        '(Used default language)' => '(Используемый язык по умолчанию)',
        'CheckMXRecord'           => 'Проверять MX запси',
        '(Checks MX recordes of used email addresses by composing an answer. Don\'t use CheckMXRecord if your OTRS machine is behinde a dial-up line $!)'
            => 'Проверяет MX записи домена, на который отправляется e-mail(при составлении ответа). Не используйте CheckMXRecord если сервер с OTRS соединен по dial-up !',
        'To be able to use OTRS you have to enter the following line in your command line (Terminal/Shell) as root.'
            => 'Чтобы использовать OTRS вам необходимо ввести следующую строку в шеле (от пользователя root).',
        'Restart your webserver' => 'Перезапустите ваш web-сервер',
        'After doing so your OTRS is up and running.' =>
            'После этих действий ваш OTRS уже запущен.',
        ...
        'Options of the ticket data (e. g. &lt;OTRS_TICKET_Number&gt;, &lt;OTRS_TICKET_ID&gt;, &lt;OTRS_TICKET_Queue&gt;, &lt;OTRS_TICKET_State&gt;)'
            => 'Опции данных заявки (например  &lt;OTRS_TICKET_Number&gt;, &lt;OTRS_TICKET_ID&gt;, &lt;OTRS_TICKET_Queue&gt;, &lt;OTRS_TICKET_State&gt;)',
        'Days'                             => 'Дни',
        'Queue ID'                         => 'ID очереди',
        ...
        'Your email with ticket number "<OTRS_TICKET>" is bounced to "<OTRS_BOUNCE_TO>". Contact this address for further informations.'
            => 'Ваш e-mail с номером заявки "<OTRS_TICKET>" отвергнут и переслан по адресу "<OTRS_BOUNCE_TO>". Пожалуйста, свяжитесь по этому адресу для выяснения причин. ',
        ...
        'Options of the current customer user data (e. g. <OTRS_CUSTOMER_DATA_UserFirstname>)' =>
            'Опции текущих данных пользователя (например <OTRS_CUSTOMER_DATA_UserFirstname>)',
        'Pending type'       => 'Тип ожидания',
        'Comment (internal)' => 'Комментарий (внутренний)',
        'Ticket owner options (e. g. &lt;OTRS_OWNER_USERFIRSTNAME&gt;)' =>
            'Опции владельца заявки (например &lt;OTRS_OWNER_USERFIRSTNAME&gt;)',
        'This window must be called from compose window' =>
            'Это окно должно вызываться из окна ввода',
        'Minutes'                            => 'Минуты',
        ...
        'All Customer variables like defined in config option CustomerUser.' =>
            'Все переменные клиента содержаться в конфигурации клиентского пользователя.',
        'for agent lastname' => 'для агента - фамилия',
        'Options of the current user who requested this action (e. g. <OTRS_CURRENT_UserFirstname>)'
            => 'Опции для текущего пользователя, который запросил это действие (например <OTRS_CURRENT_UserFirstname>)',
        ...
        'Don\'t forget to add a new user to groups!' =>
            'Не забудьте добавить новоего пользователя в группы!',
        'You need a email address (e. g. customer@example.com) in To:!' =>
            'Нужен правильный адрес в поле ДЛЯ: (support@example.ru)!',
        ...
        'Options of the ticket data (e. g. <OTRS_TICKET_TicketNumber>, <OTRS_TICKET_ID>, <OTRS_TICKET_Queue>, <OTRS_TICKET_State>)'
            => 'Опции заявки (например <OTRS_TICKET_TicketNumber>, <OTRS_TICKET_ID>, <OTRS_TICKET_Queue>, <OTRS_TICKET_State>)',
        '7 Day'             => '7 Дней',
        ...
        'WebMail'           => 'Почта',
        'Options of the ticket data (e. g. <OTRS_TICKET_TicketNumber>, <OTRS_TICKET_TicketID>, <OTRS_TICKET_Queue>, <OTRS_TICKET_State>)'
            => 'Опции заявки (например <OTRS_TICKET_TicketNumber>, <OTRS_TICKET_TicketID>, <OTRS_TICKET_Queue>, <OTRS_TICKET_State>)',
        'Ticket owner options (e. g. <OTRS_OWNER_UserFirstname>)' =>
            'Опции владельца заявки (например <OTRS_OWNER_UserFirstname>)',
        ...
        '3 Month'                           => '3 Месяца',
        'Options of the current customer user data (e. g. &lt;OTRS_CUSTOMER_DATA_USERFIRSTNAME&gt;)'
            => 'Опции для данных текущего пользователя-клиента (например &lt;OTRS_CUSTOMER_DATA_USERFIRSTNAME&gt;)',
        'Jule'                             => 'Июля',
