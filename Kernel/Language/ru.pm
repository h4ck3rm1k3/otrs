...
# --
# $Id: ru.pm,v 1.97 2010/09/08 19:38:40 mb Exp $
# --
...
sub Data {
    ...
    # $$START$$
    # Last translation file sync: 2010-07-30 14:47:47
    ...
    $Self->{Translation} = {
        ...
        'Customer Information' => 'Информация о клиента',
        'Customer Company' => 'Компания клиента',
        'Customer Companies' => 'Компания клиента',
        'Company' => 'Компания',
        'go!' => 'ОК!',
        'go' => 'ОК',
        'All' => 'Все',
        ...
        'Select the separator character used in CSV files (stats and searches). If you don\'t select a separator here, the default separator for your language will be used.' => 'Выберите символ-разделитель для использования в CSV файлах (статистики и поисковых запросов). Если вы не выберите разделитель, будет использоватcя разделитель по умолчанию для выбранного языка.',
        ...
        'Ticket follow up notification' => 'Отправлять уведомления об изменениях в заявке',
        ...
        'Send ticket lock timeout notifications' => 'Отослать извещения о истечении срока блокировки заявки',
        ...
        'Send ticket move notifications' => 'Отправлять уведомления о перемещении заявки',
        ...
        'Show this screen after I created a new ticket' => 'Показывать этот раздел после создания новой заявки',
        ...
        'Out Of Office Time' => 'Время отсутствия в офисе',
        ...
        'Actions' => 'Действия',
        'Go to overview' => 'Перейти к просмотру',
        ...
        'Wildcards are allowed.' => 'Допустимо использование масок.',
        'Add customer company' => 'Добавить компанию клиента',
        'Please enter a search term to look for customer companies.' => 'Пожалуйста введите поисковую фразу для поиска компаний клиента.',
        'Add Customer Company' => 'Добавить компанию клиента',
        ...
        'Please enter a search term to look for customers.' => 'Пожалуйста, введите поисковое выражение для поиска клиентов.',
        ...
        'No matches found' => 'Совпадений не найдено',
        'Edit Notification' => 'Редактировать извещения',
        'e. g.' => 'например,',
        ...
        'Import Stat' => 'Импортировать статистику',
        ...
        'A ticket should be associated with a queue!' => 'Заявка должны быть связана с очередью!',
        ...
        'Add another attribute' => 'Добавить ещё атрибут',
        ...
        'Show one article' => 'Отобразить одну заявку',
        'Show all articles' => 'Отобразить все заявки',
        'Unread articles' => 'Непрочитанные заявки',
        'No.' => '',
        'Unread Article!' => 'Непрочитанные заявки!',
        ...
        'Agent Notifications' => 'Извещения агентов',
        ...
        'Escalation view' => 'Эскалированные заявки',
        ...
        'Module to genetare ticket solution and response time statistics.' => 'Модуль для формирования статистки по времени реакции и разрешения заявки.',
        'Module to genetare ticket statistics.' => 'Модуль для формирования статистки по заявкам.',
        ...
        'New email ticket' => 'Новая e-mail заявка',
        ...
        'Overview Escalated Tickets' => 'Просмотр эскалированных заявок.',
        'Overview of all open Tickets.' => 'Просмотр всех открытых заявок.',
        'PGP Key' => 'PGP ключ',
        ...
        'Refresh QueueView after' => '',
        'Refresh interval' => 'Обновлять каждые',
        ...
        'Send me the same notifications for my watched tickets that the ticket owners will get.' => '',
        'Send new ticket notifications' => 'Отправить извещения о новой заявке',
        'Send notifications to users.' => 'Отправить извещения пользователям.',
        'Send ticket follow up notifications' => '',
        'Send ticket lock timeout notifications' => '',
        'Send ticket move notifications' => 'Отправить извещения о перемещении заявки',
        'Send ticket watch notifications' => '',
        ...
        'Ticket limit per page for Ticket Overview "Preview"' => '',
        'Ticket limit per page for Ticket Overview "Small"' => '',
        'Ticket move notification' => 'Извещение о перемещении заявки',
        'Ticket overview' => 'Просмотр заявки',
        'Ticket watch notification' => '',
        'Ticket-Area' => 'Заявки',
        'Tickets' => 'Заявки',
        'Time Zone' => 'Часовой пояс',
