...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'The recommended charset for your language is %s!' =>
            'Teie keele jaoks soovitame kooditabelit %s!',
        'Passwords doesn\'t match! Please try it again!' =>
            'Paroolid ei ole samad! Palun proovi uuesti!',
        'Password is already in use! Please use an other password!' =>
            'Parool on juba kasutuses, palun kasuta teist parooli!',
        'Password is already used! Please use an other password!' =>
            'Parool oli juba kasutuses, palun kasuta teist parooli!',
        'You need to activate %s first to use it!' =>
            'Enne kui saad kasutada %s, pead selle aktiveerima !',
        'No suggestions' => 'Soovitust ei ole',
        'Word'           => 'Sõna',
        'Ignore'         => 'Eira',
        'replace with'   => 'asenda',
        'There is no account with that login name.' =>
            'Sellise nimega kontot ei ole.',
        ...
        'Logout successful. Thank you for using OTRS!' =>
            'Lahkusid OTRSist, täname kasutamise eest!',
        ...
        'Session has timed out. Please log in again.' =>
            'Sesesioon aegus. Palun logi uuesti sisse.',
        ...
        'Unable to parse Online Repository index document!' =>
            'Ei saa töödelda võrgurepositooriumi indeksit!',
        ...
        'Max. shown Tickets a page in Overview.' =>
            'Ülevaates korraga nähtavate intsidentide ülempiir.',
        ...
        'Can\'t update password, invalid characters!' =>
            'Ei saa uuendada parooli, paroolis on keelatud märke.',
        'Can\'t update password, need min. 8 characters!' =>
            'Ei saa uuendada parooli, paroolis peab olema vähemalt 8 märki.',
        'Can\'t update password, need 2 lower and 2 upper characters!' =>
            'Ei saa uuendada parooli, paroolis peab olema vähemalt 2 väiketähte ja 2 suurtähte.',
        'Can\'t update password, need min. 1 digit!' =>
            'Ei saa uuendada parooli, paroolis peab olema vähemalt 1 number!',
        'Can\'t update password, need min. 2 characters!' =>
            'Ei saa uuendada parooli, paroolis peab olema vähemalt 2 tähte!',
        ...
        'Please select one element for the X-axis!' =>
            'Palun vali üks element X-teljele!',
        ...
        'This is a HTML email. Click here to show it.' =>
            'See kiri on HTML-formaadis. Kliki siia selle kirja nägemiseks.',
        ...
        'No such Ticket Number "%s"! Can\'t link it!' =>
            'Sellise numbriga (%s) ei ole! Ei saa sellele viidata!',
        ...
        'Create new Email Ticket and send this out (Outbound)' =>
            'Tee uus intsident ja saada kiri (väljaminev) ',
        ...
        'Select your screen after creating a new ticket.' =>
            'Vali lehekülg mis on näha peale uue intsidendi loomist.',
        'Closed Tickets'       => 'Sultetud intsidendid',
        'Show closed tickets.' => 'Näita suletud intsidente.',
        'Max. shown Tickets a page in QueueView.' =>
            'Mitut intsidendti näidatakse järjekorras ühel lehel.',
        ...
        'Config options (e. g. <OTRS_CONFIG_HttpType>).' =>
            'Andmed seadistuse kohta (näiteks <OTRS_CONFIG_HttpType).',
        ...
        'Read only access to the ticket in this group/queue.' =>
            'Selle grupi/järjekorra intsidentidele ainult lugemise õigused.',
        'rw' => 'rw',
        ...
        'Select the customeruser:service relations.' =>
            'Vali kliendikasutaj:teenus suhe.',
        ...
        'Fulltext-Search in Article (e. g. "Mar*in" or "Baue*")' =>
            'Täistekstiotsing kirjadest (näiteks "Mar*in" või "Andr*")',
        ...
        'No means, send agent and customer notifications on changes.' =>
            'Ei tähendab, et klientidele ja töötajatele saadetakse infot muudatustest.',
        'Save' => 'Salvesta',
        '%s Tickets affected! Do you really want to use this job?' =>
            'Muudab %s intisdenti! Oled kindel et soovid seda tööd kasutada?',
        ...
        'Notifications are sent to an agent or a customer.' =>
            'Teavitused saadetakse kliendile või töötajale.',
        ...
        'Do you really want to uninstall this package?' =>
            'Kas tõesti eemaldada see pakett?',
        ...
        'Just use this feature if you want to log each request.' =>
            'Kasuta jõudluseandmete logimist siis, kui soovid logida iga päringut.',
        ...
        'Logfile too large, you need to reset it!' =>
            'Logifail on liiga suur, see tuleb tühjendada!',
        'Range'            => 'Vahemik',
        'Interface'        => 'Liides',
        'Requests'         => 'Päringuid',
        ...
        'Will be the sender address of this queue for email answers.' =>
            'Aadress, millelt selle järjekorra kirjad tulevad.',
        ...
        'It\'s useful for a lot of users and groups.' =>
            'See on kasulik paljude kasutajate ja gruppide korral',

        # Template: AdminRoleGroupChangeForm
        'Roles <-> Groups Management' => 'Rollid <-> grupid haldus',
        'move_into'                   => 'liiguta_siia',
        'Permissions to move tickets into this group/queue.' =>
            'Õigus liigutada intsidente siia gruppi/järjekorda.',
        'create' => 'tekita',
        'Permissions to create tickets in this group/queue.' =>
            'Õigus tekitada sellesse gruppi/järjekorda intsidente.',
        'owner' => 'omanik',
        'Permissions to change the ticket owner in this group/queue.' =>
            'Õigus muuta selle grupi/järjekorra intsidentide omanikke.',
        'priority' => 'prioriteet',
        ...
        'Download all system config changes.' =>
            'Lae alla kõik süsteemi seadistuste muutused.',
        ...
        'User will be needed to handle tickets.' =>
            'Kasutajat on vaja intsidentide haldamiseks.',
        'Don\'t forget to add a new user to groups and/or roles!' =>
            'Ära unusta kasutajat gruppidesse/rollidesse lisamast!',
        ...
        'Discard all changes and return to the compose screen' =>
            'Unusta kõik muudatused ja mine tagasi kirja kirjutamise ekraanile',
        ...
        'Set customer user and customer id of a ticket' =>
            'muuda intsidendi kliendikasutajat ja kliendikasutaja id-d',
        ...
        'Use utf-8 it your database supports it!' =>
            'Kasuta utf-8 kui su andmebaas seda toetab!',
        ...
        'A message should have a To: recipient!' =>
            'Kirjal peaks oleam saatja aadress!',
        'Site' => 'Sait',
        'Customer history search (e. g. "ID342425").' =>
            'Kliendiajaloo otsing (näiteks "ID342425").',
        ...
        'The message being composed has been closed.  Exiting.' =>
            'Pooleliolev kriri sulegi. Lõpetan.',
        'to get the realname of the sender (if given)' =>
            'hankimaks saatja täisnime (kui on teada)',
        ...
        'Config options (e. g. <OTRS_CONFIG_HttpType>)' =>
            'Seadistused (<OTRS_CONFIG_HttpType>)',
        ...
        'to get the first 20 character of the subject' =>
            'hankimaks esimesed 20 märki teemareast',
        ...
        'This window must be called from compose window' =>
            'Seda akent saab avada kirja kirjutamise aknast',
        ...
        'Don\'t forget to add a new user to groups!' =>
            'Ära unusta kasutajat gruppidesse lisamast!',
        ...
        'Event'                          => 'Sündmus',
        'Config options (e. g. &lt;OTRS_CONFIG_HttpType&gt;)' =>
            'Seadistused (näiteks .&lt;OTRS_CONFIG_HttpType&gt;)',
