...
# --
# $Id: pt.pm,v 1.55 2008/05/15 12:49:32 tr Exp $
# --
...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'The recommended charset for your language is %s!' =>
            'O código recomendado para o seu idioma é %s!',
        'Passwords doesn\'t match! Please try it again!' =>
            'As palavras-passe não correspondem! Tente de novo!',
        'Password is already in use! Please use an other password!' =>
            'A palavra-passe está já em uso! Por favor use outra!',
        'Password is already used! Please use an other password!' =>
            'A palavra-passe já foi usada! Por favor use outra!',
        ...
        'There is no account with that login name.' =>
            'Não existe nenhuma conta com esse nome de utilizador',
        ...
        'Logout successful. Thank you for using OTRS!' =>
            'Saiu com sucesso. Obrigado por utilizar o OTRS!',
        ...
        'To: (%s) replaced with database email!' =>
            'Para: (%s) substituído pelo endereço na base de dados!',
        ...
        'Security Note: You should activate %s because application is already running!' =>
            'Nota de Segurança: É necessário activar %s porque a aplicação já está a ser executada',
        'Unable to parse Online Repository index document!' =>
            'Não é possivel verificar o ficheiro index do Repositório',
        'No Packages for requested Framework in this Online Repository, but Packages for other Frameworks!'
            => 'Não existe pacotes no Framework pedido neste Repositório, mas pacotes de outro Frameworks',
        'No Packages or no new Packages in selected Online Repository!' =>
            'Não existe pacotes no Repositório selecionado',
        ...
        'Select your default spelling dictionary.' =>
            'Seleccione o dicionário ortográfico por omissão.',
        'Max. shown Tickets a page in Overview.' =>
            'Número máximo de tickets por página em Visão Geral.',
        'Can\'t update password, passwords doesn\'t match! Please try it again!' =>
            'Impossível actualizar a palavra-passe: as palavras-passe não correspondem! Tente de novo!',
        'Can\'t update password, invalid characters!' =>
            'Impossível actualizar palavra-passe: caracteres inválidos!',
        'Can\'t update password, need min. 8 characters!' =>
            'Impossível actualizar palavra-passe: necessários pelo menos oito caracteres!',
        'Can\'t update password, need 2 lower and 2 upper characters!' =>
            'Impossível actualizar palavra-passe: pelo menos duas minúsculas e duas maiúsculas!',
        'Can\'t update password, need min. 1 digit!' =>
            'Impossível actualizar palavra-passe: pelo menos um dígito!',
        'Can\'t update password, need min. 2 characters!' =>
            'Impossível actualizar palavra-passe: pelo menos um caractere!',
        ...
        'Please select only one element or turn off the button \'Fixed\' where the select field is marked!'
            => 'Slecione apenas um elemento ou desligue a opção Fixed onde o campo selecionado é marcado',
        ...
        'You have to select one or more attributes from the select field!' =>
            'Terá de seleccionar um ou mais atributos do campo seleccionado',
        'The selected Date isn\'t valid!' => 'A data selecionada nao é valida',
        'Please select only one or two elements via the checkbox!' =>
            'Seleccione um ou dois elementos da caixa',
        ...
        'Your reporting time interval is too small, please use a larger time scale!' =>
            'O intervalo tempo de report é muito pequeno',
        'The selected start time is before the allowed start time!' =>
            'O tempo selecionado é antes do inicio do tempo permitido',
        'The selected end time is after the allowed end time!' =>
            'O tempo selecionado é depois do fim do tempo permitido',
        'The selected time period is larger than the allowed time period!' =>
            'O intervalo de tempo é suporior ao permitido',
        ...
        'This is a HTML email. Click here to show it.' =>
            'Esta é uma mensagem HTML. Clicar aqui para a mostrar.',
        ...
        'No such Ticket Number "%s"! Can\'t link it!' =>
            'Não existe Número de Ticket "%s"! Não posso ligar a ele!',
        ...
        'Create new Email Ticket and send this out (Outbound)' =>
            'Criar novo Email Ticket e enviar para fora',
        ...
        'Your email with ticket number "<OTRS_TICKET>" is merged to "<OTRS_MERGE_TO_TICKET>".' =>
            'A sua mensagem com o número de ticket "<OTRS_TICKET>" foi junta a "<OTRS_MERGE_TO_TICKET>".',
        'Ticket %s: first response time is over (%s)!' =>
            'Ticket %s: primeira resposta acabou em (%s)!',
        'Ticket %s: first response time will be over in %s!' =>
            'Ticket %s: primeira resposta acaba em (%s)!',
        'Ticket %s: update time is over (%s)!' =>
            'Ticket %s: tempo de actualização acabou em (%s)!',
        'Ticket %s: update time will be over in %s!' =>
            'Ticket %s: tempo de actualização acaba em (%s)!',
        'Ticket %s: solution time is over (%s)!' => 'Ticket %s: tempo de resolução acabou em (%s)!',
        'Ticket %s: solution time will be over in %s!' =>
            'Ticket %s: tempo de resolução acaba em (%s)!',
        ...
        'Send me a notification if there is a new ticket in "My Queues".' =>
            'Envie-me uma notificação se houver um novo ticket nas "Minhas Filas".',
        ...
        'Send me a notification if a ticket is unlocked by the system.' =>
            'Notifique-me se um ticket for desbloqueado pelo sistema.',
        'Move notification' => 'Notificação de movimentos',
        'Send me a notification if a ticket is moved into one of "My Queues".' =>
            'Notifique-me se um ticket for movido para uma das "Minhas Filas".',
        'Your queue selection of your favourite queues. You also get notified about those queues via email if enabled.'
            => 'Selecção das suas filas favoritas. Será notificado acerca destas filas via correio electrónico se o serviço estiver activo.',
        ...
        'Select your screen after creating a new ticket.' =>
            'Seleccionar ecrã após criação de novo ticket.',
        'Closed Tickets'       => 'Tickets Fechados',
        'Show closed tickets.' => 'Mostrar tickets fechados',
        'Max. shown Tickets a page in QueueView.' =>
            'Número máximo de tickets por página em Visualição de Filas',
        ...
        'To get the first 20 character of the subject.' =>
            'Para obter os primeiros 20 Caracteres do subject',
        'To get the first 5 lines of the email.' => 'Para obter as primeiras 5 linhas do email',
        'To get the realname of the sender (if given).' =>
            'Para obter o realname do remetente (se dado)',
        'To get the article attribute (e. g. (<OTRS_CUSTOMER_From>, <OTRS_CUSTOMER_To>, <OTRS_CUSTOMER_Cc>, <OTRS_CUSTOMER_Subject> and <OTRS_CUSTOMER_Body>).'
            => 'Para obter o atributo do artigo',
        'Options of the current customer user data (e. g. <OTRS_CUSTOMER_DATA_UserFirstname>).' =>
            'Opções dos actuais dados do cliente',
        'Ticket owner options (e. g. <OTRS_OWNER_UserFirstname>).' => 'Opções do Owner do Ticket',
        'Ticket responsible options (e. g. <OTRS_RESPONSIBLE_UserFirstname>).' =>
            'Opções do Responsavel do Ticket ',
        'Options of the current user who requested this action (e. g. <OTRS_CURRENT_UserFirstname>).'
            => 'Opções do actual cliente que pediu esta acção',
        'Options of the ticket data (e. g. <OTRS_TICKET_TicketNumber>, <OTRS_TICKET_TicketID>, <OTRS_TICKET_Queue>, <OTRS_TICKET_State>).'
            => 'Opções dos dados do ticket',
        ...
        'Read only access to the ticket in this group/queue.' =>
            'Acesso apenas de leitura para o ticket neste grupo/fila.',
        'rw' => 'escrita',
        ...
        'Notifications are sent to an agent or a customer.' =>
            'As notificações são enviadas para um agente ou um cliente.',
        ...
        'Just use this feature if you want to log each request.' =>
            'Apenas use esta opção se pretender registar cada pedido',
        ...
        'Logfile too large, you need to reset it!' =>
            'Ficheiro de log demasiado grande, precisa de fazer reset',
        'Range'            => 'Intervalo',
        'Interface'        => '',
        'Requests'         => 'Pedidos',
        ...
        'In this way you can directly edit the keyring configured in SysConfig.' =>
            'Desta forma pode editar directamente o anel de chaves configurado no SysConfig',
        ...
        'All incoming emails with one account will be dispatched in the selected queue!' =>
            'Todas as mensagens recebidas correspondentes a uma com uma conta serão despachados para a fila selecionada!',
        ...
        'If you want to match only the email address, use EMAILADDRESS:info@example.com in From, To or Cc.'
            => 'Se pretender apenas relacionar o email adress, use EMAILADDRESS:info@example.com no From, To ou Cc.',
        ...
        'Will be the sender address of this queue for email answers.' =>
            'Será o endereço de correio electrónico usado para respostas nesta fila.',
        ...
        'Create a role and put groups in it. Then add the role to the users.' =>
            'Criar um papel e atribuir-lhe grupos. Depois acrescentar o papel aos utilizadores.',
        ...
        'Permissions to move tickets into this group/queue.' =>
            'Permissões para mover tickets neste grupo/queue',
        'create' => 'criar',
        'Permissions to create tickets in this group/queue.' =>
            'Permisses para criar tickets neste grupo/queue',
        'owner' => 'dono',
        ...
        'Take care that you also updated the default states in you Kernel/Config.pm!' =>
            'Garanta que também actualisou os estados por omissão no seu Kernel/Config.pm!',
        'See also' => 'Ver também',
        ...
        'System Email Addresses Management' =>
            'Gestão dos Endereços de Correio Electrónico do Sistema',
        ...
        'User will be needed to handle tickets.' =>
            'É necessário um utilizador para manipular os tickets.',
        ...
        'Select the restrictions to characterise the stat' =>
            'Selecionar as restricções para caracterizar o estado',
        'Fixed' => 'Fixo',
        'Please select only one element or turn off the button \'Fixed\'.' =>
            'Selecione apenas um elemento ou desligue o botao "fixo"',
        ...
        'Here you can make restrictions to your stat.' =>
            'Aqui pode fazer restricçoes para a sua estatistica',
        'If you remove the hook in the "Fixed" checkbox, the agent generating the stat can change the attributes of the corresponding element.'
            => 'Se remover o visto na caixa "fixo", o agente gerador da estatistica pode mudar os atribudos do elemento correspondente',
        ...
        'In this form you can select the basic specifications.' =>
            'Neste formulario pode selecionar as especificaçoes basicas',
        'Attribute'          => 'Atributo',
        'Title of the stat.' => 'Titulo da estatistica',
        'Here you can insert a description of the stat.' =>
            'Aqui pode inserir a descriçao da estatistica',
        'Dynamic-Object' => '',
        'Here you can select the dynamic object you want to use.' =>
            'Aqui pode selecionar o Dynamic object que pretende usar ',
        ...
        'If you use a graph as output format you have to select at least one graph size.' =>
            'Se utilizar um grafico como um formato de output, terá de selecionar pelo menos um tamanho de grafico',
        'If you need the sum of every row select yes' =>
            'Se pretende a soma de todas as linhas selecione Sim',
        'If you need the sum of every column select yes.' =>
            'Se pretende a soma de todas as colunas selecione Sim',
        'Most of the stats can be cached. This will speed up the presentation of this stat.' =>
            'Maioria das estatisticas podem ser feitas. Isto irá aumentar a rapidez da apresentaçao da estatistica',
        '(Note: Useful for big databases and low performance server)' =>
            'Util para grandes databases e servers pouco potentes',
        ...
        'Please remember, that the scale for value series has to be larger than the scale for the X-axis (e.g. X-Axis => Month, ValueSeries => Year).'
            => 'Relembre-se que o valor da escala tem de ser superior ao valor maximo para o eixo dos X',
        'Here you can the value series. You have the possibility to select one or two elements. Then you can select the attributes of elements. Each attribute will be shown as single value series. If you don\'t select any attribute all attributes of the element will be used if you generate a stat. As well a new attribute is added since the last configuration.'
            => '',

        # Template: AgentStatsEditXaxis
        'Select the element, which will be used at the X-axis' =>
            'Selecione o elemento que vai ser usado no eixo dos X',
        ...
        'Configurable params of static stat' =>
            'Parametros configuraveis de estatisticas estaticas',
        'No element selected.' => 'Sem elemento selecionado',
        ...
        'Set customer user and customer id of a ticket' =>
            'Atribua o nome de utilizador e o ID do cliente do ticket',
        ...
        '(The identify of the system. Each ticket number and each http session id starts with this number)'
            => '(A identidade do sistema. Cada número de ticket e cada id. da sessão http, inicia com este número)',
        'System FQDN' => 'FQDN do sistema',
        '(Full qualified domain name of your system)' =>
            '(Nome de domínio totalmente qualificado do seu sistema)',
        ...
        'To be able to use OTRS you have to enter the following line in your command line (Terminal/Shell) as root.'
            => 'Para usar o OTRS tem de dar o seguinte comando no seu Terminal/Consola, como administrador.',
        'Restart your webserver' => 'Reinicie o seu servidor Web',
        'After doing so your OTRS is up and running.' =>
            'Depois de o fazer, o seu OTRS estará funcional.',
        ...
        'A message should have a To: recipient!' =>
            'Uma mensagem deve possuir um Para: destinatário!',
        'Site' => 'Página',
        'Customer history search (e. g. "ID342425").' =>
            'Procura no histórico do cliente (e.g., "ID342425")',
        'Close!'              => 'Fechar!',
        ...
        'to get the realname of the sender (if given)' =>
            'para obter o nome do remetente (se indicado na mensagem)',
        ...
        'Options of the current user who requested this action (e. g. &lt;OTRS_CURRENT_USERFIRSTNAME&gt;)'
            => 'Opçoes do user actual que pediu esta acção',
        ...
        'Don\'t forget to add a new user to groups!' =>
            'Não esqueça de adicionar um novo user nos grupos!',
        ...
        'Insert:' => 'Inserir:',
        'Security Note: You should activate %s because applications is already running!' =>
            'Nota de Segurança: Deve activar o %s, pois a aplicação está já em produção!',
