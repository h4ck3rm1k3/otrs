...
# --
# $Id: ar_SA.pm,v 1.46 2010/07/30 13:13:12 martin Exp $
# --
...
sub Data {
    ...
    # $$START$$
    # Last translation file sync: 2010-07-30 14:49:21
    ...
    $Self->{Translation} = {
        ...
        'Auto Responses <-> Queues' => '«·—œÊœ «·¬·Ì… <=> ﬁ«∆„… «·»ÿ«ﬁ« ',
        ...
        'Hash' => '',
        'Filelist' => '',
        'These values are required.' => 'Â–Â «·ﬁÌ„… „ÿ·Ê»…',
        'Create Database' => '',
        'DB Host' => '',
        'verified' => '',
        'File-Name' => '',
