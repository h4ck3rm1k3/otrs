...
# --
# $Id: ar_SA.pm,v 1.45 2010/02/03 13:24:27 shb Exp $
# --
...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'Can\'t update password, your new passwords do not match! Please try again!' => 'áÇ íãßä ÊÍÏíË ßáãÉ ÇáãÑæÑ, ßáãÊí ÇáãÑæÑ ÛíÑ ãÊØÇÈŞÊÇä! ÇáÑÌÇÁ ÇáÊÌÑÈÉ ãÑÉ ÃÎÑì',
        'Can\'t update password, invalid characters!' => 'áÇ íãßä ÊÍÏíË ßáãÉ ÇáãÑæÑ, ÇáÍÑæİ ÛíÑ ÕÍíÍÉ!',
        'Can\'t update password, must be at least %s characters!' => 'áÇ íãßä ÊÛííÑ ßáãÉ ÇáãÑæÑ, Úáì ÇáÃŞá íÌÈ ßÊÇÈÉ %s ÎÇäÇÊ!',
        'Can\'t update password, must contain 2 lower and 2 upper characters!' => '',
        'Can\'t update password, needs at least 1 digit!' => 'áÇ íãßä ÊÍÏíË ßáãÉ ÇáãÑæÑ, íÌÈ ßÊÇÈÉ ÎÇäÉ æÇÍÏÉ Úáì ÇáÃŞá',
        'Can\'t update password, needs at least 2 characters!' => 'áÇ íãßä ÊÍÏíË ßáãÉ ÇáãÑæÑ, íÌÈ ßÊÇÈÉ ÎÇäÊíä Úáì ÇáÃÃŞá',
        ...
        'List' => '',
        'These values are required.' => 'åĞå ÇáŞíãÉ ãØáæÈÉ',
        'These values are read-only.' => 'åĞå ÇáŞíãÉ ááŞÑÇÁÉ İŞØ',
