...
# --
# $Id: ar_SA.pm,v 1.69 2011/12/15 11:08:51 mg Exp $
# --
...
sub Data {
    ...
    # $$START$$
    # Last translation file sync: 2011-12-15 12:06:37
    ...
    $Self->{Translation} = {
        ...
        'New message!' => 'رسالة جديدة!',
        'Please answer this ticket(s) to get back to the normal queue view!' => 'الرجاء الإجابة على هذه البطاقات للعودة إلى شاشة البطاقات الرئيسية!',
        ...
        'The selected time period is larger than the allowed time period!' => 'مدة الوقت المحددة أكبر من المدة المسموح بها!',
        ...
        'This message was written in a character set other than your own.' => 'هذه الرسالة كتبت بترميز مختلف عن الترميز الحالي.',
        ...
        'Your email with ticket number "<OTRS_TICKET>" is merged to "<OTRS_MERGE_TO_TICKET>".' => 'بريدك مع رقم البطاقة  "<OTRS_TICKET>" دمجت مع "<OTRS_MERGE_TO_TICKET>".',
        ...
        'Send me a notification if there is a new ticket in "My Queues".' => 'أرسلي تنبيه إذا وجدت بطاقة جديدة في قائمة "بطاقاتي".',
        ...
        'Send me a notification if a ticket is unlocked by the system.' => 'أرسل إلي تنبيه عند فتح بطاقة بواسطة النظام بعد إنتهاء الوقت المخصص لإقفالها.',
        ...
        'Can\'t update password, your new passwords do not match! Please try again!' => 'لا يمكن تحديث كلمة المرور, كلمتي المرور غير متطابقتان! الرجاء التجربة مرة أخرى',
        ...
        'Customer user will be needed to have a customer history and to login via customer panel.' => 'العملاء مطلوبون لإمكانية الرجوع إلى تاريخ العملاء كم يمكنهم الدخول من شاشة العملاء.',
        'CustomerUser' => 'العميل',
        'D' => 'أقل',
        'Days' => 'أيام',
        ...
        'Don\'t work with UserID 1 (System account)! Create new users!' => 'لا تستخدم مدير النظام الأساسي! أنشيء مستخدم آخر!',
        ...
        'Login failed! Your username or password was entered incorrectly.' => 'فشل تسجيل الدخول! الرجاء التأكد من اسم المستخدم أو كلمة المرور.',
        'Lookup' => 'بحث عن',
        ...
        'Options of the current customer user data (e. g. <OTRS_CUSTOMER_DATA_UserFirstname>)' => 'الخيارات لبيانات العميل الحالي(مثاله <OTRS_CUSTOMER_DATA_UserFirstname>)',
        'Options of the current user who requested this action (e. g. <OTRS_CURRENT_UserFirstname>)' => 'الخصائص للمستخدم الحالي الذي طلب هذه العملية (مثاله <OTRS_CURRENT_UserFirstname>)',
        'Options of the ticket data (e. g. <OTRS_TICKET_TicketNumber>, <OTRS_TICKET_ID>, <OTRS_TICKET_Queue>, <OTRS_TICKET_State>)' => 'خيارات بيانات البطاقة (مثاله <OTRS_TICKET_TicketNumber>, <OTRS_TICKET_ID>, <OTRS_TICKET_Queue>, <OTRS_TICKET_State>)',
        'Other Options' => 'خيارات أخرى',
        'Package not correctly deployed! You should reinstall the Package again!' => 'البرنامج الإضافي لم يخزن بشكل صحيح! يجب عليك إعادة تخزينه مرة اخرى',
        ...
        'Send me a notification if a customer sends a follow up and I\'m the owner of this ticket.' => 'أرسل إلي تنبيه إذاأرسل العميل ملحق متابعة للبطاقة إذا كانت ملك لي.',
        ...
        'You have to select two or more attributes from the select field!' => 'يجب عليك تحديد عنصرين أو أكثر من القائمة المحددة!',
        ...
        'You use the DELETE option! Take care, all deleted Tickets are lost!!!' => 'قمت بإستخدام "حذف" ! جميع البطاقات المحذوفة مسحت بشكل نهائي!!!!',
