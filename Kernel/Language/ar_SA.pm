...
# --
# $Id: ar_SA.pm,v 1.8 2007/10/02 10:45:42 mh Exp $
# --
...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'Please answer this ticket(s) to get back to the normal queue view!' =>
            'ÇáÑÌÇÁ ÇáÅÌÇÈÉ Úáì åĞå ÇáÈØÇŞÇÊ ááÚæÏÉ Åáì ÔÇÔÉ ÇáÈØÇŞÇÊ ÇáÑÆíÓíÉ!',
        ...
        'Passwords doesn\'t match! Please try it again!' =>
            'ßáãÊí ÇáãÑæÑ ÛíÑ ãÊØÇÈŞÊÇä! ÇáÑÌÇÁ ÇáÊÌÑÈÉ ãÑÉ ÃÎÑì!',
        'Password is already in use! Please use an other password!' =>
            'ßáãÉ ÇáãÑæÑ ãÓÊÎÏãÉ ãÓÈŞÇğ! ÇáÑÌÇÁ ÅÓÊÎÏÇã ßáãÉ ãÑæÑ ÃÎÑìì!',
        'Password is already used! Please use an other password!' =>
            'ßáãÉ ÇáãÑæÑ ãÓÊÎÏãÉ ãÓÈŞÇğ! ÇáÑÌÇÁ ÅÓÊÎÏÇã ßáãÉ ãÑæÑ ÃÎÑì !',
        ...
        'Login failed! Your username or password was entered incorrectly.' =>
            'İÔá ÊÓÌíá ÇáÏÎæá! ÇáÑÌÇÁ ÇáÊÃßÏ ãä ÇÓã ÇáãÓÊÎÏã Ãæ ßáãÉ ÇáãÑæÑ.',
        'Please contact your admin' => 'ÇáÑÌÇÁ ÇáÅÊÕÇá ÈãÏíÑ ÇáäÙÇã',
        'Logout successful. Thank you for using OTRS!' =>
            'Êã ÇáÎÑæÌ ãä ÇáäÙÇã ÈäÌÇÍ. ÔßÑÇğ áÅÓÊÎÏÇãß OTRS!',
        'Invalid SessionID!'  => '',
        ...
        'Don\'t work with UserID 1 (System account)! Create new users!' =>
            'áÇ ÊÓÊÎÏã ãÏíÑ ÇáäÙÇã ÇáÃÓÇÓí! ÃäÔíÁ ãÓÊÎÏã ÂÎÑ!',
        ...
        'Package not correctly deployed! You should reinstall the Package again!' =>
            'ÇáÈÑäÇãÌ ÇáÅÖÇİí áã íÎÒä ÈÔßá ÕÍíÍ! íÌÈ Úáíß ÅÚÇÏÉ ÊÎÒíäå ãÑÉ ÇÎÑì',
        ...
        'Can\'t update password, passwords doesn\'t match! Please try it again!' =>
            'áÇ íãßä ÊÍÏíË ßáãÉ ÇáãÑæÑ, ßáãÊí ÇáãÑæÑ ÛíÑ ãÊØÇÈŞÊÇä! ÇáÑÌÇÁ ÇáÊÌÑÈÉ ãÑÉ ÃÎÑì',
        'Can\'t update password, invalid characters!' =>
            'áÇ íãßä ÊÍÏíË ßáãÉ ÇáãÑæÑ, ÇáÍÑæİ ÛíÑ ÕÍíÍÉ!',
        'Can\'t update password, need min. 8 characters!' =>
            'áÇ íãßä ÊÛííÑ ßáãÉ ÇáãÑæÑ, Úáì ÇáÃŞá íÌÈ ßÊÇÈÉ 8 ÎÇäÇÊ!',
        'Can\'t update password, need 2 lower and 2 upper characters!' => '',
        'Can\'t update password, need min. 1 digit!' =>
            'áÇ íãßä ÊÍÏíË ßáãÉ ÇáãÑæÑ, íÌÈ ßÊÇÈÉ ÎÇäÉ æÇÍÏÉ Úáì ÇáÃŞá',
        'Can\'t update password, need min. 2 characters!' =>
            'áÇ íãßä ÊÍÏíË ßáãÉ ÇáãÑæÑ, íÌÈ ßÊÇÈÉ ÎÇäÊíä Úáì ÇáÃÃŞá',
        ...
        'You have to select two or more attributes from the select field!' =>
            'íÌÈ Úáíß ÊÍÏíÏ ÚäÕÑíä Ãæ ÃßËÑ ãä ÇáŞÇÆãÉ ÇáãÍÏÏÉ!',
        ...
        'The selected end time is before the start time!' =>
            'æŞÊ ÇáäåÇíÉ ÇáãÍÏÏ ŞÈá æŞÊ ÇáÈÏÇíÉ ÇáãÍÏÏ!!',
        ...
        'The selected end time is after the allowed end time!' =>
            'æŞÊ ÇáäåÇíÉ ÇáãÍÏÏ ÈÚÏ æŞÊ ÇáäåÇíÉ ÇáãÓãæÍ Èå!',
        'The selected time period is larger than the allowed time period!' =>
            'ãÏÉ ÇáæŞÊ ÇáãÍÏÏÉ ÃßÈÑ ãä ÇáãÏÉ ÇáãÓãæÍ ÈåÇ!',
        ...
        'This message was written in a character set other than your own.' =>
            'åĞå ÇáÑÓÇáÉ ßÊÈÊ ÈÊÑãíÒ ãÎÊáİ Úä ÇáÊÑãíÒ ÇáÍÇáí.',
        ...
        'This is a HTML email. Click here to show it.' =>
            'åĞÇ ÈÑíÏ ÅáßÑÊæäí ßÕİÍÉ ÃÊÔ Êí Ãã Çá. ÃÎÊÑ åäÇ áÚÑÖåÇ.',
        'Free Fields'          => '',
        'Merge'                => 'ÏãÌ',
        'merged'               => '',
        ...
        'No such Ticket Number "%s"! Can\'t link it!' =>
            'áã íÊã ÇáÚËæÑ Úáì ÑŞã ÇáÈØÇŞÉ "%s" !! áÇ íãßä ÑÈØåÇ!',
        ...
        'Unlock to give it back to the queue!' =>
            'ÃİÊÍ ÇáÈØÇŞÉ áÅÑÌÇÚåÇ áŞÇÆãÉ ÇáÈØÇŞÇÊ ÇáÎÇÕÉ ÈåÇ!',
        ...
        'Your email with ticket number "<OTRS_TICKET>" is merged to "<OTRS_MERGE_TO_TICKET>".' =>
            'ÈÑíÏß ãÚ ÑŞã ÇáÈØÇŞÉ  "<OTRS_TICKET>" ÏãÌÊ ãÚ "<OTRS_MERGE_TO_TICKET>".',
        ...
        'Send me a notification if there is a new ticket in "My Queues".' =>
            'ÃÑÓáí ÊäÈíå ÅĞÇ æÌÏÊ ÈØÇŞÉ ÌÏíÏÉ İí ŞÇÆãÉ "ÈØÇŞÇÊí".',
        ...
        'Send me a notification if a customer sends a follow up and I\'m the owner of this ticket.'
            => 'ÃÑÓá Åáí ÊäÈíå ÅĞÇÃÑÓá ÇáÚãíá ãáÍŞ ãÊÇÈÚÉ ááÈØÇŞÉ ÅĞÇ ßÇäÊ ãáß áí.',
        'Ticket lock timeout notification' => 'ÊäÈíå ÅäÊåÇÁ æŞÊ ÅŞİÇá ÇáÈØÇŞÉ',
        'Send me a notification if a ticket is unlocked by the system.' =>
            'ÃÑÓá Åáí ÊäÈíå ÚäÏ İÊÍ ÈØÇŞÉ ÈæÇÓØÉ ÇáäÙÇã ÈÚÏ ÅäÊåÇÁ ÇáæŞÊ ÇáãÎÕÕ áÅŞİÇáåÇ.',
        'Move notification' => 'ÊäÈíå ÚäÏ äŞá ÈØÇŞÉ',
        'Send me a notification if a ticket is moved into one of "My Queues".' =>
            'ÃÑÓáí ÊäÈíå ÅĞÇ äŞáÊ ÃÍÏ ÇáÈØÇŞÇÊ Åáì ÃÍÏ ŞæÇÆã "ÈØÇŞÇÊí".',
        'Your queue selection of your favourite queues. You also get notified about those queues via email if enabled.'
            => 'ÇáŞæÇÆã ÇáãİÖáÉ áÏíß ãä ŞæÇÆã ÇáÈØÇŞÇÊ. ÃíÖÇğ ÓíÊã ÊäÈíåß Úä åĞå ÇáŞæÇÆã ãä ÎáÇá ÇáíÈÑíÏ ÇáÅáßÊÑæäí ÅĞÇ İÚáÊ',
        'Custom Queue'            => '',
        'QueueView refresh time'  => 'æŞÊ ÊÍÏíË ŞÇÆãÉ ÇáÈØÇŞÇÊ',
        'Screen after new ticket' => 'ÇáÔÇÔÉ ÈÚÏ ÅäÔÇÁ ÈØÇŞÉ ÌÏíÏÉ',
        'Select your screen after creating a new ticket.' =>
            'ÃÎÊÑ ÇáÔÇÔÉ ááĞåÇÈ ÅáíåÇ ÈÚÏ ÅäÔÇÁ ÈØÇŞÉ ÌÏíÏÉ.',
        'Closed Tickets'       => 'ÇáÈØÇŞÇÊ ÇáãŞİáÉ',
        'Show closed tickets.' => 'ÃÚÑÖ ÇáÈØÇŞÇÊ ÇáãŞİáÉ',
        'Max. shown Tickets a page in QueueView.' =>
            'ÃßÈÑ ÚÏÏ ãä ÇáÈØÇŞÇÊ ÇáãÚÑæÖÉ İí ÇáÕİÍÉ ÇáæÇÍÏÉ İí ŞÇÆãÉ ÇáÈØÇŞÇÊ.',
        ...
        'Customer user will be needed to have a customer history and to login via customer panel.'
            => 'ÇáÚãáÇÁ ãØáæÈæä áÅãßÇäíÉ ÇáÑÌæÚ Åáì ÊÇÑíÎ ÇáÚãáÇÁ ßã íãßäåã ÇáÏÎæá ãä ÔÇÔÉ ÇáÚãáÇÁ.',
        ...
        'Don\'t forget to add a new user to groups and/or roles!' =>
            'áÇÊäÓì ÅÖÇİÉ ÇáãÓÊÎÏã ÇáÌÏíÏ Åáì ãÌãæÚÉ Ãæ ãÌãæÚÉ ÎÕÇÆÕ',
        ...
        'Discard all changes and return to the compose screen' =>
            'ÅáÛÇÁ ÌãíÚ ÇáÊÛííÑÇÊ æ ÇáÚæÏÉ Åáì ÔÇÔÉ ÇáÅÑÓÇá',
        ...
        'Drop Database'                                 => '',
        'Options of the current customer user data (e. g. <OTRS_CUSTOMER_DATA_UserFirstname>)' =>
            'ÇáÎíÇÑÇÊ áÈíÇäÇÊ ÇáÚãíá ÇáÍÇáí(ãËÇáå <OTRS_CUSTOMER_DATA_UserFirstname>)',
        'Pending type'                                   => '',
        'Comment (internal)'                             => '',
        ...
        'You use the DELETE option! Take care, all deleted Tickets are lost!!!' =>
            'ŞãÊ ÈÅÓÊÎÏÇã "ÍĞİ" ! ÌãíÚ ÇáÈØÇŞÇÊ ÇáãÍĞæİÉ ãÓÍÊ ÈÔßá äåÇÆí!!!!',
        'All Customer variables like defined in config option CustomerUser.' => '',
        'accept license'                                                     => '',
        'for agent lastname'                                                 => '',
        'Options of the current user who requested this action (e. g. <OTRS_CURRENT_UserFirstname>)'
            => 'ÇáÎÕÇÆÕ ááãÓÊÎÏã ÇáÍÇáí ÇáĞí ØáÈ åĞå ÇáÚãáíÉ (ãËÇáå <OTRS_CURRENT_UserFirstname>)',
        ...
        'Options of the ticket data (e. g. <OTRS_TICKET_TicketNumber>, <OTRS_TICKET_ID>, <OTRS_TICKET_Queue>, <OTRS_TICKET_State>)'
            => 'ÎíÇÑÇÊ ÈíÇäÇÊ ÇáÈØÇŞÉ (ãËÇáå <OTRS_TICKET_TicketNumber>, <OTRS_TICKET_ID>, <OTRS_TICKET_Queue>, <OTRS_TICKET_State>)',
        'A article should have a title!' => 'ÇáÈØÇŞÉ íÌÈ Ãä íßæä áåÇ ÚäæÇä!',
        'don\'t accept license'          => '',
        'Imported by'                    => 'Êã ÅÓÊíÑÇÏå ãä ÎáÇá',
        'Ticket owner options (e. g. <OTRS_OWNER_UserFirstname>)' =>
            'ÎíÇÑÇÊ ãÇáß ÇáÈØÇŞÉ (ãËÇáå <OTRS_OWNER_UserFirstname>)',
        'read'                              => 'ÅŞÑÃ',
        'Product'                           => '',
