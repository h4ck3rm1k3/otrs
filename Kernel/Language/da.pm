...
# --
# $Id: da.pm,v 1.70 2010/09/08 08:27:10 martin Exp $
# --
...
sub Data {
    ...
    # $$START$$
    # Last translation file sync: 2010-07-30 14:46:40
    ...
    $Self->{Translation} = {
        ...
        'Default spelling dictionary' => 'Standard stave kontrols sprog',
        ...
        'Select the separator character used in CSV files (stats and searches). If you don\'t select a separator here, the default separator for your language will be used.' => 'Vælg det seperator ten der bliver benyttet i CSV filer (Statistik og søgning). Hvis du ikke vælger en seperator vælg standard seperatoren for dit sprog blive benyttet.',
        'CSV Separator' => 'CSV Seperator',
        ...
        'Send new ticket notifications' => 'Send ny sag besked',
        'Ticket follow up notification' => 'Send sags opfølgning besked',
        ...
        'Send ticket lock timeout notifications' => 'Send sags lås udløb beskeder',
        'Ticket move notification' => 'Sags flytnings besked',
        ...
        'Send ticket move notifications' => 'Send sags flytnings besked',
        ...
        'Refresh QueueView after' => 'Opdater KøVisning efter',
        'Screen after new ticket' => 'Skærm efter ny sag',
        'Show this screen after I created a new ticket' => 'Vis dette skærmbillede, after jeg opretter en ny sag',
        ...
        'Ticket Overview "Small" Limit' => 'Sags overblik "lille" begrænsning',
        'Ticket limit per page for Ticket Overview "Small"' => 'Sags begrænsning pr. side for Sags overblik "lille"',
        'Ticket Overview "Medium" Limit' => 'Sags overblik "mellem" begrænsning',
        'Ticket limit per page for Ticket Overview "Medium"' => 'Sags begrænsning pr. side for Sags overblik "mellem"',
        'Ticket Overview "Preview" Limit' => 'Sags overblik "visning" begrænsning',
        'Ticket limit per page for Ticket Overview "Preview"' => 'Sags begrænsning pr. side, for sags overblik "visning"',
        'Ticket watch notification' => 'Sags overvågnings besked',
        'Send me the same notifications for my watched tickets that the ticket owners will get.' => 'Send mig samme besked for mine overvågede sager, som sags ejeren vil få.',
        'Send ticket watch notifications' => 'Send sags overvågnings beskeder',
        'Out Of Office Time' => 'Uden for kontor tid',
