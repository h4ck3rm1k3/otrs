...
# --
# $Id: da.pm,v 1.31 2008/05/15 12:49:31 tr Exp $
# --
...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'The recommended charset for your language is %s!' =>
            'Det anbefalede tegnsæt til dit sprog er %s!',
        'Passwords doesn\'t match! Please try it again!' =>
            'Adgangskoderne er ikke ens! Prøv igen!',
        'Password is already in use! Please use an other password!' =>
            'Adgangskoden er allerede i brug! Brug venligst en anden adgangskode!',
        'Password is already used! Please use an other password!' =>
            'Adgangskoden er allerede brugt! Brug venligst en anden adgangskode!',
        ...
        'Login failed! Your username or password was entered incorrectly.' =>
            'Login mislykkedes! Brugernavnet eller adgangskoden blev forkert indtastet.',
        'Please contact your admin' => 'Kontakt din administrator',
        'Logout successful. Thank you for using OTRS!' =>
            'Du er nu logget ud. Tak fordi du bruger OTRS.',
        ...
        'Session has timed out. Please log in again.' =>
            'Sessionens tidsfrist er udløbet. Vær venlig at logge ind igen.',
        ...
        'Package not correctly deployed! You should reinstall the Package again!' =>
            'Pakke ikke korrekt indsat. Du bør installere pakken igen.',
        ...
        'Can\'t update password, passwords doesn\'t match! Please try it again!' =>
            'Kan ikke opdatere adgangskode, adgangskoderne er ikke ens! Prøv igen!',
        'Can\'t update password, invalid characters!' =>
            'Kan ikke opdatere adgangskode, ugyldige tegn!',
        'Can\'t update password, need min. 8 characters!' =>
            'Kan ikke opdatere adgangskode, der skal være mindst 8 tegn!',
        'Can\'t update password, need 2 lower and 2 upper characters!' =>
            'Kan ikke opdatere adgangskode, der skal være 2 små og 2 store bogstaver!',
        'Can\'t update password, need min. 1 digit!' =>
            'Kan ikke opdatere adgangskode, mindst 1 tal mangler!',
        'Can\'t update password, need min. 2 characters!' =>
            'Kan ikke opdatere adgangskode, mindst 2 tegn mangler!',
        ...
        'You have to select two or more attributes from the select field!' =>
            'Du skal vælge to eller flere attributter fra feltet!',
        ...
        'The selected end time is before the start time!' =>
            'Den valgte sluttid, er før starttiden.',
        ...
        'Please select only one or two elements via the checkbox!' =>
            'Vælg kun ene eller 2 elemeter fra checkboksene.',
        ...
        'Your reporting time interval is too small, please use a larger time scale!' =>
            'Rapport tids-intervallet er for kort, vælg en større tids horisont!',
        'The selected start time is before the allowed start time!' =>
            'Den valgte start tid, er før den tilladte starttid!',
        'The selected end time is after the allowed end time!' =>
            'Den valgte slut tid, el senere end den tilladte sluttid!',
        ...
        'This is a HTML email. Click here to show it.' =>
            'Dette er en e-mail i HTML. Klik her for at vise den.',
        ...
        'No such Ticket Number "%s"! Can\'t link it!' =>
            'Intet sådant sagsnummer "%s"! Kan ikke sammenkæde det!',
        ...
        'Your email with ticket number "<OTRS_TICKET>" is merged to "<OTRS_MERGE_TO_TICKET>".' =>
            'Din e-mail med sagnummer "<OTRS_TICKET>" er samlet til "<OTRS_MERGE_TO_TICKET>".',
        ...
        'Send me a notification if a ticket is unlocked by the system.' =>
            'Send mig en besked, hvis systemet låser en sag op.',
        ...
        'Your queue selection of your favourite queues. You also get notified about those queues via email if enabled.'
            => 'Dit køvalg af foretrukne køer. Du får også besked om disse køer via e-mail, hvis det er aktiveret.',
        ...
        'Select your screen after creating a new ticket.' =>
            'Vælg din skærm, efter ioprettelse af ny sag.',
        'Closed Tickets'       => 'Lukkede sagter',
        'Show closed tickets.' => 'Vis lukkede sagter.',
        'Max. shown Tickets a page in QueueView.' =>
            'Max. viste sager pr. side i kø-visning - QueueView.',
        ...
        'Customer user will be needed to have a customer history and to login via customer panel.'
            => 'Kundebrugeren er nødvendig for at have en kundehistorik og for at logge ind via kundepanelerne.',
        ...
        'If nothing is selected, then there are no permissions in this group (tickets will not be available for the user).'
            => 'Er intet valgt, er der ingen rettigheder i denne gruppe (der er ingen tilgængelige sag til brugeren).',
        'Permission' => 'Tilladdelse',
        'ro'         => '',
        'Read only access to the ticket in this group/queue.' =>
            'Kun læseadgang til sager i denne gruppe/kø.',
        'rw' => '',
        ...
        'Fulltext-Search in Article (e. g. "Mar*in" or "Baue*")' =>
            'Fritekstsøgning i artikel (f.eks. "Mar*in" eller "Baue*")',
        ...
        'Warning! This tickets will be removed from the database! This tickets are lost!' =>
            'Advarsel! Denne sag fjernes fra databasen! Denne sag er gået tabt!',
        ...
        'Yes means, send no agent and customer notifications on changes.' =>
            'Ja betyder, send ingen meddelser til Repræsentant eller Kunde ved ændringer.',
        'No means, send agent and customer notifications on changes.' =>
            'Nej betyder, send meddelser til Repræsentant eller Kunde ved ændringer.',
        'Save' => 'Gem',
        '%s Tickets affected! Do you really want to use this job?' =>
            '%s sager bliver berørt! Ønsker du stadig at køre dette job.',
        '"}' => '',
        ...
        'The admin group is to get in the admin area and the stats group to get stats area.' =>
            'Admin-gruppen skal ind i administratorområdet og statistikgruppen i statistikområdet.',
        'Create new groups to handle access permissions for different groups of agent (e. g. purchasing department, support department, sales department, ...).'
            => 'Opret nye grupper til at håndtere adgangstilladelser for repræsentantens forskellige grupper (f.eks. indkøbs-, support- og salgsafdeling ...).',
        ...
        'Notifications are sent to an agent or a customer.' =>
            'Beskeder sendes til en repræsentant eller kunde.',
        ...
        'Do you really want to uninstall this package?' =>
            'Er du sikker på, du ønsker at afinstallere denne pakke?',
        'Reinstall' => 'Geninstaller',
        'Do you really want to reinstall this package (all manual changes get lost)?' =>
            'Ønsker du virkeleg at geninstallere denne pakke (Alle manuelle ændringer vil blive slettet)?',
        'Continue'                    => '',
        ...
        'All incoming emails with one account will be dispatched in the selected queue!' =>
            'Alle indkommende e-mails med 1 konto sendes til den valgte kø!',
        'If your account is trusted, the already existing X-OTRS header at arrival time (for priority, ...) will be used! PostMaster filter will be used anyway.'
            => 'Er der tillid til din konto, bliver den allerede eksisterende X-OTRS-header ved ankomsttidspunktet (for prioritering, ...) anvendt! Der anvendes PostMaster-filter under alle omstændigheder.',
        ...
        'Do dispatch or filter incoming emails based on email X-Headers! RegExp is also possible.'
            => 'Send eller filtrer indkommende e-mail baseret på hver e-mails X-header! RegExp er også mulig.',
        'If you want to match only the email address, use EMAILADDRESS:info@example.com in From, To or Cc.'
            => '',
        'If you use RegExp, you also can use the matched value in () as [***] in \'Set\'.' =>
            'Anvender du RegExp, kan du også bruge den matchede værdi i () som [***] i \'Set\'.',
        ...
        'If an agent locks a ticket and he/she will not send an answer within this time, the ticket will be unlock automatically. So the ticket is viewable for all other agents.'
            => 'Hvis en repræsentant låser en sag, og vedkommende ikke sender et svar inden for dette tidsrum, låses sagen automatisk op. Derved kan alle andre repræsentanter se sagen.',
        'Escalation time' => 'Eskaleringstid',
        'If a ticket will not be answered in this time, just only this ticket will be shown.' =>
            'Besvares en sag ikke inden for dette tidsrum, vil kun denne sag blive vist.',
        'If a ticket is closed and the customer sends a follow up the ticket will be locked for the old owner.'
            => 'Er en sag lukket, og kunden sender en opfølgning, låses sagen for den gamle ejer.',
        'Will be the sender address of this queue for email answers.' =>
            'Bliver til denne køs afsenderadresse for e-mailsvar.',
        ...
        'OTRS sends an notification email to the customer if the ticket is moved.' =>
            'OTRS sender en e-mail med besked til kunden, hvis sagen er flyttet.',
        'OTRS sends an notification email to the customer if the ticket state has changed.' =>
            'OTRS sender en e-mail med besked til kunden, hvis sagens tilstand er ændret.',
        'OTRS sends an notification email to the customer if the ticket owner has changed.' =>
            'OTRS sender en e-mail med besked til kunden, hvis sagen har fået en anden indehaver.',
        ...
        'Don\'t forget to add a new response a queue!' =>
            'Glem ikke at tilføje et nyt svar pr. kø!',
        ...
        'It\'s useful for a lot of users and groups.' =>
            'Det er nyttigt for mange brugere og grupper.',

        # Template: AdminRoleGroupChangeForm
        'Roles <-> Groups Management' => 'Roller <-> Gruppestyring',
        'move_into'                   => 'flyt_til',
        'Permissions to move tickets into this group/queue.' =>
            'Tilladelser til at flytte sager ind i denne gruppe/kø.',
        'create' => 'opret',
        'Permissions to create tickets in this group/queue.' =>
            'Tilladelser til at oprette sager i denne gruppe/kø.',
        'owner' => 'ejer',
        'Permissions to change the ticket owner in this group/queue.' =>
            'Tilladelser til at ændre sagsejer i denne gruppe/kø.',
        'priority' => 'prioritering',
        ...
        'Take care that you also updated the default states in you Kernel/Config.pm!' =>
            'Sørg for, at du også opdatede standardtilstandene i Kernel/Config.pm!',
        'See also' => 'Se også',
        ...
        'All incoming emails with this "Email" (To:) will be dispatched in the selected queue!' =>
            'Alle indkommende e-mail med denne "E-mail" (Til:) sendes til den valgte kø!',
        ...
        'Don\'t forget to add a new user to groups and/or roles!' =>
            'Glem ikke at tilføje en ny bruger til grupper og/eller roller!',
        ...
        'Discard all changes and return to the compose screen' =>
            'Kassér alle ændringer og vend tilbage til skriveskærmen',
        ...
        'Do you really want to delete this Object?' =>
            'Er du sikker på, du ønsker at slette dette objekt?',

        # Template: AgentStatsEditRestrictions
        'Select the restrictions to characterise the stat' =>
            'Vælg begrænsningerne til at karakterisere stat',
        'Fixed' => 'Fast',
        ...
        'In this form you can select the basic specifications.' =>
            'I denne formular kan du vælge de grundlæggende specifikationer.',
        'Attribute'          => 'Atribut',
        'Title of the stat.' => 'Title på stat.',
        'Here you can insert a description of the stat.' =>
            'Her kan du indtaste en beskrivelse af stat.',
        'Dynamic-Object' => 'Dynamisk-Objekt',
        'Here you can select the dynamic object you want to use.' =>
            'Her kan du vælge det dynamiske objekt du vil bruge',
        '(Note: It depends on your installation how many dynamic objects you can use)' =>
            '(Bemlrk: Det afhænger af din installation hvor mange dynamiske objekter du kan bruge)',
        'Static-File' => 'Statisk-Fil',
        'For very complex stats it is possible to include a hardcoded file.' =>
            'For meget komplekse statistiker er det muligt at inkludere en hardcoded fil.',
        'If a new hardcoded file is available this attribute will be shown and you can select one.'
            => 'Hvis en hardcoded fil er tilgængelig, vil denne attribute være vist, og du kan vælge den.',
        'Permission settings. You can select one or more groups to make the configurated stat visible for different agents.'
            => 'Rettigheds indstillinger, Du kan vælge en eller flere grupper, for at gøre den konfigurerede stat synlig for forskellige agenter.',
        ...
        'If you need the sum of every row select yes' =>
            'Hvis du skal bruge summen af hver række, vælg da ja',
        'If you need the sum of every column select yes.' =>
            'Hvis du skal bruge summe af hver kolonne vælg da ja',
        'Most of the stats can be cached. This will speed up the presentation of this stat.' =>
            'De fleste statistikker kan blive cachet, det vil gøre præsentationen hurtigere',
        '(Note: Useful for big databases and low performance server)' =>
            '(Bemærk: Brugbart for store databse og lavydelse servere)',
        'With an invalid stat it isn\'t feasible to generate a stat.' =>
            'Med en ugyldig stat er det ikke muligt at generere en stat',
        'This is useful if you want that no one can get the result of the stat or the stat isn\'t ready configurated.'
            => 'Dette er brugbart hvis du ikke ønsker at nogen kan se resultatet afen stat der ikke er konfigureret.',
        ...
        'Please remember, that the scale for value series has to be larger than the scale for the X-axis (e.g. X-Axis => Month, ValueSeries => Year).'
            => 'Husk venligst at skalen for værdi serien, skal være større end den skala for X-Aksen (f.eks. X-Akse => Month, VærdiSerie => År).',
        'Here you can the value series. You have the possibility to select one or two elements. Then you can select the attributes of elements. Each attribute will be shown as single value series. If you don\'t select any attribute all attributes of the element will be used if you generate a stat. As well a new attribute is added since the last configuration.'
            => 'Her kan du vælge værdi serierne. Du har muligheden for at vælge en eller to elementer. Derefter kan du vælge attributter for elementerne. Hvert element vil blive vist som en enkelt værdi sere. Hvis du ikke har valgt nogle attributter, vil alle attributter for elementet blive brugt til at generere stat. Ligesom en ny attribut vil blive tilføjet siden sidste konfiguration.',

        # Template: AgentStatsEditXaxis
        'Select the element, which will be used at the X-axis' =>
            'Vælg det element der skal bruges ved X-aksen',
        'maximal period' => 'maksimal periode',
        'minimal scale'  => 'minimal skala',
        'Here you can define the x-axis. You can select one element via the radio button. Then you you have to select two or more attributes of the element. If you make no selection all attributes of the element will be used if you generate a stat. As well a new attribute is added since the last configuration.'
            => 'Her kan du definere X-aksen. Du kan vælge et element med radio button. Derefter skal du vælge et eller flere attributter til elementet. Hvis du ikke vælger nogle attributter, vil alle attributter blive brugt, ligesom et nyt attribut vil blive gemt, siden sidste konfiguration.',
        ...
        'With the input and select fields you can configurate the stat at your needs. Which elements of a stat you can edit depends on your stats administrator who configurated the stat.'
            => 'Med input og select felterne kan du konfigurere en stat til dine behov. Hvilket element af en stat du kan rette afhænger af administratoren der har konfigureret denne stat.',
        ...
        'Set customer user and customer id of a ticket' =>
            'Indstil en sags kundebruger og kunde-ID',
        ...
        '(The identify of the system. Each ticket number and each http session id starts with this number)'
            => '(Systemets identificering. Hvert sagnummer og hver http-sessions ID starter med dette tal) ',
        'System FQDN' => 'Systemets FQDN',
        '(Full qualified domain name of your system)' =>
            '(Dit systems FQDN(Fully qualified domain name)) ',
        ...
        'Use utf-8 it your database supports it!' =>
            'Anvend utf-8, hvis din database understøtter det!',
        ...
        '(Checks MX recordes of used email addresses by composing an answer. Don\'t use CheckMXRecord if your OTRS machine is behinde a dial-up line $!)'
            => '(Kontrollerer MX-records af anvendte e-mailadresser ved at udforme et svar. Anvend ikke KontrollerMXRecord, hvis OTRS-maskinen befinder sig bag en opkaldslinje $!)',
        ...
        'After doing so your OTRS is up and running.' =>
            'Når det er gjort, er din OTRS sat i gang og fungerer.',
        ...
        '(Ticket identifier. Some people want toset this to e. g. \'Ticket#\', \'Call#\' or \'MyTicket#\')'
            => '(Sagidentifikator. Nogle personer ønsker at indstille dette til f.eks. \Ticket#\, \Call#\ eller \MyTicket#\)',
        'In this way you can directly edit the keyring configured in Kernel/Config.pm.' =>
            'Du kan på denne måde direkte redigere den nøglering, der er konfigureret i Kernel/Config.pm.',
        ...
        'Customer history search (e. g. "ID342425").' =>
            'Kundehistoriksøgning (f.eks. "ID342425").',
        'Close!'              => 'Luk!',
        'for agent firstname' => 'til repræsentantens fornavn',
        'The message being composed has been closed.  Exiting.' =>
            'Den meddelelse, der er ved at blive formuleret, er blevet lukket.  Afslutter.',
        'A web calendar' => 'En webkalender',
        'to get the realname of the sender (if given)' =>
            'for at få afsenderens virkelige navn (hvis det er oplyst)',
        ...
        'Home'     => 'Hjem',
        'Config options (e. g. <OTRS_CONFIG_HttpType>)' =>
            'Konfigurationsmuligheder (f.eks. <OTRS_CONFIG_HttpType>)',
        ...
        'Your email with ticket number "<OTRS_TICKET>" is bounced to "<OTRS_BOUNCE_TO>". Contact this address for further informations.'
            => 'Din e-mail med sagnummer "<OTRS_TICKET>" er sendt retur til afsender til "<OTRS_BOUNCE_TO>". Kontakt denne adresse for at få flere oplysninger.',
        ...
        'Options of the current customer user data (e. g. <OTRS_CUSTOMER_DATA_UserFirstname>)' =>
            'Valgmuligheder for de aktuelle kundebrugerdata (f.eks. <OTRS_CUSTOMER_DATA_UserFirstname>)',
        'Pending type'                                                  => 'Afventer type',
        'Comment (internal)'                                            => 'Kommentar (intern)',
        'Ticket owner options (e. g. &lt;OTRS_OWNER_USERFIRSTNAME&gt;)' => '',
        'This window must be called from compose window' =>
            'Dette vindue skal åbnes via Skriv-vinduet.',
        'You need min. one selected Ticket!' => 'Du skal vælge mindst 1 dag!',
        'Options of the ticket data (e. g. <OTRS_TICKET_Number>, <OTRS_TICKET_ID>, <OTRS_TICKET_Queue>, <OTRS_TICKET_State>)'
            => 'Valgmuligheder for sagens data (f.eks. <OTRS_TICKET_Number>, <OTRS_TICKET_ID>, <OTRS_TICKET_Queue>, <OTRS_TICKET_State>)',
        ...
        'All Customer variables like defined in config option CustomerUser.' =>
            'Alle kundevariabler som definerede i konfigurationsmuligheden KundeBruger.',
        'accept license'     => 'accepter licens',
        '0'                  => '0',
        'for agent lastname' => 'til agents efternavn',
        'Options of the current user who requested this action (e. g. <OTRS_CURRENT_UserFirstname>)'
            => 'Valgmuligheder for den aktuelle bruger, som anmodede om denne handling (f.eks. <OTRS_CURRENT_UserFirstname>)',
        ...
        'Don\'t forget to add a new user to groups!' =>
            'Glem ikke at tilføje en ny bruger til grupper!',
        'You need a email address (e. g. customer@example.com) in To:!' =>
            'Der skal være en e-mailadresse (f.eks. customer@eksempel.com) i feltet Til:!',
        ...
        'Options of the ticket data (e. g. <OTRS_TICKET_TicketNumber>, <OTRS_TICKET_ID>, <OTRS_TICKET_Queue>, <OTRS_TICKET_State>)'
            => 'Valgmuligheder for de aktuelle sagsdata (f.eks. lt;OTRS_TICKET_TicketNumber>, <OTRS_TICKET_ID>, <OTRS_TICKET_Queue>, <OTRS_TICKET_State>)',
        'Artefact'                                            => 'Artefakt',
        ...
        'WebMail'                                             => '',
        'Options of the ticket data (e. g. <OTRS_TICKET_TicketNumber>, <OTRS_TICKET_TicketID>, <OTRS_TICKET_Queue>, <OTRS_TICKET_State>)'
            => 'Valgmuligheder for sagens data (f.eks. <OTRS_TICKET_TicketNumber>, <OTRS_TICKET_TicketID>, <OTRS_TICKET_Queue>, <OTRS_TICKET_State>)',
        'Ticket owner options (e. g. <OTRS_OWNER_UserFirstname>)' =>
            'Sagsejers valgmuligheder (f.eks. <OTRS_OWNER_UserFirstname>)',
        ...
        'Package not correctly deployed, you need to deploy it again!' =>
            'Pakken blev ikke korrekt installeret, den skal installeres igen!',
        'QueueView'                        => 'KøVisning',
