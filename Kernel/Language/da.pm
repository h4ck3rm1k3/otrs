...
# --
# $Id: da.pm,v 1.83.2.2 2011/05/16 20:29:45 mp Exp $
# --
...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'Remove from list of watched tickets' => 'Fjern fra listen over overvågede sager',
        'Add to list of watched tickets' => 'Føj til listen over overvågede sager',
        'Email-Ticket' => 'Email-sag',
        'Create new Email Ticket' => 'Opret ny email-sag',
        'Phone-Ticket' => 'Ny Sag',
        ...
        'Send Email and create a new Ticket' => 'Send email og opret en ny sag',
        'Create new Email Ticket and send this out (Outbound)' => 'Opret ny email-sag, og send den (Outbound)',
        ...
        'Your queue selection of your favourite queues. You also get notified about those queues via email if enabled.' => 'Dit valg af foretrukne køer. Du får besked om handlinger i disse køer via email, hvis det er aktiveret.',
        ...
        'Ticket watch notification' => 'Besked om overvågede sager',
        'Send me the same notifications for my watched tickets that the ticket owners will get.' => 'For mine overvågede sager, send mig samme notifikationer som sagernes ejere får.',
        'Send ticket watch notifications' => 'Send besked om overvågede sager',
        ...
        'This email address failed MX check.' => 'Denne adresse fejler MX-tjek.',
        ...
        'Mail Account Management' => 'Administrer email-konti',
        'Add mail account' => 'Tilføj mailkonto',
        'All incoming emails with one account will be dispatched in the selected queue!' => 'Alle indkommende emails med 1 konto tildeles til den valgte kø.',
        ...
        'Your email address is' => 'Din mailadresse er',
        ...
        'System Email Addresses Management' => 'Administrer systemets email-adresser',
        'Add system address' => 'Tilføj systemadresse',
        'All incoming email with this address in To or Cc will be dispatched to the selected queue.' => '',
        'Email address' => 'Email-adresse',
        'Display name' => 'Vist navn',
        'Add System Email Address' => 'Tilføj system-email-adresse',
        'Edit System Email Address' => 'Rediger system-email-adresse',
        'The display name and email address will be shown on mail you send.' => 'Vist navn og email-adresse vil blive vist på mail, du sender.',
        ...
        'Add email address %s to the To field' => 'Tilføj email-adresse %s til Til-feltet',
        'Add email address %s to the Cc field' => 'Tilføj email-adresse %s til Cc-feltet',
        'Add email address %s to the Bcc field' => 'Tilføj email-adresse %s til Bcc-feltet',
        'Apply' => 'Opdater',
        ...
        'Need a valid email address.' => 'Angiv en gyldig email-adresse',
        'Address book' => 'Adressebog',
        'Pending Date' => 'Afventer dato',
        ...
        'Need a valid email address or don\'t use a local email address' => 'Angiv en gyldig emailadresse, eller brug ikke en lokal emailadresse',
        ...
        'Email Text Plain View' => 'Vis emailens kildetekst',
        'Plain' => 'Kildetekst',
        'Download this email' => 'Download denne email',
        ...
        'Your User Name' => 'Dit brugernavn',
        'A new password will be sent to your email address.' => 'Et nyt password bliver sendt til din email-adresse.',
        ...
        'Manage PGP keys for email encryption.' => 'Administrer PGP-nøgler for email-kryptering',
        'Manage POP3 or IMAP accounts to fetch email from.' => 'Administrer POP3- eller IMAP-konto, der skal hentes email fra.',
        'Manage S/MIME certificates for email encryption.' => 'Administrer S/MIME-certifikater for email-kryptering.',
        ...
        'Max size of the subjects in an email reply.' => 'Max. størrelse på emnet i et email-svar.',
