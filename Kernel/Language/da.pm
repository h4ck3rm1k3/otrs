...
# --
# $Id: da.pm,v 1.83.2.4 2011/09/07 20:59:34 en Exp $
# --
...
sub Data {
    ...
    # $$START$$
    # Last translation file sync: 2011-08-05 08:37:10
    ...
    $Self->{Translation} = {
        ...
        'Defines the next state of a ticket after being moved to another queue, in the move ticket screen of the iPhone interface.' => '',
        ...
        'Sets the service in the new phone ticket screen of the iPhone interface (Ticket::Service needs to be activated).' => '',
        ...
        'Sets the ticket type in the new phone ticket screen on the iPhone interface (Ticket::Type needs to be activated).' => '',
        ...
        'Ticket free text options shown in the close ticket screen of the iPhone interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' => '',
