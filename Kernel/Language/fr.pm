...
# --
# $Id: fr.pm,v 1.74 2007/06/26 16:20:07 martin Exp $
# --
...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'Security Note: You should activate %s because application is already running!' => 'Note de Sécurité: Vous devriez activer %s parce que l\'application est déjà lancé !',
        ...
        'Do you really want to reinstall this package (all manual changes get lost)?' => 'Voulez-vous vraiment réinstaller ce paquet (Tout les changements manuels seront perdus) ?',
        'Cancle' => 'Annuler',
        'Continue' => 'Continuer',
        ...
        'Fixed' => 'Fixé',
        'Please select only one element or turn off the button \'Fixed\'.' => 'Sélectionnez un seul élément ou passez le bouton \'Fixé\' à Off',
        'Absolut Period' => 'Période absolue',
        'Between' => 'Entre',
        'Relative Period' => '',
        'The last' => 'Le dernier',
        'Finish' => 'Terminer',
        'Here you can make restrictions to your stat.' => 'Vous pouvez ici mettre des restrictions à vos statistiques.',
