...
# --
# $Id: fr.pm,v 1.127 2010/09/08 19:31:16 mb Exp $
# --
...
sub Data {
    ...
    # $$START$$
    # Last translation file sync: 2010-07-30 14:47:09
    ...
    $Self->{Translation} = {
        ...
        'Customer Companies' => 'Entreprises du client',
        'Company' => 'Entreprise',
        'go!' => 'c\'est parti !',
        'go' => 'aller',
        'All' => 'Tout',
        ...
        'Default spelling dictionary' => 'Dictionnaire orthographique par défaut',
        ...
        'Can\'t update password, it must contain at least 2 lowercase  and 2 uppercase characters!' => 'Impossible de mettre à jour le mot de passe, il doit contenir au moins 2 lettres en minuscule et 2 en majuscule!',
        ...
        'Can\'t update password, it must contain at least 2 characters!' => 'Impossible de mettre à jour le mot de passe, il doit contenir au moins 2 caractères!',
        'Can\'t update password, this password has already been used. Please choose a new one!' => 'Impossible de mettre à jour le mot de passe, ce mot de passe a déjà été utilisé. Merci d\'en choisir un autre!',
        'Select the separator character used in CSV files (stats and searches). If you don\'t select a separator here, the default separator for your language will be used.' => 'Choisir le caractère de séparation utilisé dans les fichiers CSV (stattistiques et recherches). Si vous n\'en sélectionnez pas ici, le séparateur par défaut de votre langue sera utilisé.',
        ...
        'Please select only one element or turn off the button \'Fixed\' where the select field is marked!' => 'Merci de sélectionner un seul élément ou de désactiver le bouton \'Fixe\' où le bouton de sélection est marqué',
        ...
        'Send new ticket notifications' => 'Envoyer notifications de nouveau ticket',
        ...
        'Send ticket lock timeout notifications' => 'Envoyer notification de limite de temps du blocage ticket',
        ...
        'Send ticket move notifications' => 'Envoyer notifications de déplacement de ticket',
        ...
        'If enabled, the QueueView will automatically refresh after the specified time.' => 'Si activé, la veu de queue sera automatiquement rafraîchit après le temps spécifié',
        'Refresh QueueView after' => 'Rafraichîr la vue de queue après',
        ...
        'Ticket Overview "Small" Limit' => 'Limite résumé ticket "Petite"',
        'Ticket limit per page for Ticket Overview "Small"' => 'Limite de ticket par page pour le résumé ticket "Petit"',
        'Ticket Overview "Medium" Limit' => 'Limite résumé ticket "Moyenne"',
        'Ticket limit per page for Ticket Overview "Medium"' => 'Limite de ticket par page pour le résumé ticket "Moyen"',
        'Ticket Overview "Preview" Limit' => 'Limite résumé ticket "prévisualisation"',
        'Ticket limit per page for Ticket Overview "Preview"' => 'Limite ticket par page pour résumé de ticket "prévisualisation"',
        'Ticket watch notification' => 'Notification de visualisation de ticket',
        'Send me the same notifications for my watched tickets that the ticket owners will get.' => 'M\'envoyer les mêmes notifications pour les tickets suivis que ceux que les propriétaires du ticket recevront',
        'Send ticket watch notifications' => 'M\'envoyer des notifications de visualisation de ticket',
        'Out Of Office Time' => 'Heure d\'absences',
        ...
        'Just use this feature if you want to define group permissions for customers.' => 'Utiliser cette fonction uniquement si vous shouhaitez définir des permissions de groupe pour les clients',
        ...
        'They can be administrered through the configuration setting "CustomerGroupAlwaysGroups".' => 'Ils peuvent être gérer via l\'option de configuration "CustomerGroupAlwaysGroups".',
        ...
        'If nothing is selected, then there are no permissions in this group (tickets will not be available for the customer).' => 'Si rien n\'est sélectionné, alors il n\'y aura aucune permission dans ce groupe (les tickets ne seront pas accessibles au client).',
        ...
        'Send Administrative Message to Agents' => 'Envoyer un Message Administratif aux Agents',
        ...
        'Set new priority' => 'Mettre nouvelle priorité',
        'Set new queue' => 'Mettre nouvelle queue',
        'Set new state' => 'Mettre nouvel état',
        'Set new agent' => 'Mettre nouvel agent',
        ...
        'Warning: You used the DELETE option. All deleted tickets will be lost!' => 'Attention: Vous devriez utiliser l\'option DELETE. Tous les tickets effacés seront perdus!',
        ...
        'Create new groups to handle access permissions for different groups of agent (e. g. purchasing department, support department, sales department, ...). ' => 'Créer de nouveux groupes pour gérer des permissions d\'accès pour les différents groupes d\'agent (i.e. achats, support, ventes,...). ',
        ...
        'Agent Management' => 'Gestion Agent',
        'Queue Settings' => 'Configuration Queue',
        ...
        'Package not correctly deployed! You should reinstall the package again!' => 'Package incorrectement déployé! Vous devriez réinstaller le package!',
        ...
        # Template: AdminQueue
        'Manage Queues' => 'Gérer les Queues',
        'Add queue' => 'Ajouter queue',
        'Add Queue' => 'Ajouter Queue',
        'Edit Queue' => 'Editer Queue',
        'Sub-queue of' => 'Sous queue de',
        ...
        'If an agent locks a ticket and does not close it before the unlock timeout has passed, the ticket will unlock and will become available for other agents.' => 'Si un agent vérouille a ticket et ne le ferme pas avant le délai de dévérouillage, le ticket sera dévérouillé et sera disponible pour un autre agent.',
        'Notify by' => 'Notification par',
        '0 = no escalation' => '0 = pas de remontée du ticket',
        'If there is not added a customer contact, either email-external or phone, to a new ticket before the time defined here expires, the ticket is escalated.' => 'Si un contact client n\'est pas ajouté à un nouveau ticket, soit par email externe ou téléphone, avant que le temps défini ici expire, le ticket sera escaladé.',
        'If there is an article added, such as a follow-up via e-mail or the customer portal, the escalation update time is reset. If there is no customer contact, either email-external or phone, added to a ticket before the time defined here expires, the ticket is escalated.' => 'Si un article est ajouté, tel un suivi par email ou via le portail client, le délai d\'escalade est remis à zéro. Si un contact client n\'est pas ajouté à un ticket, soit par email externe ou téléphone, avant que le temps défini ici expire, le ticket sera escaladé.',
        'If the ticket is not set to closed before the time defined here expires, the ticket is escalated.' => 'Si le ticket n\'est pas clôturé avant que le délai défini ici n\'expire, le ticket est escaladé.',
        ...
        'If a ticket is closed and the customer sends a follow up the ticket will be locked to the old owner.' => 'Si le tiket est clos and que le client envoie un suivi, le ticket sera vérouillé sur l\'ancien propriétaire.',
        ...
        'Manage Queue-Auto Response Relations' => 'Gérer les Relations de Réponse Queue-Auto',
        ...
        'Change Auto Response Relations for Queue' => 'Modifier les Relations de Réponse Automatique pour la Queue',
        'settings' => 'Paramètres',

        # Template: AdminQueueResponses
        'Manage Response-Queue Relations' => 'Gérer les Relations de Réponse-Queue',
        'Filter' => 'Filtre',
        ...
        'There are no roles defined. Please use the \'Add\' button to create a new role.' => 'Il n\'y a pas de rôle défini. Utilisez le bouton \'Ajouter\' pour créer un nouveau rôle.',
        ...
        'Customer sessions' => 'Session des clients',
        'Unique agents' => 'Agents uniques',
        ...
        'This config item is only available in a higher config level!' => 'Cet élément de configuration n\'est disponible que dans un niveau supérieur de configuration',
        ...
        'All incoming email with this address in To or Cc will be dispatched to the selected queue.' => 'Tous les mails entrants avec cette adresse dans To ou Cc sera dispatchée dans la queue sélectionnée',
        'Email address' => 'Adresse email',
        'Display name' => 'Nom à afficher',
        'Add System Email Address' => 'Ajouter adresse email système',
        'Edit System Email Address' => 'Editer adresse email système',
        'The display name and email address will be shown on mail you send.' => 'Le nom à afficher et l\'adresse email seront affichés dans les mails que vous envoyez.',
        ...
        'Agents will be needed to handle tickets.' => 'Des agents seront requis pour gérer les tickets',
        'Don\'t forget to add a new agent to groups and/or roles!' => 'N\'oubliez pas d\'ajouter a nouvel agent aux groupes et/ou rôles',
        'Please enter a search term to look for agents.' => 'Merci d\'entrer un motid de recherche pour chercher des agents',
        'Last login' => 'Dernière connexion',
        'Login as' => 'Connecté en tant que',
        'Switch to agent' => 'Changer d\'agent vers',
        'Add Agent' => 'Ajouter Agent',
        'Edit Agent' => 'Editer Agent',
        'Firstname' => 'Prénom',
        'Lastname' => 'Nom',
        'Start' => 'Démarrer',
        'End' => 'Fin',
        ...
        'owner' => 'propriétaire',
        'Permissions to change the owner of tickets in this group/queue.' => 'Permissions de changer le propriétaire des tickets dans ce gorupe/cette queue.',
        ...
        'Need a valid email address or don\'t use a local email address.' => 'Une adresse email valide est nécessaire ou n\'utilisez pas d\'adresse email locale.',
        'Need a valid email address or don\'t use a local email address' => 'Une adresse email valide est nécessaire ou n\'utilisez pas d\'adresse email locale',
        'Need a valid mail address or don\'t use a local email address' => 'Une adresse mail valide est nécessaire ou n\'utilisez pas d\'adresse email locale',
        ...
        'From queue' => 'De la Queue',
        'A ticket should be associated with a queue!' => 'Un ticket doit être associé à une queue',
        'Queue is required.' => 'Une Queue est requise',
        'Need a valid mail address or don\'t use a local email address.' => 'Une adresse email valide est nécessaire ou n\'utilisez pas d\'adresse email locale.',
        ...
        'Article(s)' => 'Article(s)',
        'Move ticket to a different queue' => 'Déplacer ticket vers une autre queue',
        'Change Queue' => 'Modifier Queue',
        'Add Filter' => 'Ajouter filtre',
        'Set' => 'Assigner',
        ...
        'To protect your privacy, active or/and remote content has blocked.' => 'Pour protéger votre vie privée, les contenus actifs ou distants ont été bloqués.',
        ...
        'New' => 'Nouveau',
        'A new database user with limited rights will be created for this OTRS system.' => 'Un nouvel utilisateur de la base de données sera créé avec des droits limités pour ce système OTRS.',
        ...
        'SystemID' => 'ID Système',
        'The identify of the system. Each ticket number and each http session id starts with this number.' => 'L\'idéntité de ce système. Chaque numéro de ticket et chaque id de session http commence avec ce numéro',
        ...
        'Checks MX recordes of used email addresses by composing an answer. Don\'t use CheckMXRecord if your OTRS machine is behind a dial-up line!' => 'Vérifier les enregistrements MX des adresses email utilisées en créant une réponse. N\'utilisez pas CheckMXRecord si votre machine OTRS se trouve derrière une ligne téléphonique.',
        ...
        'OTRS runs with a huge lists of browsers, please upgrade to one of these.' => 'OTRS tourne sur un grand nombre de navigateurs, merci de mettre à jour votre navigateur vers l\'un de ceux-ci.',
        'Please see the documentation or ask your admin for further information.' => 'Merci de se référer à la documentation ou demander à votre administrateur système pour de plus amples informations.',
        ...
        # SysConfig
        'ACL module that allows closing parent tickets only if all its children are already closed ("State" shows which states are not available for the parent ticket until all child tickets are closed).' => 'Module ACL qui autorise la fermture du ticket parent uniquement si tout ses enfants sont déjà clos("Etat" montre quels états ne sont pas disponibles pour le ticket parent tant que ses enfants ne sont pas clos).',
        'Activates TypeAhead for the autocomplete feature, that enables users to type in whatever speed they desire, without losing any information. Often this means that keystrokes entered will not be displayed on the screen immediately.' => 'Active la fonction TypeAhead pour l\'autocomplétion. Ceci permet à l\'utilisateur de taper à la vitesse désirée sans perte d\'information. Souvent cela signifie que les caractères frappés ne seront pas affichés à l\'écran immédiatement.',
        'Activates a blinking mechanism of the queue that contains the oldest ticket.' => 'Active un méchanisme de clignotement de la queue qui contient le plus vieux ticket.',
        'Activates lost password feature for agents, in the agent interface.' => 'Active la fonction de mot de passe perdu pour les agents, dans l\'interface des agents.',
        ...
        'Activates the article filter in the zoom view to specify which articles should be shown.' => 'Active le filtre d\'article dans la vue de zoom pour spécifier quels articles doivent être montrés.',
        ...
        'Adds the one time vacation days for the calendar number 3. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' => 'Ajoute les jour de vacances pour le calendrier 3. Merci d\'utiliser un seul chiffre pour les nombres de 1 à 9 (au lieu de 01 - 09).',
        'Adds the one time vacation days for the calendar number 4. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' => 'Ajoute les jour de vacances pour le calendrier 4. Merci d\'utiliser un seul chiffre pour les nombres de 1 à 9 (au lieu de 01 - 09).',
        'Adds the one time vacation days for the calendar number 5. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' => 'Ajoute les jour de vacances pour le calendrier 5. Merci d\'utiliser un seul chiffre pour les nombres de 1 à 9 (au lieu de 01 - 09).',
        'Adds the one time vacation days for the calendar number 6. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' => 'Ajoute les jour de vacances pour le calendrier 6. Merci d\'utiliser un seul chiffre pour les nombres de 1 à 9 (au lieu de 01 - 09).',
        'Adds the one time vacation days for the calendar number 7. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' => 'Ajoute les jour de vacances pour le calendrier 7. Merci d\'utiliser un seul chiffre pour les nombres de 1 à 9 (au lieu de 01 - 09).',
        'Adds the one time vacation days for the calendar number 8. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' => 'Ajoute les jour de vacances pour le calendrier 8. Merci d\'utiliser un seul chiffre pour les nombres de 1 à 9 (au lieu de 01 - 09).',
        'Adds the one time vacation days for the calendar number 9. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' => 'Ajoute les jour de vacances pour le calendrier 9. Merci d\'utiliser un seul chiffre pour les nombres de 1 à 9 (au lieu de 01 - 09).',
        'Adds the one time vacation days. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' => 'Ajoute les jour de vacances. Merci d\'utiliser un seul chiffre pour les nombres de 1 à 9 (au lieu de 01 - 09).',
        'Adds the permanent vacation days for the calendar number 1. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' => 'Ajoute les jour de vacances permanentes pour le calendrier 1. Merci d\'utiliser un seul chiffre pour les nombres de 1 à 9 (au lieu de 01 - 09).',
        'Adds the permanent vacation days for the calendar number 2. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' => 'Ajoute les jour de vacances permanentes pour le calendrier 2. Merci d\'utiliser un seul chiffre pour les nombres de 1 à 9 (au lieu de 01 - 09).',
        'Adds the permanent vacation days for the calendar number 3. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' => 'Ajoute les jour de vacances permanentes pour le calendrier 3. Merci d\'utiliser un seul chiffre pour les nombres de 1 à 9 (au lieu de 01 - 09).',
        'Adds the permanent vacation days for the calendar number 4. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' => 'Ajoute les jour de vacances permanentes pour le calendrier 4. Merci d\'utiliser un seul chiffre pour les nombres de 1 à 9 (au lieu de 01 - 09).',
        'Adds the permanent vacation days for the calendar number 5. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' => 'Ajoute les jour de vacances permanentes pour le calendrier 5. Merci d\'utiliser un seul chiffre pour les nombres de 1 à 9 (au lieu de 01 - 09).',
        'Adds the permanent vacation days for the calendar number 6. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' => 'Ajoute les jour de vacances permanentes pour le calendrier 6. Merci d\'utiliser un seul chiffre pour les nombres de 1 à 9 (au lieu de 01 - 09).',
        'Adds the permanent vacation days for the calendar number 7. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' => 'Ajoute les jour de vacances permanentes pour le calendrier 7. Merci d\'utiliser un seul chiffre pour les nombres de 1 à 9 (au lieu de 01 - 09).',
        'Adds the permanent vacation days for the calendar number 8. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' => 'Ajoute les jour de vacances permanentes pour le calendrier 8. Merci d\'utiliser un seul chiffre pour les nombres de 1 à 9 (au lieu de 01 - 09).',
        'Adds the permanent vacation days for the calendar number 9. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' => 'Ajoute les jour de vacances permanentes pour le calendrier 9. Merci d\'utiliser un seul chiffre pour les nombres de 1 à 9 (au lieu de 01 - 09).',
        'Adds the permanent vacation days. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' => 'Ajoute les jour de vacances permanentes. Merci d\'utiliser un seul chiffre pour les nombres de 1 à 9 (au lieu de 01 - 09).',
        'Admin-Area' => 'Zone d\'administration',
        'Agent Notifications' => 'Notifications d\'Agent',
        'Agent interface article notification module to check PGP.' => 'Module de notification d\'article dans l\'interface Agent pour vérifier le PGP',
        'Agent interface article notification module to check S/MIME.' => 'Module de notification d\'article dans l\'interface Agent pour vérifier le S/MIME',
        'Agent interface module to access fulltext search via nav bar.' => 'Module de l\'interface Agent pour accéder à la recherche plein texte dans la barre de navigation.',
        'Agent interface module to access search profiles via nav bar.' => 'Module de l\'interface Agent pour accéder à la recherche des profiles dans la barre de navigation.',
        ...
        'Allows adding notes in the close ticket screen of the agent interface.' => 'Autorise l\'ajout de notes dans l\'écran de fermeture du ticket dans l\'interface agent.',
        'Allows adding notes in the ticket free text screen of the agent interface.' => 'Autorise l\'ajout de notes dans l\'écran de champ libre du ticket dans l\'interface agent.',
        'Allows adding notes in the ticket note screen of the agent interface.' => 'Autorise l\'ajout de notes dans l\'écran de note du ticket dans l\'interface agent.',
        'Allows adding notes in the ticket owner screen of a zoomed ticket in the agent interface.' => 'Autorise l\'ajout de notes dans l\'écran de propriétaire d\'un ticket zoomé dans l\'interface agent.',
        'Allows adding notes in the ticket pending screen of a zoomed ticket in the agent interface.' => 'Autorise l\'ajout de notes dans l\'écran de mise en attente d\'un ticket zoomé dans l\'interface agent.',
        'Allows adding notes in the ticket priority screen of a zoomed ticket in the agent interface.' => 'Autorise l\'ajout de notes dans l\'écran de priorité d\'un ticket zoomé dans l\'interface agent.',
        'Allows adding notes in the ticket responsible screen of the agent interface.' => 'Autorise l\'ajout de notes dans l\'écran de responsable d\'un ticket dans l\'interface agent.',
        'Allows agents to exchange the axis of a stat if they generate one.' => 'Autorise les agent à échanger les axes d\'une statistique si ils en génèrent une.',
        'Allows agents to generate individual-related stats.' => 'Autorise les agents à générer des statistiques relatives à un individu.',
        ...
        'Create and manage notifications that are sent to agents.' => 'Créer et gérer les notifications envoyées aux agents.',
        'Create and manage queues.' => 'Créer et gérer les queues.',
        ...
        'Customer item (icon) which shows the open tickets of this customer as info block.' => 'Icon de l\'entreprise à montrer dnas le ticket pour ce client dnas le bloc d\'information.',
        'Customers' => 'Clients',
        ...
        'Defines a customer item, which generates a LinkedIn icon at the end of a customer info block.' => 'Défini un élément client qui génère un icone LinkedIn à la fin du bloc d\'information client.',
        'Defines a customer item, which generates a XING icon at the end of a customer info block.' => 'Défini un élément client qui génère un icone XING à la fin du bloc d\'information client.',
        'Defines a customer item, which generates a google icon at the end of a customer info block.' => 'Défini un élément client qui génère un icone Google à la fin du bloc d\'information client.',
        'Defines a customer item, which generates a google maps icon at the end of a customer info block.' => 'Défini un élément client qui génère un icone Google Maps à la fin du bloc d\'information client.',
        'Defines a default list of words, that are ignored by the spell checker.' => 'Défini une liste de mots ignorés par le correcteur orthographique.',
        ...
        'Defines the default selection of the free field number 1 (if more than one option is provided).' => 'Défini la sélection par défaut pour le champ libre numéro 1 (si plus d\'une option est fournie).',
        'Defines the default selection of the free field number 10 (if more than one option is provided).' => 'Défini la sélection par défaut pour le champ libre numéro 10 (si plus d\'une option est fournie).',
        'Defines the default selection of the free field number 11 (if more than one option is provided).' => 'Défini la sélection par défaut pour le champ libre numéro 11 (si plus d\'une option est fournie).',
        'Defines the default selection of the free field number 12 (if more than one option is provided).' => 'Défini la sélection par défaut pour le champ libre numéro 12 (si plus d\'une option est fournie).',
        'Defines the default selection of the free field number 13 (if more than one option is provided).' => 'Défini la sélection par défaut pour le champ libre numéro 13 (si plus d\'une option est fournie).',
        'Defines the default selection of the free field number 14 (if more than one option is provided).' => 'Défini la sélection par défaut pour le champ libre numéro 14 (si plus d\'une option est fournie).',
        'Defines the default selection of the free field number 15 (if more than one option is provided).' => 'Défini la sélection par défaut pour le champ libre numéro 15 (si plus d\'une option est fournie).',
        'Defines the default selection of the free field number 16 (if more than one option is provided).' => 'Défini la sélection par défaut pour le champ libre numéro 16 (si plus d\'une option est fournie).',
        'Defines the default selection of the free field number 2 (if more than one option is provided).' => 'Défini la sélection par défaut pour le champ libre numéro 2 (si plus d\'une option est fournie).',
        'Defines the default selection of the free field number 3 (if more than one option is provided).' => 'Défini la sélection par défaut pour le champ libre numéro 3 (si plus d\'une option est fournie).',
        'Defines the default selection of the free field number 4 (if more than one option is provided).' => 'Défini la sélection par défaut pour le champ libre numéro 4 (si plus d\'une option est fournie).',
        'Defines the default selection of the free field number 5 (if more than one option is provided).' => 'Défini la sélection par défaut pour le champ libre numéro 5 (si plus d\'une option est fournie).',
        'Defines the default selection of the free field number 6 (if more than one option is provided).' => 'Défini la sélection par défaut pour le champ libre numéro 6 (si plus d\'une option est fournie).',
        'Defines the default selection of the free field number 7 (if more than one option is provided).' => 'Défini la sélection par défaut pour le champ libre numéro 7 (si plus d\'une option est fournie).',
        'Defines the default selection of the free field number 8 (if more than one option is provided).' => 'Défini la sélection par défaut pour le champ libre numéro 8 (si plus d\'une option est fournie).',
        'Defines the default selection of the free field number 9 (if more than one option is provided).' => 'Défini la sélection par défaut pour le champ libre numéro 9 (si plus d\'une option est fournie).',
        'Defines the default selection of the free text field number 1 (if more than one option is provided).' => 'Défini la sélection par défaut pour le champ texte libre numéro 1 (si plus d\'une option est fournie).',
        'Defines the default selection of the free text field number 10 (if more than one option is provided).' => 'Défini la sélection par défaut pour le champ texte libre numéro 10 (si plus d\'une option est fournie).',
        'Defines the default selection of the free text field number 11 (if more than one option is provided).' => 'Défini la sélection par défaut pour le champ texte libre numéro 11 (si plus d\'une option est fournie).',
        'Defines the default selection of the free text field number 12 (if more than one option is provided).' => 'Défini la sélection par défaut pour le champ texte libre numéro 12 (si plus d\'une option est fournie).',
        'Defines the default selection of the free text field number 13 (if more than one option is provided).' => 'Défini la sélection par défaut pour le champ texte libre numéro 13 (si plus d\'une option est fournie).',
        'Defines the default selection of the free text field number 14 (if more than one option is provided).' => 'Défini la sélection par défaut pour le champ texte libre numéro 14 (si plus d\'une option est fournie).',
        'Defines the default selection of the free text field number 15 (if more than one option is provided).' => 'Défini la sélection par défaut pour le champ texte libre numéro 15 (si plus d\'une option est fournie).',
        'Defines the default selection of the free text field number 16 (if more than one option is provided).' => 'Défini la sélection par défaut pour le champ texte libre numéro 16 (si plus d\'une option est fournie).',
        'Defines the default selection of the free text field number 2 (if more than one option is provided).' => 'Défini la sélection par défaut pour le champ texte libre numéro 2 (si plus d\'une option est fournie).',
        'Defines the default selection of the free text field number 3 (if more than one option is provided).' => 'Défini la sélection par défaut pour le champ texte libre numéro 3 (si plus d\'une option est fournie).',
        'Defines the default selection of the free text field number 4 (if more than one option is provided).' => 'Défini la sélection par défaut pour le champ texte libre numéro 4 (si plus d\'une option est fournie).',
        'Defines the default selection of the free text field number 5 (if more than one option is provided).' => 'Défini la sélection par défaut pour le champ texte libre numéro 5 (si plus d\'une option est fournie).',
        'Defines the default selection of the free text field number 6 (if more than one option is provided).' => 'Défini la sélection par défaut pour le champ texte libre numéro 6 (si plus d\'une option est fournie).',
        'Defines the default selection of the free text field number 7 (if more than one option is provided).' => 'Défini la sélection par défaut pour le champ texte libre numéro 7 (si plus d\'une option est fournie).',
        'Defines the default selection of the free text field number 8 (if more than one option is provided).' => 'Défini la sélection par défaut pour le champ texte libre numéro 8 (si plus d\'une option est fournie).',
        'Defines the default selection of the free text field number 9 (if more than one option is provided).' => 'Défini la sélection par défaut pour le champ texte libre numéro 9 (si plus d\'une option est fournie).',
