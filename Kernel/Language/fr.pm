...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'Please insert a value in the selected input field or turn off the \'Fixed\' checkbox!' => 'Veuillez donner une valeur pour le champ sélectionné ou désactiver la case',
        ...
        'All tickets which are escalated!' => 'Tous les tickets devant être escaladés',
