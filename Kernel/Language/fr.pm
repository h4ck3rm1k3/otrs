...
# --
# $Id: fr.pm,v 1.154 2011/12/02 07:30:50 mg Exp $
# --
...
sub Data {
    ...
    # $$START$$
    # Last translation file sync: 2011-12-02 08:27:06
    ...
    $Self->{Translation} = {
        ...
        'Dear %s,' => 'Cher %s',
        'Hello %s,' => 'Bonjour %s',
        'This email address already exists. Please log in or reset your password.' => 'Cette adresse de messagerie existe déjà. Veuillez vous authentifier ou re-initialiser votre mot de passe',
        'New account created. Sent login information to %s. Please check your email.' => 'Nouveau compte créé. Informations de connexion envoyées à %s. SVP veuillez vérifier votre messagerie.',
        ...
        'Create new groups to handle access permissions for different groups of agent (e. g. purchasing department, support department, sales department, ...). ' => 'Créer de nouveux groupes pour gérer des permissions d\'accès pour les différents groupes de opérateurs (i.e. achats, support, ventes,...). ',
        ...
        'If an agent locks a ticket and does not close it before the unlock timeout has passed, the ticket will unlock and will become available for other agents.' => 'Si un opérateur vérouille un ticket et ne le ferme pas avant le délai de dévérouillage, le ticket sera dévérouillé et sera disponible pour un autre opérateur.',
        ...
        'All incoming email with this address in To or Cc will be dispatched to the selected queue.' => 'Tous les messages entrants avec cette adresse en To(A) ou Cc(copie) seront ventilés dans la file sélectionnée',
        ...
        'The display name and email address will be shown on mail you send.' => 'Le nom à afficher et l\'adresse demessagerie seront affichés dans les messages que vous envoyez.',
        ...
        'owner' => 'propriétaire',
        'Permissions to change the owner of tickets in this group/queue.' => 'Permissions de changer le propriétaire des tickets dans ce gorupe/cette file.',
        ...
        'If you remove the hook in the "Fixed" checkbox, the agent generating the stat can change the attributes of the corresponding element.' => 'Si vous enlevez la coche dans la case, l\'opérateur generant les statistiques peut changer les attributs de l\élement correspondant',
        'Fixed' => 'Fixé',
        ...
        'Activates a blinking mechanism of the queue that contains the oldest ticket.' => 'Active un méchanisme de clignotement du nom de la file qui contient le plus vieux ticket.',
        'Activates lost password feature for agents, in the agent interface.' => 'Active la fonction de mot de passe perdu pour les opérateurs, dans l\'interface des opérateurs.',
        ...
        'Adds customers email addresses to recipients in the ticket compose screen of the agent interface.' => 'Ajoute l\'adresse email des clients en destinataire dans l\'écran de création de l\'interface opérateur.',
        ...
        'Agent interface article notification module to check S/MIME.' => 'Module de notification d\'article dans l\'interface opérateur pour vérifier le S/MIME',
        'Agent interface module to access fulltext search via nav bar.' => 'Module de l\'interface opérateur pour accéder à la recherche plein texte dans la barre de navigation.',
        'Agent interface module to access search profiles via nav bar.' => 'Module de l\'interface opérateur pour accéder à la recherche des profiles dans la barre de navigation.',
        ...
        'Agents <-> Roles' => '',
        'Allows adding notes in the close ticket screen of the agent interface.' => 'Autorise l\'ajout de notes dans l\'écran de fermeture du ticket dans l\'interface opérateur.',
        'Allows adding notes in the ticket free text screen of the agent interface.' => 'Autorise l\'ajout de notes dans l\'écran de champ libre du ticket dans l\'interface opérateur.',
        'Allows adding notes in the ticket note screen of the agent interface.' => 'Autorise l\'ajout de notes dans l\'écran de note du ticket dans l\'interface opérateur.',
        'Allows adding notes in the ticket owner screen of a zoomed ticket in the agent interface.' => 'Autorise l\'ajout de notes dans l\'écran de propriétaire d\'un ticket zoomé dans l\'interface opérateur.',
        'Allows adding notes in the ticket pending screen of a zoomed ticket in the agent interface.' => 'Autorise l\'ajout de notes dans l\'écran de mise en attente d\'un ticket zoomé dans l\'interface opérateur.',
        'Allows adding notes in the ticket priority screen of a zoomed ticket in the agent interface.' => 'Autorise l\'ajout de notes dans l\'écran de priorité d\'un ticket zoomé dans l\'interface opérateur.',
        'Allows adding notes in the ticket responsible screen of the agent interface.' => 'Autorise l\'ajout de notes dans l\'écran de responsable d\'un ticket dans l\'interface opérateur.',
        'Allows agents to exchange the axis of a stat if they generate one.' => 'Autorise les opérateurs à échanger les axes d\'une statistique si ils en génèrent une.',
        ...
        'Default ticket ID used by the system in the agent interface.' => 'ID de ticket par défaut utilisé par le système dans l\'interface opérateur.',
        ...
        'Create new groups to handle access permissions for different groups of agent (e. g. purchasing department, support department, sales department, ...).' => 'Créer de nouveaux groupes permettra de gérer les droits d\'accès pour les différents groupes de l\'opérateur (exemple: achats, comptabilité, support, ventes...).',
        ...
        'If an agent locks a ticket and he/she will not send an answer within this time, the ticket will be unlock automatically. So the ticket is viewable for all other agents.' => 'Si un opérateur verrouille un ticket et qu\'il/elle n\'envoie pas une réponse dans le temps imparti, le ticket sera déverrouillé automatiquement. Le ticket sera alors visible par tous les autres opérateurs',
        ...
        'Options of the current user who requested this action (e. g. <OTRS_CURRENT_UserFirstname>)' => 'Options concernant l\'utilisateur actuel ayant effectué cet action (ex: <OTRS_CURRENT_UserFirstname>)',
        'Options of the current user who requested this action (e. g. <OTRS_CURRENT_UserFirstname>).' => 'Propriétés du client qui a demandé cette action (e. g. <OTRS_CURRENT_UserFirstname>).',
        ...
        'Permission settings. You can select one or more groups to make the configurated stat visible for different agents.' => 'Permissions. Vous pouvez sélectionner un ou plusieurs groupes pour autoriser la consultation des statistiques pour différents opérateurs.',
        ...
        'Yes means, send no agent and customer notifications on changes.' => 'Oui signifie : ne rien envoyer sur changement à l\'opérateur et au client.',
