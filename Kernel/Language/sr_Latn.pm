...
# --
# $Id: sr_Latn.pm,v 1.2 2010/11/05 15:12:50 mb Exp $
# --
...
sub Data {
    ...
    # $$START$$
    # Last translation file sync: 2010-11-05 15:51:07
    ...
    $Self->{Translation} = {
        ...
        'Security Note: You should activate %s because application is already running!' => 'Bezbednosna preporuka: Trebalo bi da omoguæite %s, jer je aplikacija veæ pokrenuta!',
        ...
        'Create new Email Ticket and send this out (Outbound)' => 'Otvori novi e-mejl tiket i po¹alji ga (odlazni)',
        ...
        'Search for customers (wildcards are allowed).' => 'Na¹i korisnika (Platzhalter sind erlaubt).',
        ...
        'Ticket first response time reached between' => 'Vreme reakcije na tiket dostignuto izmeðu',
        ...
        'Undo & close window' => 'Otka¾i i zatvori prozor',
        ...
        'Cancel & close window' => 'Poni¹ti i zatvori prozor',
        ...
        'Lock state' => 'Staus zakljièavanja',
        'Watcher' => 'Praæenje',
        ...
        'Mail check successful.' => 'Uspe¹na provera e-mejl pode¹avanja.',
        'Error in the mail settings. Please correct and try again.' => 'Gre¹ka u pode¹avanju e-mejla. Molimo ispravite i poku¹ajte ponovo.',
        ...
        # Misc
        '%s Tickets affected! Do you really want to use this joba' => '%s tiketa zahvaæeno! Da li stvarno ¾elite da pokrenete ovaj posaoa',
        ...
        'All email addresses get excluded on replaying on composing an email.' => 'Sve e-mejl adrese æe biti iskljuèene pri kreiranju odgovora.',
        'All incoming emails with this "Email" (To:) will be dispatched in the selected queue!' => 'Sve e-mejl poruke sa ovim primaocem (Za:) biæe otpremljene u izabrani red!',
        ...
        'Do you really want to delete this Objecta' => 'Da li stvarno ¾elite da obri¹ete ovaj objekta',
        'Do you really want to reinstall this package (all manual changes get lost)a' => 'Da li stvarno ¾elite da reinstalirate ovaj paket (sve ruène promene æe biti izgubljene)a',
        'Do you really want to uninstall this packagea' => 'Da li stvarno ¾elite da deinstalirate ovaj paketa',
        'Does your SMTP host need authenticationa' => 'Da li va¹ "SMTP"-domaæin zahteva autentikacijua',
        ...
        'Have you lost your passworda' => 'Da li ste izgubili va¹u lozinkua',
        'Help' => 'Pomoæ',
        ...
        'Is Job Valida' => 'Da li je posao va¾eæia',
        ...
        'OTRS sends an notification email to the customer if the ticket state has changed.' => '"OTRS" ¹alje e-mejl sa obave¹tenjem korisniku ukoliko se promeni status tiketa.',
        ...
        'Save Job asa' => 'Saèuvaj posao kaoa',
        'Save Search-Profile as Templatea' => 'Saèuvaj profil pretrage kao ¹ablona',
        'Save as Templatea' => 'Saèuvati kao ¹ablona',
        'Schedule' => 'Raspored',
        'Search Result' => 'Rezultat pretrage',
        ...
        'This email address already exists. Please log in or reset your password..' => 'Ova e-mejl adresa veæ postoji. Molimo, prijavite se ili resetujte va¹u lozinku',
        ...
        'Your Password' => 'Va¹a lozinka',
        'Your email address is new' => 'Va¹a e-mejl adresa je nova',
        ...
        'tmp_lock' => 'zaknjuèavalje (privremeno)',
        'to get the first 20 character of the subject' => 'Da vidite prvih 20 slova predmeta',
        'to get the first 5 lines of the email' => 'da vidite prvih 5 linija poruke',
