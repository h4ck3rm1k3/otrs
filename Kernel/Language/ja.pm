...
# --
# $Id: ja.pm,v 1.1 2010/11/24 11:13:43 mg Exp $
# --
...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'The recommended charset for your language is %s!' => 'あなたの言語では文字コード %s を推奨します',
        ...
        'Ignore' => '無視',
        'replace with' => '置換',
        'There is no account with that login name.' => '該当ログイン名のアカウントはありません',
        ...
        'Feature not active!' => '機能が起動されていません！',
        'Agent updated!' => '担当者更新！',
        ...
        'Please press Back and try again.' => '戻るボタンを押して再度試してください',
        ...
        'more' => '',
        'For more info see:' => '',
        'Package verification failed!' => 'パッケージの確認に失敗しました',
        'Collapse' => '失敗？',
        'Shown' => '表示？',
        'News' => 'ニュース',
        'Product News' => '製品ニュース',
        ...
        'Show/Hide Hidden Elements' => '隠し要素を表示／非表示',
        'Align Left' => '左寄せ',
        'Align Center' => '中央揃え',
        'Align Right' => '右寄せ',
        'Justify' => '両端揃え',
        ...
        'Closed' => '完了',
        'removed' => '削除',
        'pending reminder' => '保留期限付',
        'pending auto' => '保留自動',
        'pending auto close+' => '保留自動完了＋',
        'pending auto close-' => '保留自動完了－',
        ...
        'Watch' => '監視',
        'Unwatch' => '監視解除',
        'Lock it to work on it!' => 'ロックしたので作業してください！',
        'Unlock to give it back to the queue!' => '',
        'Shows the ticket history!' => 'チケット履歴閲覧',
        'Print this ticket!' => 'このチケットを印刷！',
        'Change the ticket priority!' => 'チケット優先度を変更！',
        'Change the ticket free fields!' => 'チケットの自由領域を変更！',
        'Link this ticket to an other objects!' => 'このチケットを他と結合',
        'Change the ticket owner!' => 'チケット所有者を変更！',
        'Change the ticket customer!' => 'チケットの顧客を変更！',
        'Add a note to this ticket!' => 'このチケットに注釈を追加！',
        'Merge this ticket!' => 'このチケットを結合',
        'Set this ticket to pending!' => 'このチケットを保留！',
        'Close this ticket!' => 'このチケットを完了！',
        'Look into a ticket!' => 'チケットを閲覧！',
        ...
        'Send me a notification if a ticket is unlocked by the system.' => 'チケットがシステムにアンロックされたら通知を送信',
        ...
        'New Tickets' => '新規チケット',
        'Open Tickets / Need to be answered' => '対応中チケット／回答が必要です',
        ...
        'If you use Regular Expressions, you also can use the matched value in () as [***] in the \'Set\' action.' => '正規表現を使う場合、設定アクション内で[***]をとして使用できます。',
        ...
        'Unlock timeout' => 'アンロックの期限',
        '0 = no unlock' => '0 = アンロックしない',
        ...
        'Block' => 'ブロック',
        'AccessKey' => 'アクセスキー',
        'Add NavBar entry' => 'ナビゲーションバーの登録を追加',
        'Year' => '年',
        'Month' => '月',
        'Day' => '日',
        'Invalid year' => '無効な年',
        ...
        'Sign up now' => '新規登録する',
        'Request new password' => '新規パスワードを要請',
        'Your User Name' => 'ユーザー名',
        ...
        'Fr' => '金',
        'Sa' => '土',
        'Open date selection' => 'open日を検索',

        # Template: Error
        'Oops! An Error occurred.' => 'エラーが発生しました！',
        'Error Message' => 'エラーメッセージ',
        'You can' => '',
        'Send a bugreport' => 'バグレポートを送信',
        ...
        'SMTP host' => 'SMTPホスト',
        'SMTP host.' => 'SMTPホスト名',
        'SMTP authentication' => 'SMPT認証',
        'Does your SMTP host need authentication?' => 'SMTP認証の必要はありますか？',
        'SMTP auth user' => 'SMTP authユーザー',
        'Username for SMTP auth.' => 'SMTP authで使用するユーザー名',
        'SMTP auth password' => 'SMTP authパスワード',
        'Password for SMTP auth.' => 'SMTP authで使用するパスワード',
        ...
        'Lost your password?' => 'パスワードを忘れた場合',
        ...
        'Send me a notification if a customer sends a follow up and I\'m the owner of the ticket or the ticket is unlocked and is in one of my subscribed queues.' => '顧客が追跡し、かつ自分がチケット所有者になるか、チケットがアンロックされて自分が購読中のキューのいずれかになった場合通知を送信',
        ...
        'Clear From' => 'フォーム初期化',
        'Clear To' => '初期化: ',
        'Click here to report a bug!' => 'バグレポートを送信！',
        'Close Times' => '完了時間',
        'Close ticket' => '完了チケット',
        'Close type' => '完了種別',
        'Close!' => '完了！',
       ...
       'Your Password' => 'パスワード',
       'Your email address is new' => 'メールアドレスが新しく追加されました？',
