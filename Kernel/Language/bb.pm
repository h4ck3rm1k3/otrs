...
# --
# $Id: bb.pm,v 1.24 2007/06/28 23:58:32 martin Exp $
# --
...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'Unable to parse Online Repository index document!' => 'Nicht möglich den Online Repository Index zum verarbeiten!',
        ...
        'Your reporting time interval is too small, please use a larger time scale!' => 'Die Zeitskalierung ist zum klein gewählt, bitte wählen Sie eine größere Zeitskalierung!',
        ...
        'Source' => 'Quelle',
        'Create' => 'Erstellen',
        'Customer user will be needed to have a customer history and to login via customer panel.' => 'Kundan-Leid werden für Kundan-Historien und für die Benutzung von Kundan-Weboberfläche benötigt.',
        ...
        'If nothing is selected, then there are no permissions in this group (tickets will not be available for the user).' => 'Ist nichts ausgewählt, sind keine Rechte vergeben (diese Tickets sind für den Leid nicht verfügbar).',
        'Permission' => 'Rechte',
        'ro' => 'ro',
        ...
        'No means, send agent and customer notifications on changes.' => 'Naaa bedeutet, es werden die Kundan und Agents durch eine Benachrichtigung über die Änderung informiert.',
        'Save' => 'Speichern',
        ...
        'Create new groups to handle access permissions for different groups of agent (e. g. purchasing department, support department, sales department, ...).' => 'Erstellen Sie neue Gruppen, um die Zugriffe für verschiedene Agenten-Gruppen zum definieren (z. B. Einkaufs-Abteilung, Support-Abteilung, Verkaufs-Abteilung,...).',
        ...
        'Of couse this feature will take some system performance it self!' => 'Wenn dieses Feature akitv ist, wird ist mit Leistungsdefizit zum rechnen.',
        ...
        'Logfile too large, you need to reset it!' => 'Die Logdatei ist zum groß, bitte ummesetzen!',
        'Range' => 'Bereich',
        'Interface' => 'Interface',
        'Requests' => 'Anfragen',
        ...
        'If a ticket is closed and the customer sends a follow up the ticket will be locked for the old owner.' => 'Wenn ein Ticket geschlossen ist und der Kunda ein Follow-Up sendet, wird das Ticket für den alten Besitzer gesperrt.',
        ...
        'OTRS sends an notification email to the customer if the ticket state has changed.' => 'OTRS sendet eine Info E-Mail an Kundan beim Ändern des Status.',
        'OTRS sends an notification email to the customer if the ticket owner has changed.' => 'OTRS sendet eine Info E-Mail an Kundan beim Ändern des Besitzers.',
        ...
        'A response is default text to write faster answer (with default text) to customers.' => 'Eine Antwort ist ein vordefinierter Text, um Kundan schneller antworten zum können.',
        ...
        'Create a role and put groups in it. Then add the role to the users.' => 'Erstelle eine Rolle und weise Gruppen hinzu. Danach füge Leid zum den Rollen hinzu.',
        'It\'s useful for a lot of users and groups.' => 'Es ist sehr nützlich wenn man viele Gruppen und Leid hat.',
        ...
        'owner' => 'Besitzer',
        'Permissions to change the ticket owner in this group/queue.' => 'Rechte, um den Besitzer eines Ticket in einer Gruppe/Queue zum ändern.',
        'priority' => 'Priorität',
        'Permissions to change the ticket priority in this group/queue.' => 'Rechte, um die Priorität eines Tickets in einer Gruppe/Queue zum ändern.',
        ...
        'Download all system config changes.' => 'Herunterladen oller Änderungen der Konfiguration.',
        ...
        'Firstname' => 'Vorname',
        'Lastname' => 'Nachname',
        'User will be needed to handle tickets.' => 'Leid werden benötigt, um Tickets zum bearbeiten.',
        ...
        'Discard all changes and return to the compose screen' => 'Alle Änderungen verwerfen und umme zum Verfassen-Fenster',
        ...
        'Finish' => 'Abschließen',
        'Here you can make restrictions to your stat.' => 'Dieses Formular wird dazu verwendet die Einschränkungen für die Statistik zum definieren.',
        'If you remove the hook in the "Fixed" checkbox, the agent generating the stat can change the attributes of the corresponding element.' => 'Wenn Sie den Haken in der "Fixiert" Checkbox entfernen, kann der Agent der die Statistik eschtaid, die Attribute des entsprechenden Elements verändern.',
        ...
        'Here you can select the dynamic object you want to use.' => 'Hier kann das zum benutzende dynamische Objekt ausgewählt werden.',
        ...
        'For very complex stats it is possible to include a hardcoded file.' => 'Bei sehr komplexen Statistiken ist es möglich Programmdateien zum integrieren.',
        ...
        'Permission settings. You can select one or more groups to make the configurated stat visible for different agents.' => 'Rechtevergabe: Sie können eine oder mehrere Gruppen auswählen, um die Statistiken für die entsprechenden Agents sichtbar zum machen.',
        ...
        'Here you can the value series. You have the possibility to select one or two elements. Then you can select the attributes of elements. Each attribute will be shown as single value series. If you don\'t select any attribute all attributes of the element will be used if you generate a stat. As well a new attribute is added since the last configuration.' => 'Auf dieser Seite werden die Wertereihen festgelegt. Jedes Attribut wird als einzelne Wertereihe dargestellt. Wenn Sie keine Attribute auswählen werden olle Attribute bei der Generierung einer Statistik verwendet. Auch, wenn ein neues Attribut nach der Statistikkonfiguration hinzugefügt wird.',
        ...
        'Set customer user and customer id of a ticket' => 'Kundanbenutzer und Kundannummer des Tickets auswählen',
        ...
        'To be able to use OTRS you have to enter the following line in your command line (Terminal/Shell) as root.' => 'Um OTRS nutzen zum können, müssen die die folgenden Zeilen als root in die Befehlszeile (Terminal/Shell) eingeben.',
        ...
        'to get the realname of the sender (if given)' => 'Um den Realnamen des Senders zum erhalten (wenn möglich)',
        ...
        'Options of the current user who requested this action (e. g. &lt;OTRS_CURRENT_USERFIRSTNAME&gt;)' => 'Einstellungen für den Leid, der diese Aktion ausgelöst hat (z. B. &lt;OTRS_CURRENT_USERFIRSTNAME&gt;)',
        ...
        'Options of the current user who requested this action (e. g. <OTRS_CURRENT_UserFirstname>)' => 'Informationen über den Leid, der die Aktion gerade anfragt (z. B. <OTRS_CURRENT_UserFirstname>)',
