...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'Please answer this ticket(s) to get back to the normal queue view!' =>
            'Pra�ome atsakyti � �� trikt�(-us), kad gr��tum�te prie �prastos eil�s per�i�ros!',
        ...
        'Login failed! Your user name or password was entered incorrectly.' =>
            'Prisijungimas nepavyko! Neteisingai �vestas prisijungimo vardas arba slapta�odis.',
        ...
        'Security Note: You should activate %s because application is already running!' =>
            'Saugumo pastaba: tur�tum�te aktyvuoti %s, nes aplikacija jau vykdoma!',
        'Unable to parse repository index document.' => 'Nepavyko i�nagrin�ti saugyklos indeks� dokumento.',
        'No packages for your framework version found in this repository, it only contains packages for other framework versions.' =>
            '�ioje saugykloje n�ra paket� J�s� naudojamai pagrindo (framework) versijai, yra tik kitoms versijoms.',
        'No packages, or no new packages, found in selected repository.' =>
            'Pasirinktoje saugykloje arba n�ra nauj� paket�, arba i�vis n�ra joki� paket�.',
        ...
        'This email address already exists. Please log in or reset your password.' =>
            '�is el. pa�to adresas jau yra. Pra�ome prisijungti arba atsistatyti slapta�od�.',
        'New account created. Sent login information to %s. Please check your email.' =>
            'Sukruta nauja paskyra. Prisijungimo informacija i�i�sta � %s. Pra�ome pasitikrinti savo el. pa�t�.',
        ...
        'Can\'t update password, your new passwords do not match. Please try again!' =>
            'Ne�manoma atnaujinti slapta�od�io, nes nesutampa J�s� �vesti nauji slapta�od�iai!',
        ...
        'Can\'t update password, it must be at least %s characters long!' =>
            'Ne�manoma atnaujinti slapta�od�io. Jis turi b�ti ma�iausiai %s simboli� ilgio.',
        'Can\'t update password, it must contain at least 2 lowercase  and 2 uppercase characters!' =>
            'Ne�manoma atnaujinti slapta�od�io. Slapta�od� turi sudaryti ma�iausiai 2 did�iosios ir 2 ma�osios raid�s.',
        ...
        'Can\'t update password, it must contain at least 2 characters!' =>
            'Ne�manoma atnaujinti slapta�od�io. Slapta�odis turi b�ti ma�iausiai 2 simboli� ilgio.',
        'Can\'t update password, this password has already been used. Please choose a new one!' =>
            'Ne�manoma atnaujinti slapta�od�io. �is slapta�odis jau buvo naudotas. Pra�ome pasirinkti nauj�!',
        'Select the separator character used in CSV files (stats and searches). If you don\'t select a separator here, the default separator for your language will be used.' =>
            'Pasirinkite skyrikl�, kur� norite naudoti CSV failuose (statistikoje ir paie�koje) arba bus naudojamas standartinis J�s� kalbos skyriklis.',
        ...
        'Please select only one element or turn off the button \'Fixed\' where the select field is marked!' =>
            'Pra�ome pasirinkti tik vien� element� arba nuimti mygtuko "Fiksuota" varnel�!',
        'If you use a checkbox you have to select some attributes of the select field!' =>
            'Jeigu naudojate �ymeles turite pasirinkti kurias nors reik�mes ir pasirinkimo laukelio!',
        'Please insert a value in the selected input field or turn off the \'Fixed\' checkbox!' =>
            'Pra�ome �veasti reik�m� � pasirinkt� �vedimo laukel� arba at�ym�ti \'Fiksuotas\'!',
        ...
        'You have to select one or more attributes from the select field!' =>
            'Privalote pasirinkti bent vien� reik�m� i� pasirinkto lauko!',
        ...
        'If you use a time scale element you can only select one element!' =>
            'Jeigu naudojate laiko skal�s element�, tai galite pasirinkti tik vien� element�!',
        'You have an error in your time selection!' => 'J�s� datos pasirinkime yra klaida!',
        'Your reporting time interval is too small, please use a larger time scale!' =>
            'J�s� pasirinktas ataskaitos intervalas yra per trumpas. Pra�ome pasirinkti didesn� laiko skal�!',
        ...
        'This message was written in a character set other than your own.' =>
            '�i �inut� para�yta kitokiu simboli� rinkiniu negu J�s� esama.',
        ...
        'Your email with ticket number "<OTRS_TICKET>" is merged to "<OTRS_MERGE_TO_TICKET>".' =>
            'J�s� el. lai�kas trikties numeriu "<OTRS_TICKET>" yra sujungtas su "<OTRS_MERGE_TO_TICKET>"!',
        ...
        'Send me a notification if there is a new ticket in "My Queues".' =>
            'Si�sti persp�jim� jeigu yra nauj� trik�i� "mano eil�se".',
        ...
        'Send me a notification if a ticket is unlocked by the system.' =>
            'Si�sti man persp�jim� jeigu sistema atrakina trikt�',
        ...
        'Send me a notification if a ticket is moved into one of "My Queues".' =>
            'Si�sti man �sp�jim� jeigu triktis yra perkeliamas � vien� i� "mano eili�".',
        ...
        'If enabled, the QueueView will automatically refresh after the specified time.' =>
            'Eili� per�i�ra automati�kai atsinaujins po nurodyto laiko, jeigu tai �jungsite',
        ...
        'Send me the same notifications for my watched tickets that the ticket owners will get.' =>
            'Mano stebimoms triktims si�sti man tuos pa�ius prane�imus, kuriuos gaus ir patys prane�im� savininkai.',
        ...
        'All tickets with a reminder set where the reminder date has been reached' =>
            'Visos triktys turin�ios nustatytus priminimus, kuri� priminimo laikai jau at�jo',
        'Archived tickets' => '',
        'Unarchived tickets' => '',
        ...
        'Customer will be needed to have a customer history and to login via customer panel.' =>
            'Klientas bus reikalingas tur�ti klient� istorijai ir prisijungimui per klient� skydel�.',
        ...
        'This field is required and needs to be a valid email address.' =>
            '�is laukelis yra b�tinas ir turi b�ti galiojontis pa�to adresas.',
        'This email address is not allowed due to the system configuration.' =>
            'D�l sistemos konfig�racijos �is el. pa�to adresas yra neleid�iamas.',
        ...
        'Just use this feature if you want to define group permissions for customers.' =>
            '�i� ypatyb� naudokite tik tada jeigu norite klientams apibr��ti grupi� leidimus.',
        ...
        'You can manage these groups via the configuration setting "CustomerGroupAlwaysGroups".' =>
            '�ias grupes galite valdyti per konfig�racijos nustatym� "CustomerGroupAlwaysGroups".',
        ...
        'If nothing is selected, then there are no permissions in this group (tickets will not be available for the customer).' =>
            'Jeigu n�ra nieko pasirinkta, tai �ioje grup�je n�ra nustatyt� leidim� (klientui triktys bus nepasiekiamos).',
        ...
        'Full read and write access to the tickets in this group/queue.' =>
            'Pilnos skaitymo ir ra�ymo teis�s trik�iai �ioje grup�je/eil�je.',
        ...
        'With this module, administrators can send messages to agents, group or role members.' =>
            '�io modulio pagalba administratoriai gali si�sti �inutes agentams, grup�ms ar roli� nariams.',
        ...
        'Currently this generic agent job will not run automatically.' =>
            '�iuo metu �i bendrinio agento (generic agent) u�duotis nebus vykdoma.',
        'To enable automatic execution select at least one value from minutes, hours and days!' =>
            'Nor�dami �jungti automatin� u�duo�i� paleidim� turite pasirinkti bent vien� reik�m� i� minu�i�, valand� ir dien�!',
        'Schedule minutes' => '',
        'Schedule hours' => '',
        'Schedule days' => '',
        ...
        'This command will be executed. ARG[0] will be the ticket number. ARG[1] the ticket id.' =>
            '�i komanda bus �vykdyta. ARG[0] bus trikties numeris, ARG[1] - trikties ID',
        'Delete tickets' => 'I�trinti triktis',
        'Warning: All affected tickets will be removed from the database and cannot be restored!' =>
            '�SP�JIMAS: visos paveiktos triktys bus pa�alintos i� duomen� baz�s ir bus nebe atstatomos.',
        ...
        'Warning: You used the DELETE option. All deleted tickets will be lost!' =>
            '�SP�JIMAS: Pasirinkote I�TRINTI. I�trintos triktys bus prarastos visam laikui!',
        ...
        'WARNING: When you change the name of the group \'admin\', before making the appropriate changes in the SysConfig, you will be locked out of the administrations panel! If this happens, please rename the group back to admin per SQL statement.' =>
            '�SP�JIMAS: Pervadinant grup� \'admin\' prie� atlikant atitinkamus veiksmus \'SysConfig\' b�site u�rakintas nuo administravimo skydelio! Jei tai atsitikt�, panaudodami SQL u�klaus�, atkeiskite grup�s pavadinim� atgal � \'admin\'',
        'Group Management' => 'Grup�s valdymas',
        'Add group' => 'Prid�ti grup�',
        'The admin group is to get in the admin area and the stats group to get stats area.' =>
            '\'admin\' grup� yra skirta patekti � administratori� zon�, o \'stats\' grup� - � statistikos zon�',
        'Create new groups to handle access permissions for different groups of agent (e. g. purchasing department, support department, sales department, ...). ' =>
            'Sukurkite naujas grupes skirting� agent� grupi� leidimams suvaldyti (pvz. pirkim� skyrius, palaikymo skyrius, pardavim� skyrius, ...).',
        ...
        'To get the first 20 character of the subject (of the latest agent article).' =>
            'Gauti pirmus 20 temos simboli� (paskutinio agento straipsnio)',
        'To get the first 5 lines of the body (of the latest agent article).' =>
            'Gauti pirmas 5 turinio eilutes (paskutinio agento straipsnio)',
        'To get the first 20 character of the subject (of the latest customer article).' =>
            'Gauti pirmus 20 temos simboli� (paskutinio kliento straipsnio)',
        ...
        'In this way you can directly edit the keyring configured in SysConfig.' =>
            '�iuo b�du galite tiesiogiai valdyti SysConfig sukonfig�ruot� "rakt� ry�ul�".',
        ...
        'Do you really want to reinstall this package? Any manual changes will be lost.' =>
            'Ar tikrai norite i� naujo �diegti �� paket�? Bet kokie atlikti rankiniai pakeitimai bus prarasti.',
        'Continue' => 'T�sti',
        'Install' => '�diegti',
        ...
        'Activating this feature might affect your system performance!' =>
            '�ios ypatyb�s aktyvavimas gali paveikti J�s� sistemos na�um�.',
        ...
        'To dispatch or filter incoming emails based on email headers. Matching using Regular Expressions is also possible.' =>
            'I�skirstyti ar filtruoti el. lai�kus pagal el. lai�k� antra�tes. Taip pat galima naudoti ir reguliarias i�rai�kas',
        'If you want to match only the email address, use EMAILADDRESS:info@example.com in From, To or Cc.' =>
            'Jeigu norite nustatyti atitikmen� tik vienam el. pa�to adresui, tai Nuo, Kam ir Cc laukeliuose naudokite EMAILADDRESS:info@example.com.',
        ...
        'If an agent locks a ticket and does not close it before the unlock timeout has passed, the ticket will unlock and will become available for other agents.' =>
            'Jeigu agentas u�rakins trikt� ir neu�darys jos iki pasibaigs atrakinimo laikas (unlock timeout), tai ji atsirakins ir taps prieinama kitiems agentams.',
        'Notify by' => 'Prane�ti per',
        '0 = no escalation' => '0 = neeskaluoti',
        'If there is not added a customer contact, either email-external or phone, to a new ticket before the time defined here expires, the ticket is escalated.' =>
            'Jeigu naujai trik�iai nebus prid�ti kliento kontaktai (i�orinis el. pa�tas ar telefono numeris), iki pasibaigiant �ia nurodytam laikui, tai triktis bus eskaluota.',
        'If there is an article added, such as a follow-up via email or the customer portal, the escalation update time is reset. If there is no customer contact, either email-external or phone, added to a ticket before the time defined here expires, the ticket is escalated.' =>
            'Jeigu trik�iai bus prid�tas naujas straipsnis, pvz., atsakymas per i�orin� el. pa�t� arba klient� portal�, tai eskalavimo atnaujinimo laikas yra atstatomas atgal. Jeigu trik�iai nebus prid�ti kliento kontaktai (i�orinis el. pa�tas ar telefono numeris), iki pasibaigiant �ia nurodytam laikui, tai triktis bus eskaluota.',
        'If the ticket is not set to closed before the time defined here expires, the ticket is escalated.' =>
            'Jeigu triktis nebus ir neu�daryta iki pasibaigs �ia nurodytas laikas, tai ji bus eskaluota.',
        'Follow up Option' => '',
        'Specifies if follow up to closed tickets would re-open the ticket, be rejected or lead to a new ticket.' =>
            'Nurodo ar tolimesni veiksmai su jau u�daryta triktimi: j� i� naujo atidaryt�, atmest� bet kokius tolimesnius veiksmus, sukurt� nauj� trikt�.',
        'Ticket lock after a follow up' => 'U�rakinti trikt� po bet kokio atsakymo ar kontakto',
        'If a ticket is closed and the customer sends a follow up the ticket will be locked to the old owner.' =>
            'Jeigu triktis yra u�daryta ir klientas v�l k� nors atsiun�ia - triktis bus prirakinta prie senojo savininko.',
        ...
        'A response is default text to write faster answer (with default text) to customers.' =>
            'Atsakymas yra standartinis tekstas skirtas greitesniems atsakymams klientams ra�yti.',
        ...
        'Create a role and put groups in it. Then add the role to the users.' =>
            'Sukurkite rol�, o tada �d�kite � j� grupes. Tada priskirkite roles naudotojams.',
        'There are no roles defined. Please use the \'Add\' button to create a new role.' =>
            'N�ra apibr��t� roli�. Pra�ome paspausti mygtuk� "Prid�ti" naujoms rol�s sukurti.',
        'Add Role' => 'Prid�ti Rol�',
        ...
        'If nothing is selected, then there are no permissions in this group (tickets will not be available for the role).' =>
            'Jeigu n�ra nieko pasirinkta, tai �ioje grup�je n�ra nustatyt� leidim� (rolei triktys bus neprieinamos).',
        ...
        'Permissions to change the ticket priority in this group/queue.' =>
            'Leidimai keisti trik�i� prioritetus �ioje grup�je/eil�je.',
        ...
        'In this way you can directly edit the certification and private keys in file system.' =>
            '�iuo b�du galite tiesiogiai redaguoti sertifikatus ir priva�ius raktus sistemoje.',
        'Hash' => '',
        'Create' => 'Sukurti',
        ...
        'Secure mode will (normally) be set after the initial installation is completed.' =>
            'Saugus re�imas, paprastai, yra nustatomas po pradinio �diegimo.',
        'Secure mode must be disabled in order to reinstall using the web-installer.' =>
            'Norint �diegti i� naujo, naudojant web-diegykl�, saugus re�imas turi b�ti i�jungtas.',
        ...
        'Here you can enter SQL to send it directly to the application database.' =>
            '�ia galite �vesti ir tiesiogiai programos duomen� bazei nusi�sti SQL u�klausas.',
        'The syntax of your SQL query has a mistake. Please check it.' =>
            'J�s� SQL u�klausoje yra klaida. Pra�ome j� i�taisyti.',
        ...
        'This config item is only available in a higher config level!' =>
            '�is konfig�racijos punktas yra prieinamas tik auk�tesniame konfig�racijos lygyje!',
        ...
        'All incoming email with this address in To or Cc will be dispatched to the selected queue.' =>
            'Visas �einantis el. pa�tas, su tokiu (nurodytu) el. pa�to adresu Kam ir Kopija laukeliuose, bus nukreiptas � pasirinkt� eil�.',
        ...
        'The display name and email address will be shown on mail you send.' =>
            'Rodomas vardas ir el. pa�to adresas bus rodomas J�s� siun�iamuose lai�kuose.',
        ...
        'Permissions to change the owner of tickets in this group/queue.' =>
            'Leidimai keisti trik�i� savininkus �ioje grup�je/eil�je.',
        ...
        'If you remove the hook in the "Fixed" checkbox, the agent generating the stat can change the attributes of the corresponding element.' =>
            'Jeigu nuimsite varnel� nuo laukelio "Fiksuotas", tai agentas gal�s pakeisti kiekvieno atitinkamo elemento atributus.',
        'Fixed' => 'Fiksuotas',
        'Please select only one element or turn off the button \'Fixed\'.' =>
            'Pra�ome pasirinkti tik vien� element� arba i�jungti "Fiksuotas"!',
        ...
        'You can select one or more groups to define access for different agents.' =>
            'Skirtingiems agentams apibr��ti galite pasirinkti vien� ar daugiau grupi�.',
        'Some result formats are disabled because at least one needed package is not installed.' =>
            'Dalis rezultat� format� yra i�jungti, nes ne�diegtas ma�iausiai vienas reikalingas paketas.',
        'Please contact your administrator.' => 'Pra�ome susisiekti su savo administratoriumi.',
        'Graph size' => 'Diagramos dydis',
        'If you use a graph as output format you have to select at least one graph size.' =>
            'Jei i�vedimo tipui naudosite diagram� - turite pasirinkti bent vien� diagramos dyd�.',
        'Sum rows' => 'Sumuoti eilutes',
        'Sum columns' => 'Sumuoti stulpelius',
        'Use cache' => 'Naudoti ke�� (cache)',
        'Most of the stats can be cached. This will speed up the presentation of this stat.' =>
            'Dauguma statistik� gali b�ti ke�uojama. Tai padidins �ios statistikos pateikim�.',
        ...
        'Please remember, that the scale for value series has to be larger than the scale for the X-axis (e.g. X-Axis => Month, ValueSeries => Year).' =>
            'Prisiminkite, kad reik�mi� serijos skal� turi b�ti didesn� u� X a�ies skal� (pvz., X-a�is => M�nesis, Reik�mi� Serija => Metai).',

        # Template: AgentStatsEditXaxis
        'Here you can define the x-axis. You can select one element via the radio button.' =>
            '�ia galite apibr��ti X a��. Galite pasirinkti vien� element� pa�ym�dami "radijo mygtuk�" (radio button)',
        ...
        'With the input and select fields you can influence the format and contents of the statistic.' =>
            'Pasirinktais laukeliais ir �vestimi galite �takoti turinio ir statistikos format�.',
        'Exactly what fields and formats you can influence is defined by the statistic administrator.' =>
            'Kokius konkre�ius laukelius ir formatus galite �takoti yra numat�s statistikos administratorius.',
        ...
        'Need a valid email address or don\'t use a local email address.' =>
            'Reikalingas galiojantis el. pa�to adresas (arba nenaudokite lokalaus pa�to adreso).',
        ...
        'To protect your privacy, active or/and remote content has blocked.' =>
            'Siekiant apsaugoti J�s� privatum� buvo u�blokuotas aktyvus ir/ar nuotolinis turinys.',
        ...
        'Could not open popup window. Please disable any popup blockers for this application.' =>
            'Nepavyko atverti i��okan�io lango. Pra�ome i�jungti visus i��okan�ius langus blokuojan�ias programas.',
        ...
        'If you now leave this page, all open popup windows will be closed, too!' =>
            'Jeigu dabar u�versite/paliksite �� puslap�, tai visi i��okantys langai taip pat bus u�verti!',
        'A popup of this screen is already open. Do you want to close it and load this one instead?' =>
            '�io ekrano i��okantis langas jau yra atvertas. Ar norite j� u�daryti ir vietoj jo u�krauti ��?',
        ...
        'In order to experience OTRS, you\'ll need to enable JavaScript in your browser.' =>
            'Norint geriausios, darbo su OTRS, patirties Jums reikia savo nar�ykl�je �jungti JavaScript.',
        ...
        'If you have set a root password for your database, it must be entered here. If not, leave this field empty. For security reasons we do recommend setting a root password. For more information please refer to your database documentation.' =>
            '�ia turi b�ti �vestas J�s� duomen� baz�s root naudotojo slapta�odis, jeigu toks yra nustatytas, jeigu ne, tai palikite �� laukel� tu��i�. D�l saugumo, mes, nerekomenduojame naudoti root slapta�od�io. Daugiau informacijos rasite savo duomen� baz�s dokumentacijoje.',
        ...
        'If you want to install OTRS on another database type, please refer to the file README.database.' =>
            'Jeigu OTRS diegimui norite naudoti kitok� duombaz�s tip� skaitykite fail� README.database',
        'Database-User' => 'Duomen� baz�s naudotojas',
        'New' => 'Naujas',
        'A new database user with limited rights will be created for this OTRS system.' =>
            '�iai OTRS sistemai bus sukurtas naujas, apribotas teises turintis, duomen� baz�s naudotojas.',
        ...
        'To be able to use OTRS you have to enter the following line in your command line (Terminal/Shell) as root.' =>
            'Nor�dami naudoti OTRS turite root naudotojo teis�mis, komandin�je eilut�je (terminale), �vesti �i� komand�.',
        ...
        'The identifier of the system. Each ticket number and each HTTP session ID contain this number.' =>
            'Sistemos identifikacijos numeris. �is numeris bus kiekviename trikties numeryje ir kiekviename HTTP sesijos ID',
        ...
        'Email addresses that are manually entered are checked against the MX records found in DNS. Don\'t use this option if your DNS is slow or does not resolve public addresses.' =>
            'Rankiniu b�du �vesti el. pa�to adresai yra patikrinami DNS MX s�ra�uose. Nenaudokite �ios parinkties jeigu J�s� DNS yra l�tas arba neaptarnauja vie�� adres�.',
        ...
        'OTRS runs with a huge lists of browsers, please upgrade to one of these.' =>
            'OTRS gali veikti su daugybe nar�ykli�, pra�ome atsinaujinti � vien� i� j�.',
        'Please see the documentation or ask your admin for further information.' =>
            'Daugiau informacijos ie�kokit dokumentacijoje arba kreipkit�s � administratori�.',
        ...
        'Send me a notification if a customer sends a follow up and I\'m the owner of the ticket or the ticket is unlocked and is in one of my subscribed queues.' =>
            'Si�sti man prane�im� jeigu klientas atsiun�ia atsak� o a� esu trikties savininkas arba triktis yra atrakinta ir yra vienoje i� mano eili�.',
        ...
        'Your queue selection of your favorite queues. You also get notified about those queues via email if enabled.' =>
            'J�s� m�gstamiausi� eili� rinkinys. Taip pat b�site informuoti apie �ias eiles jei �jungsite (�galinsite) toki� funkcij�.',
        ...
        'Package not correctly deployed! You should reinstall the package again!' =>
            'Netinkamai �diegtas paketas! Tur�tum�te �diegti i� naujo!',
