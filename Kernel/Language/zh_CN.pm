...
# --
# $Id: zh_CN.pm,v 1.88.2.5 2011/08/12 09:56:10 mg Exp $
# --
...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'New message' => '新消息',
        'New message!' => '新消息!',
        'Please answer this ticket(s) to get back to the normal queue view!' => '请先回复该票单，然后回到正常队列视图!',
        ...
        'installed' => '已安装',
        'uninstalled' => '未安装',
        'Security Note: You should activate %s because application is already running!' => '安全提示: 您不能激活 %s, 因为此应用已经在运行!',
        ...
        'No packages, or no new packages, found in selected repository.' => '选中的软件仓库中没有需要安装的软件包。',
        ...
        'Dear %s,' => '尊敬的 %s:',
        'Hello %s,' => '您好, %s:',
        'This email address already exists. Please log in or reset your password.' => '邮件地址已存在，请登录或重新初始化密码。',
        'New account created. Sent login information to %s. Please check your email.' => '帐户创建成功。登录信息发送到 %s ，请查收邮件。',
        ...
        'Can\'t update password, your new passwords do not match. Please try again!' => '无法更改密码。新密码不一致，请重新输入！',
        'Can\'t update password, it contains invalid characters!' => '无法更改密码，密码不能包含非法字符！',
        'Can\'t update password, it must be at least %s characters long!' => '无法更改密码，密码至少 %s 个字符长度！',
        'Can\'t update password, it must contain at least 2 lowercase  and 2 uppercase characters!' => '无法更改密码，密码必须包含至少2个小写和2个大写字符！',
        'Can\'t update password, it must contain at least 1 digit!' => '无法更改密码，密码必须包含至少1个数字！',
        'Can\'t update password, it must contain at least 2 characters!' => '无法更改密码，密码必须包含至少2个字符！',
        'Can\'t update password, this password has already been used. Please choose a new one!' => '无法更改密码，该密码已被使用。 请选择一个新密码！',
        'Select the separator character used in CSV files (stats and searches). If you don\'t select a separator here, the default separator for your language will be used.' => '选择CSV文件（统计和搜索）中使用的分隔符。如果不指定，系统将使用默认分隔符。',
        ...
        'Please select only one element or turn off the button \'Fixed\' where the select field is marked!' => '请只选择一个元素或关闭被选字段的\'Fixed\'按钮',
        'If you use a checkbox you have to select some attributes of the select field!' => '如果使用复选框，必须选择被选字段的部分属性！',
        'Please insert a value in the selected input field or turn off the \'Fixed\' checkbox!' => '在选定的输入框中请插入一个值，或关闭\'Fixed\'复选框！',
        'The selected end time is before the start time!' => '选定的结束时间早于开始时间！',
        'You have to select one or more attributes from the select field!' => '必须从被选字段中选择一个或多个属性！',
        'The selected Date isn\'t valid!' => '所选日期无效',
        'Please select only one or two elements via the checkbox!' => '请通过复选框选择一个或两个要素！',
        'If you use a time scale element you can only select one element!' => '如果使用时间尺度要素，只能选择其中一个',
        'You have an error in your time selection!' => '选择时间错误！',
        'Your reporting time interval is too small, please use a larger time scale!' => '报告时间间隔太短，请使用更长的间隔！',
        ...
        'The selected time period is larger than the allowed time period!' => '选定时间段大于允许的时间段！',
        ...
        'Attachment' => '附件',
        'Attachments' => '附件',
        'This message was written in a character set other than your own.' => '这封邮件所用字符集与您的系统字符集不符',
        ...
        'My Queues' => '我的队列',
        'Shown Tickets' => '显示票单',
        'Your email with ticket number "<OTRS_TICKET>" is merged to "<OTRS_MERGE_TO_TICKET>".' => '您的单号为"<OTRS_TICKET>"的邮件票单 被合并到单号"<OTRS_MERGE_TO_TICKET>" !',
        ...
        'Send me a notification if there is a new ticket in "My Queues".' => '如果我的队列中有新的票单，发通知给我.',
        'Send new ticket notifications' => '发送新票单通知',
        'Ticket follow up notification' => '票单跟进通知',
        'Ticket lock timeout notification' => '票单锁定超时通知',
        'Send me a notification if a ticket is unlocked by the system.' => '如果票单被系统解锁，请通知我.',
        'Send ticket lock timeout notifications' => '发送票单锁定超时间通知',
        'Ticket move notification' => '票单移动通知',
        'Send me a notification if a ticket is moved into one of "My Queues".' => '如果有票单被转入我的队列，请通知我.',
        'Send ticket move notifications' => '发送票单移动通知',
        'Your queue selection of your favourite queues. You also get notified about those queues via email if enabled.' => '您的最常用队列，如果您设置了邮件通知，您将会得到该队列的状态通知.',
        'Custom Queue' => '客户队列',
        'QueueView refresh time' => '队列视图刷新频率',
        'If enabled, the QueueView will automatically refresh after the specified time.' => '如果启用此功能, 队列视图会自动在指定时间内自动刷新.',
        ...
        'Send me the same notifications for my watched tickets that the ticket owners will get.' => '对我所关注的票单，给所有者发送通知时，也给我发送相同的通知',
        ...
        'All open tickets, these tickets have already been worked on, but need a response' => '所有打开票单，这些票单已经在处理中，但是需要一个回复',
        'All new tickets, these tickets have not been worked on yet' => '所有新建票单，这些票单目前还没有被处理',
        'All escalated tickets' => '所有升级的票单',
        'All tickets with a reminder set where the reminder date has been reached' => '所有设置提醒日期已经到达的票单',
        ...
        'Select' => '选择',
        'Hint' => '提示',
        'Customer will be needed to have a customer history and to login via customer panel.' => '需要建立客户档案以记录服务过程，并可让客户从自助服务界面登录。',
        ...
        'Just use this feature if you want to define group permissions for customers.' => '该功能用于为客户定义权限组。',
        ...
        'You can manage these groups via the configuration setting "CustomerGroupAlwaysGroups".' => '可以通过系统配置项 "CustomerGroupAlwaysGroups"修改默认群组。',
        'Filter for Groups' => '群组过滤',
        'Select the customer:group permissions.' => '选择客户:群组设定权限。',
        'If nothing is selected, then there are no permissions in this group (tickets will not be available for the customer).' => '如果没有选择，将无法给客户设定群组权限（票单将对该客户不可用）。',
        'Search Result:' => '搜索结果',
        'Customers' => '客户',
        'Groups' => '群组',
        ...
        'rw' => '读写',
        'Full read and write access to the tickets in this group/queue.' => '群组/队列中的票单可读写.',
        ...
        'With this module, administrators can send messages to agents, group or role members.' => '通过此模块，管理员客户发送消息给服务人员/群组/角色成员。',
        ...
        'CMD' => '命令',
        'This command will be executed. ARG[0] will be the ticket number. ARG[1] the ticket id.' => '将执行这个命令, 第一个参数是票单 编号，第二个参数是票单的标识符.',
        'Delete tickets' => '删除票单',
        'Warning: All affected tickets will be removed from the database and cannot be restored!' => '警告：所有影响的票单从数据库删除，将无法恢复！',
        ...
        'Warning: You used the DELETE option. All deleted tickets will be lost!' => '警告：你选择了"删除"指令。所有删除的票单数据将无法恢复。',
        'Edit job' => '修改任务',
        'Run job' => '执行任务',
        ...
        'Create new groups to handle access permissions for different groups of agent (e. g. purchasing department, support department, sales department, ...). ' => '通过创建群组来为不同部门（比如采购部门，支持部门，销售部门等）的服务人员设定权限。',
        ...
        'If your account is trusted, the already existing X-OTRS header at arrival time (for priority, ...) will be used! PostMaster filter will be used anyway.' => '如果您的帐户是值得信赖的，现有的X-OTRS标题到达时间（优先， ... ）将被使用！邮件过滤器将被使用',
        'Host' => '主机',
        'Delete account' => '删除帐号',
        'Fetch mail' => '查收邮件',
        'Add Mail Account' => '新增邮件帐号',
        ...
        'To get the first 5 lines of the body (of the latest customer article).' => '截取客户最新邮件正文内容前 5 行.',

        # Template: AdminPGP
        'PGP Management' => 'PGP 管理',
        'Use this feature if you want to work with PGP keys.' => '该功能用于管理PGP密钥',
        'Add PGP key' => '新增PGP密钥',
        'In this way you can directly edit the keyring configured in SysConfig.' => '通过此模块可以直接编辑在SysConfig中设置的密钥环。',
        ...
        'Do you really want to reinstall this package? Any manual changes will be lost.' => '你确定要重新安装该软包吗? 所有该模块的手工设置将丢失.',
        'Continue' => '继续',
        'Install' => '安装',
        ...
        'Uninstall' => '卸载',
        'Package not correctly deployed! You should reinstall the package again!' => '该软件没有正确展开! 你应该再试重新安装该软件包!',
        'Reinstall' => '重新安装',
        ...
        'Add filter' => '新增过滤器',
        'To dispatch or filter incoming emails based on email headers. Matching using Regular Expressions is also possible.' => '根据email的头部信息分发和过滤邮件，可以使用正则表达式匹配',
        ...
        'Value' => '值',
        'The field needs to be a valid regular expression or a literal word.' => '该栏位需使用有效的正则表达式或文字。',
        ...
        'If an agent locks a ticket and does not close it before the unlock timeout has passed, the ticket will unlock and will become available for other agents.' => '如果服务人员在自动解锁超时期限内没有关闭票单，该票单将被自动解锁。',
        'Notify by' => '进度通知',
        ...
        'If a ticket is closed and the customer sends a follow up the ticket will be locked to the old owner.' => '客户对已关闭的票单提交跟进后，该票单将自动被前一个所有者锁定。',
        ...
        'There are no roles defined. Please use the \'Add\' button to create a new role.' => '有没有角色定义. 请使用 \'添加\' 按钮来创建一个新的角色',
        'Add Role' => '新增角色',
        'Edit Role' => '修改角色',
        ...
        'priority' => '优先级',
        'Permissions to change the ticket priority in this group/queue.' => '允许在群组/队列中修改票单优先级。',
        ...
        'In this way you can directly edit the certification and private keys in file system.' => '该功能可用于直接编辑证书和私匙。',
        'See also' => '参见',
        'Hash' => 'Hash',
        'Create' => '创建',
        ...
        'Secure mode must be disabled in order to reinstall using the web-installer.' => '为了重新用Web 界面安装，安全模式必须禁用',
        'If secure mode is not activated, activate it via SysConfig because your application is already running.' => '系统已启用，请通过SysConfig启用安全模式。',

        # Template: AdminSelectBox
        'SQL Box' => 'SQL查询窗口',
        'Here you can enter SQL to send it directly to the application database.' => '可以提交SQL到应用数据库执行。',
        'The syntax of your SQL query has a mistake. Please check it.' => 'SQL查询的语法有一个错误，请核对。',
        'There is at least one parameter missing for the binding. Please check it.' => '至少有一个参数丢失，请核对。',
        'Result format' => '结果格式',
        'Run Query' => '执行查询',
        ...
        'This config item is only available in a higher config level!' => '该配置项只在高级配置可用！',
        ...
        'All incoming email with this address in To or Cc will be dispatched to the selected queue.' => '收件人或抄送队列中包含该地址的邮件将被分发到所选队列。',
        'Email address' => '邮件地址',
        'Display name' => '名称',
        'Add System Email Address' => '新增系统邮件地址',
        'Edit System Email Address' => '修改系统邮件地址',
        'The display name and email address will be shown on mail you send.' => '邮件地址和名称将在邮件中显示。',
        ...
        'owner' => '所有者',
        'Permissions to change the owner of tickets in this group/queue.' => '允许改变群组/队列中票单所有者。',
        ...
        'Permissions' => '权限',
        'You can select one or more groups to define access for different agents.' => '可选中一个或多个群组定义服务人员访问权限。',
        'Some result formats are disabled because at least one needed package is not installed.' => '至少一个必须的软件包没有安装，部分结果格式无法使用。',
        ...
        'Sum columns' => '总和列',
        'Use cache' => '使用缓存',
        'Most of the stats can be cached. This will speed up the presentation of this stat.' => '大多数的统计资料可以缓存，将加快统计计算。',
        ...
        'Here you can define the x-axis. You can select one element via the radio button.' => '定义x轴，可以使用单选按钮选择要素。',
        'maximal period' => '最大周期',
        'minimal scale' => '最小尺度',
        ...
        'Need a valid email address or don\'t use a local email address.' => '需要有效的邮件地址/不可以使用本地邮件地址。',
        ...
        'To protect your privacy, active or/and remote content has blocked.' => '为了保护您的隐私，远程内容加载被阻止。',
        ...
        'Could not open popup window. Please disable any popup blockers for this application.' => '无法打开弹出窗口，请禁用弹出窗口拦截。',
        ...
        'A popup of this screen is already open. Do you want to close it and load this one instead?' => '一个弹出窗口已经打开，是否继续关闭？',
        ...
        'If you want to install OTRS on another database type, please refer to the file README.database.' => '如果使用其他数据库安装OTRS，请参考README文档。',
        'Database-User' => '数据库用户名',
        'New' => '新建',
        'A new database user with limited rights will be created for this OTRS system.' => '已经为OTRS系统创建了新的数据库用户',
        ...
        'Email addresses that are manually entered are checked against the MX records found in DNS. Don\'t use this option if your DNS is slow or does not resolve public addresses.' => '手动输入的电子邮件地址将通过DNS服务器验证MX记录。如果DNS服务器响应慢或无法提供公网解析，请不要使用此选项。',
        ...
        'Please see the documentation or ask your admin for further information.' => '欲了解更多信息, 请向你的管理询问或参考相关文档.',
        ...
        'Send me a notification if a customer sends a follow up and I\'m the owner of the ticket or the ticket is unlocked and is in one of my subscribed queues.' => '如果客人回复的 Ticket 属于我, 或者该 Ticket 未锁定但在我的队列, 请发送一个通知给我.',
