...
# --
# $Id: zh_CN.pm,v 1.82 2010/11/10 08:50:18 mg Exp $
# --
...
sub Data {
    ...
    # $$START$$
    # Last translation file sync: 2010-07-30 14:48:19
    ...
    $Self->{Translation} = {
        ...
        'Can\'t update password, your new passwords do not match. Please try again!' => '无法更改密码, 新密不匹配. 请重新输入!',
        'Can\'t update password, it contains invalid characters!' => '无法更改密码, 密码不能包含非常字符!',
        'Can\'t update password, it must be at least %s characters long!' => '无法更改密码, 密码至少 %s 字符的长度!',
        'Can\'t update password, it must contain at least 2 lowercase  and 2 uppercase characters!' => '无法更改密码, 密码必须包含至少 2 个小写和 2 个大写字母!',
        'Can\'t update password, it must contain at least 1 digit!' => '无法更改密码, 密码必须有 1 个数字!',
        'Can\'t update password, it must contain at least 2 characters!' => '无法更改密码, 密码至少有 2 个字母!',
        'Can\'t update password, this password has already been used. Please choose a new one!' => '无法更改密码, 这个密码已被使用. 请选择一个新密码!',
        ...
        'Status' => '状态',
        'Statuses' => '状态',
        'Ticket Type' => 'Ticket 类型',
        'Ticket Types' => 'Ticket 类型',
        'Compose' => '撰写',
        'Pending' => '等待',
        'Owner' => '所有者',
        'Owner Update' => '更新所有者',
        ...
        'My Locked Tickets' => '我已锁定的 Ticket',
        ...
        'Send ticket lock timeout notifications' => '发送 Ticket 锁定超时通知',
        'Ticket move notification' => 'Ticket 移动通知',
        'Send me a notification if a ticket is moved into one of "My Queues".' => '如果有 Ticket 被转入我的队列，请通知我.',
        'Send ticket move notifications' => '发送 Ticket 移动通知',
        ...
        'Ticket Overview "Small" Limit' => '"简洁模式"的 Ticket 视图',
        'Ticket limit per page for Ticket Overview "Small"' => '在"简洁模式"下每页显示的 Ticket 数量',
        'Ticket Overview "Medium" Limit' => '"基本模式"的 Ticket 视图',
        'Ticket limit per page for Ticket Overview "Medium"' => '在"基本模式"下每页显示的 Ticket 数量',
        'Ticket Overview "Preview" Limit' => '"预览模式"的 Ticket 视图',
        'Ticket limit per page for Ticket Overview "Preview"' => '在"预览模式"下每页显示的 Ticket 数量',
        'Ticket watch notification' => 'Ticket 订阅通知',
        'Send me the same notifications for my watched tickets that the ticket owners will get.' => '被我订阅的 Ticket 有变动时请与 Ticket 所有者一样发送通知给我.',
        'Send ticket watch notifications' => '发送 Ticket 订阅通知',
        ...
        ' e. g.' => '例如',
        'Options of the current customer user data' => '与客户相关的一些数据',
        'Ticket owner options' => 'Ticket 所有者的数据',
        'Ticket responsible options' => '与责任人相关的一些数据',
        'Options of the current user who requested this action' => '与当时操作人相关的一些数据',
        'Options of the ticket data' => '跟 Ticket 有关的一些数据',
        'Config options' => '与系统配置有关的选项',
        'Example response' => '这里有一个范例',

        # Template: AdminCustomerCompany
        'Customer Company Management' => '管理客户单位',
        'Wildcards are allowed.' => '允许使用通配符.',
        'Add customer company' => '增加客户单位',
        'Please enter a search term to look for customer companies.' => '请输入一个搜索条件以寻找客户的单位.',
        'Add Customer Company' => '增加客户单位',
        'The field is required.' => '该字段是必需的',

        # Template: AdminCustomerUser
        'Customer Management' => '客户关系管理',
        'Add customer' => '增加客户',
        'Note' => '注解',
        ...
        'Manage Responses <-> Attachments Relations' => '管理回复和附件的对应关系',
        ...
        'Manage Role-Group Relations' => '管理角色和服务人员的关系',
        ...
        'Add certificate' => '添加证书', # UI is certificate not Certificate
        'Add Private Key' => '添加私匙',
        'Secret' => '密码',
        ...
        # Template: AdminUser
        'Add agent' => '增位一位服务人员',
        'Agents will be needed to handle tickets.' => '服务人员需要处理 Ticket.',
        'Don\'t forget to add a new agent to groups and/or roles!' => '请别忘了添加服务人员到群组 或 角色里!',
        'Please enter a search term to look for agents.' => '请输入一个搜索条件以快速找到服务人员的登录信息.',
        'Last login' => '最后一次登录',
        'Login as' => '登录名',
        'Switch to agent' => '',
        'Add Agent' => '增加服务人员',
        ...
        'Edit your preferences' => '编辑你的个人偏好',
        ...
        'Article(s)' => '信息',
        'Move ticket to a different queue' => '移动 Ticket 到不同的队列',
        'Change Queue' => '改变队列',
        'Add Filter' => '增加过滤器',
        'Set' => '设置',
        'Reset Filter' => '重置过滤器',
        ...
        'Send me the same notifications for my watched tickets that the ticket owners will get.' => '被我订阅的 Ticket 有变动时请与 Ticket 所有者一样发送通知给我.',
        'Send new ticket notifications' => '发送新 Ticket 通知',
        'Send notifications to users.' => '发送通知给用户.',
        'Send ticket follow up notifications' => '发送 Ticket 跟进通知',
        'Send ticket lock timeout notifications' => '发送 Ticket 锁定超时间通知',
        'Send ticket move notifications' => '发送 Ticket 移动通知',
        'Send ticket watch notifications' => '发送订阅通知',
        ...
        'Show this screen after I created a new ticket' => '创建完一个新的 Ticket 之后返回创建 Ticket 页面还是展开该 Ticket',
        ...
        'Ticket Overview "Preview" Limit' => '"预览模式"的 Ticket 视图',
        'Ticket Overview "Small" Limit' => '"简洁模式"的 Ticket 视图',
        'Ticket follow up notification' => 'Ticket 跟进通知',
...
#add by Never
    ...
    'd' => '天',
    'h' => '时',
    'Edit the system configuration settings.' => '编辑系统配置', #line 1205
