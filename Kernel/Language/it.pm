...
# --
# $Id: it.pm,v 1.86 2009/07/13 15:41:29 martin Exp $
# --
...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'Unable to parse Online Repository index document!' => 'Impossibile i documenti in linea ',
        'No Packages for requested Framework in this Online Repository, but Packages for other Frameworks!' => 'Nessun Packages richiesto in linea ,esistono altri Packages non richiesti ',
        'No Packages or no new Packages in selected Online Repository!' => 'No Packages o nussun  Packages disponibile OnLine ',
        ...
        'Package verification failed!' => 'Verifica del Package fallita! ',
        'Collapse' => '',
        'News' => 'Aggiornamenti',
        'Product News' => 'Aggiornamenti Prodotto',
        'OTRS News' => 'Aggiornamenti OTRS',
        '7 Day Stats' => 'Stat di 7 giorni',
        'Bold' => 'Grassetto',
        'Italic' => '',
        ...
        'Please select a file!' => 'Prego selezionare il file',
        'Please select an object!' => '',
        'Please select a graph size!' => 'Prego selezionare la dimensione del graph-size',
        'Please select one element for the X-axis!' => 'Per favore selezionare un elemento come asse delle X ',
        'Please select only one element or turn off the button \'Fixed\' where the select field is marked!' => 'Prego selezionare un solo elemento oppure togli  \'Fixed\' dove sono marcati i campi ! ',
        'If you use a checkbox you have to select some attributes of the select field!' => 'Se usi il checkbox devi decidere un attributo per il campo selezionato!',
        'Please insert a value in the selected input field or turn off the \'Fixed\' checkbox!' => 'Prego inserire un valore nel campo selezionato oppure togli \'Fixed\' nel checkbox!',
        ...
        'Common Specification' => 'Configurazione di base',
        'Xaxis' => '',
        'Value Series' => '',
        ...
        'Ticket %s: solution time will be over in %s!' => 'Per questo Ticket %s: soluzione scadradopo %s! ',
        'There are more escalated tickets!' => 'Ci sono piu tickets in gestione!',
        ...
        'Open Tickets / Need to be answered' => 'Tickets Aperti/ Serve una risposta',
        ...
        'All tickets where the reminder date has reached!' => 'tickets con data di avviso superata!',
        'Responses' => 'Risposte',
        ...
        'Ticket closed between' => 'Ticket Chiusi fra ',
        ...
        'Do you really want to reinstall this package (all manual changes get lost)?' => 'Vuoi veramente Re-installere questo Package (tutte le modifiche saranno perse ) ? ',
        'Continue' => 'Continua',
        'Install' => 'Installa',
        'Package' => 'Pacchetto',
        'Online Repository' => 'Archivio Online',
        'Vendor' => 'Fornitore',
        'Module documentation' => 'Documentazione Modulo',
        'Upgrade' => 'Aggiorna',
        ...
        'Change responsible of ticket' => 'Cambia responsabile del Ticket',
