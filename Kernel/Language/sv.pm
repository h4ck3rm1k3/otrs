...
# --
# $Id: sv.pm,v 1.2.2.1 2004/10/25 09:47:46 martin Exp $
# --
...
sub Data {
    ...
    # $$START$$
    # Last translation Fri May 21 19:28:37 2004 by 
    ...
    # Template: AAAPreferences
      ...
      'Send me a notification if a ticket is moved into a custom queue.' => 'Skicka mig ett meddelande ifall ett ärende flyttas över till en av mina utvalda köer.',
      ...
      'Send me a notification if there is a new ticket in my custom queues.' => 'Skicka mig ett meddelande ifall det kommer ett nytt ärende till mina utvalda köer.',
      'Show closed tickets.' => 'Visa låsta ärenden.',
    ...
    # Template: AdminAutoResponseForm
      ...
      'to get the ticket id of the ticket' => 'för att få fram internt ärende-id',
      'to get the ticket number of the ticket' => 'för att få fram ärende-nummer',
      'Type' => 'Typ',
    ...
    # Template: AdminCustomerUserGroupChangeForm
      ...
      'Customer User <-> Group Management' => 'Kundanvändare <-> grupper',
    ...
    # Template: AgentCompose
      ...
      'Is the ticket answered' => 'Är ärendet besvarat',
    ...
    # Template: AgentForward
      ...
      'Forward article of ticket' => 'Vidarebefordrad artikel från ärende',
    ...
    # Template: AgentPhone
      'Customer called' => 'Kunduppringning',
    ...
    # Template: AgentUtilTicketStatus
      'All closed tickets' => 'Alla låsta ärenden',
      'All open tickets' => 'Alla öppna ärenden',
      'closed tickets' => 'låsta ärenden',
    ...
    # Template: CustomerNavigationBar
      ...
      'FAQ' => 'FAQ',
      'New Ticket' => 'Nytt ärende',
      'Ticket-Overview' => 'Ärende-översikt',
    ...
    # Template: InstallerSystem
      ...
      '(Ticket identifier. Some people want to set this to e. g. \'Ticket#\', \'Call#\' or \'MyTicket#\')' => '(Ärende-identifierare, t.ex. \'Ärende#\', \'Samtal#\' eller \'MittÄrende#\')',
    ...
    # Misc
      ...
      'New ticket via call.' => 'Nytt ärende via samtal.',
