...
# --
# $Id: sv.pm,v 1.40 2007/09/29 10:36:40 mh Exp $
# --
...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'The recommended charset for your language is %s!' =>
            'Den rekommenderade teckenuppsättningen för ditt språk är %s!',
        ...
        'Logout successful. Thank you for using OTRS!' =>
            'Utloggningen lyckades.  Tack för att du använde OTRS!',
        ...
        'Session has timed out. Please log in again.' =>
            'Sessionstiden har löpt ut.  Vänligen logga på igen.',
        'No Permission!'                         => '',
        ...
        'Select your QueueView refresh time.' =>
            'Välj automatisk uppdateringsintervall för Kö-bild.',
        ...
        'This is a HTML email. Click here to show it.' =>
            'Detta är ett HTML-email. Klicka här för att visa.',
        'Free Fields'                                          => '',
        'Merge'                                                => '',
        'merged'                                               => '',
        ...
        'Select your screen after creating a new ticket.' =>
            'Välj skärmbild som visas efter registrering av ny hänvisning/ärende.',
        ...
        'Read only access to the ticket in this group/queue.' =>
            'Endast läsrättighet till ärenden i denna grupp/kö.',
        'rw' => '',
        ...
        'Fulltext-Search in Article (e. g. "Mar*in" or "Baue*")' =>
            'Fritextsök i artiklar (t.ex. "Mar*in" eller "Baue*")',
        ...
        'Create new groups to handle access permissions for different groups of agent (e. g. purchasing department, support department, sales department, ...).'
            => 'Skapa nya grupper för att kunna handtera olika rättigheter för skilda grupper av agenter (t.ex. inköpsavdelning, supportavdelning, försäljningsavdelning, ...).',
        ...
        'Notifications are sent to an agent or a customer.' =>
            'Meddelanden skickats till agenter eller kunder.',
        ...
        'Will be the sender address of this queue for email answers.' =>
            'Avsändaradress för email i denna Kö.',
        ...
        'Don\'t forget to add a new response a queue!' =>
            'Kom ihåg att lägga till ett nytt svar till en kö!',
        ...
        'Permissions to move tickets into this group/queue.' =>
            'Rätt att flytta ärenden i denna grupp/Kö.',
        'create' => 'Skapa',
        'Permissions to create tickets in this group/queue.' =>
            'Rätt att skapa ärenden i denna grupp/Kö.',
        'owner' => 'Ägare',
        'Permissions to change the ticket owner in this group/queue.' =>
            'Rätt att ändra ärende-ägare i denna grupp/Kö.',
        'priority' => 'prioritet',
        ...
        'Take care that you also updated the default states in you Kernel/Config.pm!' =>
            'Se till att du också uppdaterade standardutgångslägena i Kernel/Config.pm!',
        'See also' => 'Se också',
        ...
        'Discard all changes and return to the compose screen' =>
            'Bortse från ändringarna och stäng fönstret',
        ...
        'Set customer user and customer id of a ticket' =>
            'Ange kundanvändare och organisations-id för ett ärende',
        ...
        'your MySQL DB should have a root password! Default is empty!' =>
            'Din MySQL-databas bör ha ett root-lösenord satt!  Default är inget lösenord!',
        'Database-User'   => '',
        'default \'hot\'' => '',
        'DB connect host' => '',
        'Database'        => '',
        ...
        '(The identify of the system. Each ticket number and each http session id starts with this number)'
            => '(Unikt id för detta system.  Alla ärendenummer och http-sesssionsid börjar med denna id)',
        'System FQDN' => '',
        '(Full qualified domain name of your system)' =>
            '(Fullt kvalificerat dns-namn för ditt system)',
        ...
        'A message should have a To: recipient!' =>
            'Ett meddelande måste ha en mottagare i Till:-fältet!',
        'Site' => 'plats',
        'Customer history search (e. g. "ID342425").' =>
            'Sök efter kundhistorik (t.ex. "ID342425").',
        'for agent firstname' => 'för agents förnamn',
        'Close!'              => 'Stäng!',
        'Subgroup \''         => '',
        'The message being composed has been closed.  Exiting.' =>
            'Det tilhörande redigeringsfönstret har stängts. Avslutar.',
        'A web calendar' => '',
        'to get the realname of the sender (if given)' =>
            'för att få fram avsändarens fulla namn (om möjligt)',
        ...
        'Home'                    => 'Hem',
        'Config options (e. g. <OTRS_CONFIG_HttpType>)' =>
            'Konfigurationsval (t.ex. <OTRS_CONFIG_HttpType>)',
        'System History'                 => '',
        ...
        'A message must be spell checked!' =>
            'Stavningskontroll måste utföras på alla meddelanden!',
        ...
        'to get the first 20 character of the subject' =>
            'för att få fram de förste 20 tecknen i ämnesbeskrivningen',
        ...
        'This window must be called from compose window' =>
            'Denne funktion måste startas från redigeringsfönstret',
        'Minutes'                            => '',
        ...
        'Don\'t forget to add a new user to groups!' =>
            'Glöm inte att lägga in en ny användare i en grupp!',
        ...
        'Article time' => '',
        'Ticket owner options (e. g. <OTRS_OWNER_UserFirstname>)' =>
            'ger tillgang till data för agenten som står som ägare till ärendet (t.ex. <OTRS_OWNER_UserFirstname>)',
        'Name is required!'                 => '',
        'DB Type'                           => 'DB typ',
