...
# --
# $Id: pl.pm,v 1.120 2011/12/19 12:29:08 mg Exp $
# --
...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'Login failed! Your user name or password was entered incorrectly.' => 'Błąd logowania! Podana została zła nazwa użytkownika lub hasło.',
        ...
        'Don\'t use the Superuser account to work with OTRS! Create new Agents and work with these accounts instead.' => 'Nie używaj konta superużytkownika do pracy w OTRS! Stwórz raczej nowych agentów i pracuj na ich kontach!',
        ...
        'No packages for your framework version found in this repository, it only contains packages for other framework versions.' => 'Brak paczek dla twojej wersji środowiska w tym repozytorium, zawiera ono tylko paczki dla innych wersji środowiska.',
        'No packages, or no new packages, found in selected repository.' => 'Brak paczek lub brak nowych paczek w wybranym repozytorium.',
        ...
        'Dear %s,' => 'Drogi %s,',
        'Hello %s,' => 'Witaj %s,',
        'This email address already exists. Please log in or reset your password.' => 'Ten adres e-mail już istnieje. Prosimy, zaloguj się lub zresetuj swoje hasło.',
        'New account created. Sent login information to %s. Please check your email.' => 'Utworzono nowe konto. Informacje dotyczące sposobu logowania zostały wysłane do %s. Prosimy o sprawdzenie swojej skrzynki pocztowej.',
        ...
        'Select the separator character used in CSV files (stats and searches). If you don\'t select a separator here, the default separator for your language will be used.' => 'Wskaż znak separatora w pliku CSV (statystyki i wyszukiwania). Jeśli nie wskażzesz tutaj separatora, użyty zostanie domyślny separator dla twojego języka.',
        ...
        'Your queue selection of your favourite queues. You also get notified about those queues via email if enabled.' => 'Twój zestaw wybranych kolejek. Jeżeli włączysz opcję "Powiadomienie o nowym zgłoszeniu" to dostaniesz wiadomość e-mail o każdym nowym zgłoszeniu, które pojawi się w tych kolejkach.',
        ...
        'Send me the same notifications for my watched tickets that the ticket owners will get.' => 'Wysyłaj do mnie takie same powiadomienia dla obserwowanych przeze mnie zgłoszeń, jakie otrzymywać będą właściciele tych zgłoszeń.',
        ...
        'All open tickets, these tickets have already been worked on, but need a response' => 'Wszystkie otwarte zgłoszenia, były już podjęte prace w związku z nimi ale obecnie wymagają odpowiedzi',
        ...
        'Select' => 'Zaznacz',
        'Hint' => 'Podpowiedź',
        'Customer will be needed to have a customer history and to login via customer panel.' => 'Klient będzie wymagany by mieć historię klienta i by logować się przez panel klienta.',
        ...
        'This field is required and needs to be a valid email address.' => 'To pole jest wymagane i musi być poprawnym adresem e-mail.',
        'This email address is not allowed due to the system configuration.' => 'Ten adres e-mail nie jest dozwolony z uwagi na konfigurację systemu.',
        ...
        'Just use this feature if you want to define group permissions for customers.' => 'Użyj tej funkcji jeśli chcesz zdefinioać grupę uprawnień dla klientów.',
        ...
        'You can manage these groups via the configuration setting "CustomerGroupAlwaysGroups".' => 'Możesz zarządzać tymi grupami poprzez parametr "CustomerGroupAlwaysGroups".',
        'Filter for Groups' => 'Filtr dla grup.',
        'Select the customer:group permissions.' => 'Wybierz uprawnienia klient:grupa',
        'If nothing is selected, then there are no permissions in this group (tickets will not be available for the customer).' => 'Jeśli nic nie zostało zaznaczone, wtedy nie ma uprawnień w tej grupie (zgłoszenia nie będą dostępne dla klienta).',
        ...
        'Create new groups to handle access permissions for different groups of agent (e. g. purchasing department, support department, sales department, ...). ' => 'Utwórz nowe grupy aby obsłużyć prawa dostępu dla różnych grup agentów (np. działu zakupu, działu wsparcia, działu sprzedaży, ...). ',
        ...
        'To get the first 20 character of the subject (of the latest agent article).' => 'Aby pobrać pierwszych 20 znaków tematu (najnowszego artykułu agenta)',
        'To get the first 5 lines of the body (of the latest agent article).' => 'Aby pobrać pierwszych 5 linie treści (najnowszego artykułu agenta)',
        'To get the first 20 character of the subject (of the latest customer article).' => 'Aby pobrać pierwsze 20 znaków tematu (najnowszego artykułu klienta)',
        'To get the first 5 lines of the body (of the latest customer article).' => 'Aby pobrać pierwsze 5 linii treści (najnowszego artykułu klienta)',
        ...
        'Do you really want to reinstall this package? Any manual changes will be lost.' => 'Czy na pewno chcesz reinstalować ten pakiet? Wszystkie ręczne modyfikacje będą utracone.',
        'Continue' => 'Kontynuuj',
        'Install' => 'Instaluj',
        ...
        'Package not correctly deployed! You should reinstall the package again!' => 'Pakiet nie został poprawnie zainstalowany! Pakiet ten powinien być ponownie zainstalowany!',
        ...
        'Activating this feature might affect your system performance!' => 'Włączenie tej opcji może wpłynąć na wydajność twojego systemu!',
        ...
        'To dispatch or filter incoming emails based on email headers. Matching using Regular Expressions is also possible.' => 'Aby rozdzielić lub odfiltrować napływające wiadomości e-mail na podstawie nagłówków e-mail. Możliwe dopasowywanie przy użyciu wyrażeń regularnych.',
        ...
        'If you use Regular Expressions, you also can use the matched value in () as [***] in the \'Set\' action.' => 'Jeśli użyjesz wyrażeń regularnych, możesz również użyć dopasowanej wartości w () jako [***] w akcji \'Set\'.',
        ...
        'Value' => 'Wartość',
        'The field needs to be a valid regular expression or a literal word.' => 'Pole musi zawierać poprawne wyrażenie regularne lub słowo.',
        ...
        'If there is not added a customer contact, either email-external or phone, to a new ticket before the time defined here expires, the ticket is escalated.' => 'Jeśli w określonym tutaj czasie nie pojawi się kontakt z klientem, zewnętrzny e-mail lub telefon związany z nowym zgłoszeniem, zgłoszenie takie będzie eskalowane.',
        'If there is an article added, such as a follow-up via email or the customer portal, the escalation update time is reset. If there is no customer contact, either email-external or phone, added to a ticket before the time defined here expires, the ticket is escalated.' => 'Jeśli dodany zostanie artykuł, tj. nowa wiadomość przez e-mail lub z portala WWW klineta, czas aktualizacji eskalacji będzie zresetowany. Jeśli nie będzie kontaktu z klientem, zewnętrznego e-maila lub telefonu dodanego do zgłoszenia przed upłynięciem zadanego tutaj czasu, zgłoszenie to będzie eskalowane.',
        ...
        'Specifies if follow up to closed tickets would re-open the ticket, be rejected or lead to a new ticket.' => 'Określa czy nowa wiadomość do zamkniętego zgłoszenia będzie otwierała to zgłoszenie czy będzie odrzucana czy też będzie generowała nowe zgłoszenie.',
        ...
        'There are no roles defined. Please use the \'Add\' button to create a new role.' => 'Nie ma zdefiniowanych ról. Użyj przycisku \'Add\' aby utworzyć nową rolę',
        'Add Role' => 'Dodaj rolę',
        ...
        'If nothing is selected, then there are no permissions in this group (tickets will not be available for the role).' => 'Jeśli nic nie będzie zaznaczone, wtedy nie będzie uprawnień w tej grupie (zgłoszenia nie będą dostępne dla roli).',
        ...
        'Secure mode will (normally) be set after the initial installation is completed.' => 'Tryb bezpieczny będzie (standardowo) włączony po inicjalnej instalacji.',
        'Secure mode must be disabled in order to reinstall using the web-installer.' => 'Tryb bezpieczny musi być wyłączony aby reinstalować przy użyciu instalatora web.',
        'If secure mode is not activated, activate it via SysConfig because your application is already running.' => 'Jeśli tryb bezpieczny nie jest aktywny, uaktywnij go w SysConfig gdyż twoja aplikacja jest już uruchomiona.',
        ...
        'The syntax of your SQL query has a mistake. Please check it.' => 'Składnia twojego zapytania SQL jest niepoprawna. Sprawdź ją.',
        'There is at least one parameter missing for the binding. Please check it.' => 'Brakuje przynajmniej jednego parametru połączenia. Sprawdź je.',
        ...
        'This config item is only available in a higher config level!' => 'Ten element konfiguracji jest dostępny wyłącznie na wyższym poziomie konfiguracji!',
        ...
        'All incoming email with this address in To or Cc will be dispatched to the selected queue.' => 'Wszystkie przychodzące wiadomości e-mail z tym adresem w Do lub DW będą skierowane do wskazanej kolejki.',
        'Email address' => 'Adres e-mail',
        'Display name' => 'Wyświetlana nazwa',
        'Add System Email Address' => 'Dodaj systemowy adres e-mail',
        'Edit System Email Address' => 'Edytuj systemowy adres e-mail',
        'The display name and email address will be shown on mail you send.' => 'Wyświetlana nazwa oraz adres e-mail będą umieszczane w wysyłanej poczcie.',
        ...
        'owner' => 'właściciel',
        'Permissions to change the owner of tickets in this group/queue.' => 'Uprawnienia do zmiany właściciela zgłoszeńw tej grupie/kolejce.',
        ...
        'You can select one or more groups to define access for different agents.' => 'Możesz wskazać jedną lub więcej grup aby zdefiniować dostęp dla różnych agentów.',
        'Some result formats are disabled because at least one needed package is not installed.' => 'Niektóre formaty wynikowe są zablokowane ponieważ przynajmniej jeden z wymaganych pakietów nie jest zainstalowany.',
        'Please contact your administrator.' => 'Prosimy, o kontakt z twoim administratorem.',
        'Graph size' => 'Rozmiar wykresu.',
        'If you use a graph as output format you have to select at least one graph size.' => 'Jeżeli używasz wykresu jako formatu wyjściowego, musisz okreslić jego rozmiar.',
        'Sum rows' => 'Suma wierszy',
        'Sum columns' => 'Suma kolumn',
        'Use cache' => 'Użyj pamięci podręcznej',
        'Most of the stats can be cached. This will speed up the presentation of this stat.' => 'Większość statystyk może być umieszczona w pamięci podręcznej. Przyspiesza to wyświetlanie tych statystyk.',
        ...
        'If you don\'t select any attribute all attributes of the element will be used if you generate a stat, as well as new attributes which were added since the last configuration.' => 'Jeśli nie zaznaczysz żadnego atrybutu, wszystkie atrybuty tego elementu będą użyte do wygenerowania statystyki, w tym również nowe atrybuty, które zostały dodane od czasu ostatniej konfiguracji.',
        'Scale' => 'Skala',
        'minimal' => 'minimum',
        ...
        'Here you can define the x-axis. You can select one element via the radio button.' => 'Tutaj definiujesz oś X. Możesz zaznaczyć jeden element za pomocą przycisku radio.',
        ...
        'With the input and select fields you can influence the format and contents of the statistic.' => 'Korzystając z pól wejściowych i wyboru możesz wpłynąć na format i zawartość statystyki.',
        'Exactly what fields and formats you can influence is defined by the statistic administrator.' => 'To, które z pól i formatów możesz zmieniać zdefiniował administrator statystyki.',
        ...
        'To protect your privacy, active or/and remote content has blocked.' => 'Aby chronić twoją prywatność, aktywna lub/i zdalna zawartość została zablokowana.',
        ...
        'In order to experience OTRS, you\'ll need to enable JavaScript in your browser.' => 'Aby korzystać z OTRS, musisz włączyć obsługę JavaScript w twojej przeglądarce.',
        ...
        'If you have set a root password for your database, it must be entered here. If not, leave this field empty. For security reasons we do recommend setting a root password. For more information please refer to your database documentation.' => 'Jeżeli masz hasło administratora bazy danych wpisz je tutaj. Jeżeli nie, zostaw pole puste. Ze względów bezpieczeństwa zalecamy ustawienie hasła administratora bazy danych. Po szczegóły sięgnij do dokumentacji bazy danych.',
        'Currently only MySQL is supported in the web installer.' => 'Obecnie instalator web wspiera jedynie bazę danych MySQL.',
        'If you want to install OTRS on another database type, please refer to the file README.database.' => 'Jeśli chcesz zainstalować OTRS na innym silniku baz danych, prosimy o zapoznanie się z treścią pliku README.database.',
        'Database-User' => 'Użytkownik bazy danych',
        'New' => 'Nowa',
        'A new database user with limited rights will be created for this OTRS system.' => 'Dla tego systemu OTRS utworzony zostanie nowy użytkownik bazy danych z ograniczonymi uprawnieniami.',
        ...
        'OTRS runs with a huge lists of browsers, please upgrade to one of these.' => 'OTRS współpracyje z ogromną listą przeglądarek, prosimy, użyj jednej z nich.',
        'Please see the documentation or ask your admin for further information.' => 'Zajrzyj do dokumentacji lub zapytaj o szczegóły swojego administratora.',
        ...
        'Here you can define the x-axis. You can select one element via the radio button. Then you you have to select two or more attributes of the element. If you make no selection all attributes of the element will be used if you generate a stat. As well a new attribute is added since the last configuration.' => 'Tu możesz zdefiniowac oś X. Możesz wybrać jeden element ze zdefiniowanych. Następnie musisz wybrać dwa lub więcej atrybutów wskazanego elementu. Jeżeli nie wybrałeś żadnego atrybutu, wszystkie atrybuty zostaną użyte przy generowaniu statystyki. Tak samo jak nowe atrybuty dodane od ostatniej konfiguracji.',
        ...
        'Permission settings. You can select one or more groups to make the configurated stat visible for different agents.' => 'Ustawienia dostepu. Wybierz grupy mogące udostępniać przygotowane statystyki dla innych agentów.',
        ...
        'This is useful if you want that no one can get the result of the stat or the stat isn\'t ready configurated.' => 'To jest użyteczna blokada jeżeli chcesz uniemożliwić generowanie statystyki przed zakończeniem tworzenia wzorca.',
