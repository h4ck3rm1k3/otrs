...
# --
# $Id: pl.pm,v 1.55 2008/05/06 23:23:10 martin Exp $
# --
...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'Please answer this ticket(s) to get back to the normal queue view!' =>
            'Proszê odpowiedz na to zg³oszenie, by móc powrociæ do zwyk³ego widoku kolejki zg³oszeñ!',
        ...
        'The recommended charset for your language is %s!' =>
            'Sugerowane kodowanie dla Twojego jêzyka to %s!',
        ...
        'Login failed! Your username or password was entered incorrectly.' =>
            'Logowanie niepoprawne! Twój u¿ytkownik lub has³o zosta³y wpisane niepoprawnie.',
        'Please contact your admin' => 'Skontaktuj siê z Administratorem',
        'Logout successful. Thank you for using OTRS!' =>
            'Wylogowanie zakoñczone! Dziêkujemy za u¿ywanie OTRS!',
        ...
        'Don\'t work with UserID 1 (System account)! Create new users!' =>
            'Nie u¿ywaj u¿ytkownika z UserID 1 (Konto systemowe)! Stwórz nowych u¿ytkowników!',
        ...
        'To: (%s) replaced with database email!' =>
            'DO: (%s) zamienione z adresem email z bazy danych',
        ...
        'Max. shown Tickets a page in Overview.' =>
            'Limit pokazywanych zg³oszeñ na stronie Podsumowania',
        ...
        'This message was written in a character set other than your own.' =>
            'Ta wiadomo¶æ zosta³a napisana z u¿yciem kodowania znaków innego ni¿ Twój.',
        ...
        'This is a HTML email. Click here to show it.' =>
            'To jest e-mail w formacie HTML. Kliknij tutaj, by go przeczytaæ.',
        'Free Fields'                                 => '',
        'Merge'                                       => '',
        'merged'                                      => '',
        ...
        'Send me a notification if a customer sends a follow up and I\'m the owner of this ticket.'
            => 'Wy¶lij mi wiadomo¶æ, gdy klient odpowie na zg³oszenie, którego ja jestem w³a¶cicielem.',
        'Ticket lock timeout notification' =>
            'Powiadomienie o przekroczonym czasie blokady zg³oszenia',
        'Send me a notification if a ticket is unlocked by the system.' =>
            'Wy¶lij mi wiadomo¶æ, gdy zg³oszenie zostanie odblokowane przez system.',
        ...
        'Select your screen after creating a new ticket.' =>
            'Wybierz ekran, który poka¿e siê po rejestracji nowego zg³oszenia',
        'Closed Tickets'       => 'Zamkniête zg³oszenia',
        'Show closed tickets.' => 'Poka¿ zamkniête zg³oszenia.',
        'Max. shown Tickets a page in QueueView.' =>
            'Limit pokazywanych zg³oszeñ na stronie Podgl±du Kolejki',
        'CompanyTickets'            => '',
        'MyTickets'                 => '',
        'New Ticket'                => '',
        'Create new Ticket'         => '',
        ...
        'If nothing is selected, then there are no permissions in this group (tickets will not be available for the user).'
            => 'Je¶li nic nie zaznaczono, wtedy u¿ytkownik nie bêdzie mia³ praw w tej grupie (zg³oszenia bêd± niedostêpne)',
        'Permission' => 'Prawo dostêpu',
        'ro'         => '',
        'Read only access to the ticket in this group/queue.' =>
            'Prawo jedynie do odczytu zg³oszeñ w tej grupie/kolejce',
        'rw' => '',
        'Full read and write access to the tickets in this group/queue.' =>
            'Prawa pe³nego odczytu i zapisu zg³oszeñ w tej grupie/kolejce',
        ...
        'Fulltext-Search in Article (e. g. "Mar*in" or "Baue*")' =>
            'Przeszukiwanie pe³notekstowe w artykule (np. "Ja*k" lub "Rumia*)',
        ...
        'The admin group is to get in the admin area and the stats group to get stats area.' =>
            'Grupa Admin pozwala posiada prawa Administracji systemem. Grupa Stats umo¿liwia przegl±danie statystyk zg³oszeñ.',
        'Create new groups to handle access permissions for different groups of agent (e. g. purchasing department, support department, sales department, ...).'
            => 'Stwórz nowe grupy, by móc efektywniej zarz±dzaæ dostêpem do zg³oszeñ ró¼nych grup u¿ytkownikow (np. Serwisu, Sprzeda¿y itp...).',
        ...
        'Notifications are sent to an agent or a customer.' =>
            'Powiadomienia s± wysy³ane do agenta obs³ugi lub klienta',
        ...
        'All incoming emails with one account will be dispatched in the selected queue!' =>
            'Wszystkie przychodz±ce na jedno konto wiadomo¶ci bêd± umieszczone w zaznacznej kolejce!',
        ...
        'If an agent locks a ticket and he/she will not send an answer within this time, the ticket will be unlock automatically. So the ticket is viewable for all other agents.'
            => 'Je¶li agent zablokuje zg³oszenie, a nastêpnie nie odpowie na nie w ci±gu wskazanego czasu, wtedy zg³oszenie zostanie automatycznie odblokowane. Dziêki temu pozostali agenci bêd± mogli je zobaczyæ.',
        'Escalation time' => 'Czas eskalacji',
        'If a ticket will not be answered in this time, just only this ticket will be shown.' =>
            'Je¶li, w podanym czasie, nie zostanie udzielona odpowied¼ na zg³oszenie, wtedy tylko to zg³oszenie bêdzie widoczne w kolejce.',
        'If a ticket is closed and the customer sends a follow up the ticket will be locked for the old owner.'
            => 'Je¶li zg³oszenie by³o zamkniête, a klient przy¶le do niego kolejn± odpowied¼, wtedy zg³oszenie zostanie zablokowane w kolejce starego w³a¶ciciela.',
        'Will be the sender address of this queue for email answers.' =>
            'Bêdzie adresem nadawcy odpowiedzi emailowych wysy³anych z tej kolejki.',
        ...
        'OTRS sends an notification email to the customer if the ticket is moved.' =>
            'System wy¶le powiadomienie do klienta, gdy zg³oszenie zostanie przesuniête do innej kolejki.',
        'OTRS sends an notification email to the customer if the ticket state has changed.' =>
            'System wy¶le powiadomienie do klienta, gdy zmieni sie status zg³oszenia.',
        'OTRS sends an notification email to the customer if the ticket owner has changed.' =>
            'System wy¶le powiadomienie do klienta, gdy zmieni sie w³a¶ciciel zg³oszenia.',
        ...
        'A response is default text to write faster answer (with default text) to customers.' =>
            'Odpowied¼ to domy¶lny tekst wstawiany do odpowiedzi klientowi, dziêki czemu agent mo¿e szybciej odpowiedzieæ na zg³oszenie.',
        'Don\'t forget to add a new response a queue!' =>
            'Nie zapomnij powi±zaæ nowej odpowiedzi z jak±¶ kolejk±!',
        ...
        'Permissions to move tickets into this group/queue.' =>
            'Uprawnienia do przesuwania zg³oszeñ do tej grupy/kolejki',
        'create' => 'utwórz',
        'Permissions to create tickets in this group/queue.' =>
            'Uprawnienia do tworzenia zg³oszeñ w tej grupie/kolejce',
        'owner' => 'w³a¶ciciel',
        'Permissions to change the ticket owner in this group/queue.' =>
            'Uprawnienia do zmiany w³a¶ciciela zg³oszenia w tej grupie/kolejce',
        'priority' => 'priorytet',
        'Permissions to change the ticket priority in this group/queue.' =>
            'Uprawnienia do zmiany priorytetu zg³oszenia w tej grupie/kolejce',
        ...
        'Take care that you also updated the default states in you Kernel/Config.pm!' =>
            'Pamiêtaj, by auktualniæ równie¿ domy¶lne statusy w pliku Kernel/Config.pm !',
        ...
        'All incoming emails with this "Email" (To:) will be dispatched in the selected queue!' =>
            'Wszystkie wiadomo¶ci przys³ane na ten adres w polu (Do:) zostan± umieszczone w tej kolejce.',
        ...
        'User will be needed to handle tickets.' =>
            'U¿ytkownik bêdzie niezbêdny do obs³ugi zg³oszenia.',
        ...
        'Discard all changes and return to the compose screen' =>
            'Anuluj wszystkie zmiany i powróæ do ekranu edycji',
        ...
        'Set customer user and customer id of a ticket' =>
            'Wska¿ klienta i ID klienta dla zg³oszenia',
        ...
        '(The identify of the system. Each ticket number and each http session id starts with this number)'
            => '(Identyfikator systemu. Wszystkie zg³oszenia oraz sesje http bêd± zaczyna³y siê od tego ci±gu)',
        'System FQDN' => 'Pe³na domena systemu FQDN',
        '(Full qualified domain name of your system)' =>
            '(Pe³na nazwa domeny Twojego systemu FQDN)',
        ...
        '(Logfile just needed for File-LogModule!)' =>
            '(Logfile jest potrzebny jedynie dla modu³u File-Log!)',
        'Webfrontend'     => 'Interfejs webowy',
        'Default Charset' => 'Domy¶lne kodowanie',
        'Use utf-8 it your database supports it!' =>
            'U¿ywaj kodowania UTF-8 je¶li pozwala Ci na to baza danych!',
        ...
        'To be able to use OTRS you have to enter the following line in your command line (Terminal/Shell) as root.'
            => 'Musisz wpisaæ nastêpuj±ce polecenie w linii komend (Terminal/Shell).',
        'Restart your webserver' => 'Uruchom ponownie serwer WWW',
        'After doing so your OTRS is up and running.' =>
            'Po zakoñczeniu tych czynno¶ci Twój system OTRS bêdzie gotowy do pracy',
        ...
        '(Ticket identifier. Some people want toset this to e. g. \'Ticket#\', \'Call#\' or \'MyTicket#\')'
            => '(Identyfikator zg³oszenia. np. \'Ticket#\', \'Call#\' lub \'MyTicket#\')',
        'In this way you can directly edit the keyring configured in Kernel/Config.pm.' => '',
        'Create new Phone Ticket'                                                       => '',
        'Symptom'                                                                       => 'Objawy',
        'A message should have a To: recipient!' =>
            'Wiadomo¶æ musi zawieraæ wype³nione adresem polu Do: (odbiorca)!',
        'Site' => 'Witryna',
        'Customer history search (e. g. "ID342425").' =>
            'Przeszukiwanie historii klienta (np. "ID342425").',
        'Close!'              => 'Zamknij!',
        'for agent firstname' => 'dla imienia agenta',
        'The message being composed has been closed.  Exiting.' =>
            'Wiadomo¶æ edytowana zosta³a zamkniêta.  Wychodzê.',
        'A web calendar' => '',
        'to get the realname of the sender (if given)' =>
            'by wstawiæ prawdziwe imiê i nazwisko klienta (je¶li podano)',
        ...
        'Queue ID' => 'ID Kolejki',
        'Config options (e. g. <OTRS_CONFIG_HttpType>)' =>
            'Opcje konfiguracyjne (np. <OTRS_CONFIG_HttpType>)',
        ...
        'Your email with ticket number "<OTRS_TICKET>" is bounced to "<OTRS_BOUNCE_TO>". Contact this address for further informations.'
            => 'Twoja wiadomo¶æ o numerze zg³oszenia: "<OTRS_TICKET>" zosta³a przekazana na adres "<OTRS_BOUNCE_TO>" . Prosimy kontaktowaæ siê pod tym adresem we wszystkich sprawach dotycz±cych tego zg³oszenia.',
        ...
        'This window must be called from compose window' =>
            'To okno musi zostaæ wywo³ane z okna edycji',
        ...
        'Options of the current user who requested this action (e. g. <OTRS_CURRENT_UserFirstname>)'
            => 'Opcje aktualnego agenta obs³ugi (np. <OTRS_CURRENT_UserFirstname>)',
        ...
        'You need a email address (e. g. customer@example.com) in To:!' =>
            'W polu Do: musi znale¼æ siê adres email (np. klient@przyklad.pl)!',
        ...
        'WebMail'                                             => '',
        'Ticket owner options (e. g. <OTRS_OWNER_UserFirstname>)' =>
            'Opcje dotycz±ce w³a¶ciciela zg³oszenia (np. <OTRS_OWNER_UserFirstname>)',
        'Name is required!'                 => '',
