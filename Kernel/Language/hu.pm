...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'The recommended charset for your language is %s!' =>
            'Az ajánlott karakterkészlet az ön nyelvénél %s!',
        'Passwords doesn\'t match! Please try it again!' =>
            'A jelszavak nem egyeznek! Próbálja meg újra!',
        'Password is already in use! Please use an other password!' => '',
        'Password is already used! Please use an other password!'   => '',
        'You need to activate %s first to use it!' =>
            '%s aktiválására van szükség mielõtt használná!',
        ...
        'Logout successful. Thank you for using OTRS!' =>
            'Kilépés megtörtént! Köszönjük, hogy az OTRS-t használja!',
        'Invalid SessionID!' => 'Hibás folyamat azonosító!',
        'SessionID invalid! Need user data!' =>
            'Hibás folyamat azonosító! Felhasználói adatok megadása szükséges!',
        ...
        'Session has timed out. Please log in again.' =>
            'Az folyamat idõtúllépés miatt befejezõdött. Kérjük lépjen be újra.',
        ...
        'Package not correctly deployed! You should reinstall the Package again!' =>
            'A csomag nincsen megfelelõen telepítve! Telepítse újra a csomagot!',
        ...
        'Unable to parse Online Repository index document!' =>
            'Nem sikerült értelmezni az on-line csomagtároló index dokumentumát!',
        ...
        'Select your frontend QueueView.' =>
            'Válassza ki a felhasználói felület Várólista nézetét.',
        'Spelling Dictionary' => 'Helyesírás-ellenõrzõ szótár',
        'Select your default spelling dictionary.' =>
            'Válassza ki az alapértelmezett helyesírásellenõrzõ szótárat.',
        ...
        'Can\'t update password, invalid characters!' =>
            'Nem sikerült modosítani a jelszót, érvénytelen karakterek!',
        'Can\'t update password, need min. 8 characters!' =>
            'Nem sikerült modosítani a jelszót, legalább 8 karakter megadása szükséges!',
        'Can\'t update password, need 2 lower and 2 upper characters!' =>
            'Nem sikerült modosítani a jelszót, legalább 2 kisbetûnek és 2 nagybetûnek kell benne szerepelnie!',
        'Can\'t update password, need min. 1 digit!' =>
            'Nem sikerült modosítani a jelszót, legalább egy számjegynek kell benne szerepelnie!',
        'Can\'t update password, need min. 2 characters!' =>
            'Nem sikerült modosítani a jelszót, legalább 2 karakter megadása szükséges!',
        ...
        'Please select one element for the X-axis!' =>
            'Kérem válasszon egy tulajdonságot az X tengelynek',
        'You have to select two or more attributes from the select field!' =>
            'Legalább két értéket válasszon ki a mezõben!',
        'Please select only one element or turn off the button \'Fixed\' where the select field is marked!'
            => 'Kérem válasszon egy értéket vagy kapcsolja ki a \'Rögzített\' kapcsolót a megjelölt mezõnél.',
        'If you use a checkbox you have to select some attributes of the select field!' =>
            'Ha egy jelölõnégyzetet használ, akkor néhány értéket is ki kell választania a tulajdonsághoz!',
        'Please insert a value in the selected input field or turn off the \'Fixed\' checkbox!' =>
            'Adjon meg egy értéket a bemeneti mezõben vagy kapcsolja ki a \'Rögzített\' kapcsolót!',
        'The selected end time is before the start time!' =>
            'A befejezési idõnek a kezdeti idõ után kell lennie!',
        'You have to select one or more attributes from the select field!' =>
            'Válasszon ki egy vagy több értéket a mezõbõl!',
        'The selected Date isn\'t valid!' => 'A kiválasztott dátum érvénytelen!',
        'Please select only one or two elements via the checkbox!' =>
            'Kérem válasszon egy vagy két elemet a jelölõnégyetekbõl!',
        'If you use a time scale element you can only select one element!' =>
            'Amennyiben egy idõskála elemet is választott, akkro csak egy elemet választhat közölük!',
        'You have an error in your time selection!' => 'Hibás a kiválasztott idõ!',
        'Your reporting time interval is too small, please use a larger time scale!' =>
            'A kiválasztott idõ intervallum túl kicsi, kérem válasszon nagyobb skálát.',
        'Your reporting time interval is too small, please use a larger time scale!' =>
            'A kiválasztott idõ intervallum túl kicsi, kérem válasszon nagyobb skálát.',
        'The selected start time is before the allowed start time!' =>
            'A kiválasztott kezdési idõ a megengedett kezdési idõ elõtt van!',
        'The selected end time is after the allowed end time!' =>
            'A kiválasztott befejezési idõ a megengedett befejezési idõ után van!',
        'The selected time period is larger than the allowed time period!' =>
            'A kiválasztott ismétlõdés a megengedett ismétlõdésnél nagyobb!',
        ...
        'This is a HTML email. Click here to show it.' =>
            'Ez egy HTML e-mail. Kattintson ide a megtekintéshez.',
        ...
        'No such Ticket Number "%s"! Can\'t link it!' =>
            'Nincs "%s" számú jegy! Nem tudom csatolni!',
        ...
        'Create new Email Ticket and send this out (Outbound)' =>
            'Új E-mail jegy létrehozása és kiküldése (Kimenõ)',
        ...
        'Your queue selection of your favourite queues. You also get notified about those queues via email if enabled.'
            => 'Saját várólistáknak tekintett várólisták kiválasztása. E-mail értesítítések fog kapni ezekrõl a várólistákról, amennyiben ez engedélyezett.',
        ...
        'Select your screen after creating a new ticket.' =>
            'Válassza ki a képernyõt új jegy létrehozása után.',
        'Closed Tickets'       => 'Lezárt jegyek',
        'Show closed tickets.' => 'Mutasd a lezárt jegyeket.',
        'Max. shown Tickets a page in QueueView.' =>
            'A megjelenített jegyek számának maximuma a Várólista nézetnél.',
        ...
        'To get the first 20 character of the subject.' =>
            'Az elsõ 20 karakter használata a tárgyból',
        'To get the first 5 lines of the email.' => 'Az elsõ 5 sor használata az e-mailbõl.',
        'To get the realname of the sender (if given).' =>
            'A küldõ valódi nevének használata (ha van ilyen)',
        ...
        'Ticket owner options (e. g. <OTRS_OWNER_UserFirstname>).' =>
            'A jegy tulajdonosának adatai (pl.  <OTRS_OWNER_UserFirstname>).',
        'Ticket responsible options (e. g. <OTRS_RESPONSIBLE_UserFirstname>).' =>
            'A jegy felelõsének adatai (pl. <OTRS_RESPONSIBLE_UserFirstname>).',
        'Options of the current user who requested this action (e. g. <OTRS_CURRENT_UserFirstname>).'
            => 'A mûveletet végzõ felhasználónak adatai (pl. <OTRS_CURRENT_UserFirstname>).',
        ...
        'Config options (e. g. <OTRS_CONFIG_HttpType>).' =>
            'Konfigurációs értékek (pl.  <OTRS_CONFIG_HttpType>).',
        ...
        'Customer user will be needed to have a customer history and to login via customer panel.'
            => 'Ügyfél felhasználó létrehozása szükséges, hogy legyenek ügyfélhez tartozó elõzmények és be lehessen lépni az ügyfél oldalon.',
        ...
        'If nothing is selected, then there are no permissions in this group (tickets will not be available for the user).'
            => 'Ha nincs semmi kiválasztva, akkor nincsenek jogosultságok ebben a csoportban (a jegyek nem lesznek elérhetõk a felhasználónak).',
        'Permission' => 'Jogosultság',
        'ro'         => 'Csak olvasás',
        'Read only access to the ticket in this group/queue.' =>
            'Csak olvasási jogosultság a jegyekhez ebben a csoportban/várólistában.',
        'rw' => 'Írás/Olvasás',
        ...
        'Customer Users <-> Services Management' =>
            'Ügyfél felhasználók <-> Szolgáltatások kezelése',
        'Select the customeruser:service relations.' =>
            'Válassza ki az ügyfél felhasználó:szolgáltatás relációt.',
        ...
        'Fulltext-Search in Article (e. g. "Mar*in" or "Baue*")' =>
            'Szöveg keresése a bejegyzésekben (pl. "Mar*in" or "Baue*")',
        ...
        'Yes means, send no agent and customer notifications on changes.' =>
            'Igen esetén nem küld értesítésekes sem az ügyintézõnek, sem az ügyfélnek a változásokról.',
        'No means, send agent and customer notifications on changes.' =>
            'Nem esetén mind az ügyintézõnek, mind az ügyfélnek küld értesítéseket a változásokról.',
        'Save' => 'Mentés',
        '%s Tickets affected! Do you really want to use this job?' =>
            '%s jegy érintett! Valóban el akarja végezni ezt a teendõt a jegyeken?',
        ...
        'Create new groups to handle access permissions for different groups of agent (e. g. purchasing department, support department, sales department, ...).'
            => 'Hozzon létre új csoportot a különbözõ ügyintézõ csoportok (pl. beszerzõ osztály, támogató osztály, eladó osztály, ...) hozzáférési jogainak kezeléséhez.',
        ...
        'Notifications are sent to an agent or a customer.' =>
            'Az értesítések ügyintézõnek vagy ügyfélnek kerülnek elküldésre.',
        ...
        'Do you really want to uninstall this package?' =>
            'Valóban el akarja távolítani ezt a csomagot?',
        ...
        'Just use this feature if you want to log each request.' =>
            'Használja ezt a képességet amennyiben naplózni szeretne minden egyes kérést.',
        ...
        'All incoming emails with one account will be dispatched in the selected queue!' =>
            'Az összes fiókkal rendelkezõ bejövõ e-mail egy kiválasztott várólistához lesz rendelve!',
        'If your account is trusted, the already existing X-OTRS header at arrival time (for priority, ...) will be used! PostMaster filter will be used anyway.'
            => 'Ha az Ön fiókja megbízható, a már létezõ X-OTRS fejlécet használjuk beérkezéskor (prioritáshoz, ...)! Egyéb esetben a levelezési szûrõk lesznek alkalmazva.',
        ...
        'Do dispatch or filter incoming emails based on email X-Headers! RegExp is also possible.'
            => 'A beérkezõ e-mailek az X-Fejlécek alapján legyen hozzárendelve! Szabályos kifejezések alkalmazhatók.',
        'If you want to match only the email address, use EMAILADDRESS:info@example.com in From, To or Cc.'
            => 'Amennyiben Ön csak az e-mail cím egyezését kívánja vizsgálni, akkor használja a EMAILADDRESS:info@example.com formulát a Feladó (From), Címzett (To) vagy Másolat (Cc) mezõkben.',
        'If you use RegExp, you also can use the matched value in () as [***] in \'Set\'.' =>
            'Ha szabályos kifejzéseket használ, használhatja a ()-ben levõ egyezõ értéket mint [***] a \'Beállítás\'-nál.',
        ...
        'If an agent locks a ticket and he/she will not send an answer within this time, the ticket will be unlock automatically. So the ticket is viewable for all other agents.'
            => 'Ha az ügyintézõ zárolja a jegyet és nem küld választ ezen idõn belül, a jegy zárolása megszûnik. Így a jegy látható lesz minden ügyintézõnek.',
        'Escalation time' => 'Kiemelési idõ',
        'If a ticket will not be answered in this time, just only this ticket will be shown.' =>
            'Ha a jegy nem kerül megválaszolásra a megadott idõn belül, csak ez a jegy lesz megjelenítve.',
        ...
        'Will be the sender address of this queue for email answers.' =>
            'Ennél a várólistánál ez lesz a feladó e-mail válaszokhoz.',
        ...
        'OTRS sends an notification email to the customer if the ticket is moved.' =>
            'Az OTRS értesítõ levelet küld az ügyfélnek ha a jegy áthelyezésre került.',
        'OTRS sends an notification email to the customer if the ticket state has changed.' =>
            'Az OTRS értesítõ levelet küld az ügyfélnek ha a jegy állapota megváltozott.',
        'OTRS sends an notification email to the customer if the ticket owner has changed.' =>
            'Az OTRS értesítõ levelet küld az ügyfélnek ha a jegy tulajdonosa megváltozott.',
        ...
        'Don\'t forget to add a new response a queue!' =>
            'Ne felejtsen el új reakciót hozzáadni a várólistához!',
        ...
        'It\'s useful for a lot of users and groups.' =>
            'Ez hasznos egy csomó felhasználónak és csoportnak',

        # Template: AdminRoleGroupChangeForm
        'Roles <-> Groups Management' => 'Szerepek <-> Csoportok kezelése',
        'move_into'                   => 'mozgat',
        'Permissions to move tickets into this group/queue.' =>
            'Jogosultságok jegyek áthelyezéséhez ebbe a csoportba/várólistába.',
        'create' => 'készít',
        'Permissions to create tickets in this group/queue.' =>
            'Jogosultságok új jegyek létrehozásához ebben a csoportban/várólistában.',
        'owner' => 'tulajdonos',
        'Permissions to change the ticket owner in this group/queue.' =>
            'Jogosultságok a jegy tulajdonosának megváltoztatásához ebben a csoportban/várólistában.',
        'priority' => 'prioritás',
        ...
        'All incoming emails with this "Email" (To:) will be dispatched in the selected queue!' =>
            'Az összes bejövõ e-mail ezzel az címzettel a kiválasztott várólistához lesz rendelve!',
        ...
        'Don\'t forget to add a new user to groups and/or roles!' =>
            'Ne felejtse el az új felhasználót hozzáadni csoportokhoz és/vagy szerepekhez!',
        ...
        'Discard all changes and return to the compose screen' =>
            'Minden változtatás megsemmisítése és visszatérés a szerkesztõképernyõre',
        ...
        'Select the restrictions to characterise the stat' =>
            'Válassza ki a megkötéseket a statsztika testre szabásához',
        'Fixed' => 'Rögzített',
        ...
        'If you remove the hook in the "Fixed" checkbox, the agent generating the stat can change the attributes of the corresponding element.'
            => 'Ha eltávolítja a "Rögzített" jelölõnégyzetet, akkor a statisztikát elõállítõ ügyintézõ megváltoztathatja az értékeit a megfelelõ tulajdonságnak.',
        ...
        'In this form you can select the basic specifications.' =>
            'Ezen a felületen elvégezheti az alapvetõ beállításokat.',
        'Attribute'          => 'Tulajdonság',
        'Title of the stat.' => 'A statisztika címe.',
        'Here you can insert a description of the stat.' =>
            'Itt tudja megadni a statisztika leírását.',
        'Dynamic-Object' => 'Dinamikus objektum',
        'Here you can select the dynamic object you want to use.' =>
            'Itt tudja kiválasztani azt a dinamikus objektumot, amelyet hasznáni kíván.',
        '(Note: It depends on your installation how many dynamic objects you can use)' =>
            '(Megjegyzés: A telepítéstõl függ mennyi dinamikus objektumot használhat.)',
        'Static-File' => 'Statikus fájl',
        'For very complex stats it is possible to include a hardcoded file.' =>
            'Nagyon összetett statisztikáknál lehetség elõre elkészített fájlok használata.',
        'If a new hardcoded file is available this attribute will be shown and you can select one.'
            => 'Ha rendelkezésre áll egy újabb elõre elkészített fájl akkor az itt megjelenik és választható közülük egyet.',
        'Permission settings. You can select one or more groups to make the configurated stat visible for different agents.'
            => 'Jogosultság beállítások. Kiválaszthat egy vagy több csoportot, hogy a beállított statisztikát megtekinthetõvé tegye a különbözõ ügyintézõk számára.',
        ...
        'If you need the sum of every row select yes' =>
            'Amennyiben a sorok összegzésére van szüksége, akkor válassza az igent.',
        'If you need the sum of every column select yes.' =>
            'Amennyiben az oszlopok összegzésére van szüksége, akkor válassza az igent.',
        ...
        '(Note: Useful for big databases and low performance server)' =>
            '(Megyjegyzés: Ez hasznos nagy méretû adatbázisoknál és ki teljesítményû kiszolgáló használata esetén.)',
        'With an invalid stat it isn\'t feasible to generate a stat.' =>
            'Érvénytelen statisztika esetén nem lehetséges a statiszika elõállítása.',
        ...
        'Select the elements for the value series' =>
            'Válassza ki a tulajdonságokat a grafikonon megjelenõ értékekhez',
        'Scale'   => 'Skála',
        'minimal' => '',
        'Please remember, that the scale for value series has to be larger than the scale for the X-axis (e.g. X-Axis => Month, ValueSeries => Year).'
            => '',
        'Here you can the value series. You have the possibility to select one or two elements. Then you can select the attributes of elements. Each attribute will be shown as single value series. If you don\'t select any attribute all attributes of the element will be used if you generate a stat. As well a new attribute is added since the last configuration.'
            => 'Itt kiválaszthatja a grafikonon megjelenõ értékeket. Egy vagy két tulajdonságot jelölhet ki. Után kiválaszthatja a tulajdonság értékeit. Minden érték külön kerül ábrázolásra a grafikonon. Ha nem választ ki egyetlen értéket sem a tulajdonsághoz, akkor az összes érték használva lesz a statisztika létrehozásakor. Szintén hozzáadásra kerülnek a legutóbbi beállítás óta létrejött új értékek is.',

        # Template: AgentStatsEditXaxis
        'Select the element, which will be used at the X-axis' =>
            'Válassza ki a tulajdonságot, amely az X tengelyen fog megjelenni.',
        'maximal period' => '',
        'minimal scale'  => '',
        ...
        'With the input and select fields you can configurate the stat at your needs. Which elements of a stat you can edit depends on your stats administrator who configurated the stat.'
            => 'A bemeneti és kiválasztható mezõkkel kiválaszthatja a kívánt statisztikát. Az Ön által szerkeszthetõ statisztika értékek a statisztikát beállító adminisztrátortól függnek.',
        ...
        'Set customer user and customer id of a ticket' =>
            'A jegyhez tartozó ügyfél felhasználónak és ügyfél azonosítónak beállítása',
        ...
        '(Full qualified domain name of your system)' =>
            '(Teljes ellenõrzött domain név a rendszerben)',
        ...
        '(Checks MX recordes of used email addresses by composing an answer. Don\'t use CheckMXRecord if your OTRS machine is behinde a dial-up line $!)'
            => '(Ellenõrizd le az MX rekordot a használt email címben a válasz írásakor!)',
        'To be able to use OTRS you have to enter the following line in your command line (Terminal/Shell) as root.'
            => 'Ahhoz, hogy az OTRS-t használni tudja, a következõ parancsot kell begépelnie parancssorban (terminálban/héjjban) root-ként.',
        ...
        'Customer history search (e. g. "ID342425").' =>
            'Keresés az ügyfél történetében (pl. "ID342425").',
        'for agent firstname' => 'ügyintézõ keresztnévhez',
        'Close!'              => 'Lezár!',
        'Reporter'            => '',
        'Process-Path'        => '',
        'The message being composed has been closed.  Exiting.' =>
            'Az éppen elkészült levél lezárásra került. Kilépés.',
        'to get the realname of the sender (if given)' =>
            'hogy megkapja a feladó valódi nevét (ha lehetséges)',
        'FAQ Search Result'       => '',
        ...
        'Config options (e. g. <OTRS_CONFIG_HttpType>)' =>
            'Beállítás opciók (pl. <OTRS_CONFIG_HttpType>)',
        'FAQ System History'             => '',
        ...
        'not rated'                             => '',
        'to get the first 20 character of the subject' =>
            'hogy megkapja az elsõ 20 karaktert a tárgyból',
        ...
        'This window must be called from compose window' =>
            'Ezt az ablakot a szerkesztõ ablakból kell hívni',
        'User-Number'                        => '',
        ...
        'Don\'t forget to add a new user to groups!' =>
            'Ne felejtsen el új felhasználót hozzáadni a csoportokhoz!',
        ...
        'Imported by' => '',
        'Ticket owner options (e. g. <OTRS_OWNER_UserFirstname>)' =>
            'Jegy tulajdonos opciók (pl. <OTRS_OWNER_UserFirstname>)',
        'read'                              => 'olvasott',
        'Product'                           => 'Termék',
