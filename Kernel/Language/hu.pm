...
# --
# $Id: hu.pm,v 1.102 2011/12/02 07:32:41 mg Exp $
# --
...
sub Data {
    ...
    # $$START$$
    # Last translation file sync: 2011-12-02 08:27:09
    ...
    $Self->{Translation} = {
        ...
        'Please select only one element or turn off the button \'Fixed\' where the select field is marked!' => 'Kérem válasszon egy értéket vagy kapcsolja ki a \'Rögzített\' kapcsolót a megjelölt mezőnél.',
        'If you use a checkbox you have to select some attributes of the select field!' => 'Ha egy jelölőnégyzetet használ, akkor néhány értéket is ki kell választania a tulajdonsághoz!',
        'Please insert a value in the selected input field or turn off the \'Fixed\' checkbox!' => 'Adjon meg egy értéket a bemeneti mezőben vagy kapcsolja ki a \'Rögzített\' kapcsolót!',
        'The selected end time is before the start time!' => 'A befejezési időnek a kezdeti idő után kell lennie!',
        'You have to select one or more attributes from the select field!' => 'Válasszon ki egy vagy több értéket a mezőből!',
        ...
        'If you use a time scale element you can only select one element!' => 'Amennyiben egy időskála elemet is választott, akkro csak egy elemet választhat közölük!',
        'You have an error in your time selection!' => 'Hibás a kiválasztott idő!',
        'Your reporting time interval is too small, please use a larger time scale!' => 'A kiválasztott idő intervallum túl kicsi, kérem válasszon nagyobb skálát.',
        ...
        'The selected time period is larger than the allowed time period!' => 'A kiválasztott ismétlődés a megengedett ismétlődésnél nagyobb!',
        ...
        'Your email with ticket number "<OTRS_TICKET>" is merged to "<OTRS_MERGE_TO_TICKET>".' => 'Az Ön "<OTRS_TICKET>" jegy számmal rendelkező e-mailje egyesítésre került a "<OTRS_MERGE_TO_TICKET>" jeggyel.',
        ...
        'Job Settings' => '',
        'Job name' => '',
        'Currently this generic agent job will not run automatically.' => 'Jelenleg ez az általános ügyintéző munka nem fut le automatikusan.',
        ...
        # Template: AdminGroup
        'WARNING: When you change the name of the group \'admin\', before making the appropriate changes in the SysConfig, you will be locked out of the administrations panel! If this happens, please rename the group back to admin per SQL statement.' => 'Figyelem: Ha az admin csoport nevét megváltoztatja a megfelelő SysConfig beállítások előtt, úgy ki lesz zárva az adminisztrációs felületről. Ha ez megtörtént, akkor nevezze vissza a csoportot admin névre egy megfelelő SQL parancs kiadásával.',
        ...
        'Add mail account' => '',
        'All incoming emails with one account will be dispatched in the selected queue!' => 'Az összes fiókkal rendelkező bejövő e-mail egy kiválasztott várólistához lesz rendelve!',
        'If your account is trusted, the already existing X-OTRS header at arrival time (for priority, ...) will be used! PostMaster filter will be used anyway.' => 'Ha az Ön fiókja megbízható, a már létező X-OTRS fejlécet használjuk beérkezéskor (prioritáshoz, ...)! Egyéb esetben a levelezési szűrők lesznek alkalmazva.',
        'Host' => 'Kiszolgáló',
        'Delete account' => '',
        'Fetch mail' => '',
        'Add Mail Account' => '',
        ...
        'To get the first 20 character of the subject (of the latest agent article).' => '(Legutolsó ügyintéző cikk) tárgyának első 20 karaktere.',
        'To get the first 5 lines of the body (of the latest agent article).' => '(Legutolsó ügyintéző cikk) törzsének első 5 sora.',
        'To get the first 20 character of the subject (of the latest customer article).' => '(Legutolsó ügyfél cikk) tárgyának első 20 karaktere.',
        'To get the first 5 lines of the body (of the latest customer article).' => '(Legutolsó ügyfél cikk) törzsének első 5 sora.',
        ...
        'Activating this feature might affect your system performance!' => 'Ha bekapcsolja ezt a funkciót a rendszer teljesítményét jelentősen befolyásolhatja!',
        ...
        'If you want to match only the email address, use EMAILADDRESS:info@example.com in From, To or Cc.' => 'Amennyiben Ön csak az e-mail cím egyezését kívánja vizsgálni, akkor használja a EMAILADDRESS:info@example.com formulát a Feladó (From), Címzett (To) vagy Másolat (Cc) mezőkben.',
        ...
        'Secure mode will (normally) be set after the initial installation is completed.' => 'Biztonságos üzemmód a telepítést követően fog teljesen működni.',
        'Secure mode must be disabled in order to reinstall using the web-installer.' => 'Biztonságos üzemmódot le kell tíltani ahhoz, hogy a webes telepítővel újra lehessen dolgozni.',
        ...
        'If you remove the hook in the "Fixed" checkbox, the agent generating the stat can change the attributes of the corresponding element.' => 'Ha eltávolítja a "Rögzített" jelölőnégyzetet, akkor a statisztikát előállítő ügyintéző megváltoztathatja az értékeit a megfelelő tulajdonságnak.',
        'Fixed' => 'Rögzített',
        ...
        'To be able to use OTRS you have to enter the following line in your command line (Terminal/Shell) as root.' => 'Ahhoz, hogy az OTRS-t használni tudja, a következő parancsot kell begépelnie parancssorban (terminálban/héjjban) root-ként.',
        ...
        '(Checks MX recordes of used email addresses by composing an answer. Don\'t use CheckMXRecord if your OTRS machine is behinde a dial-up line $!)' => '(Ellenőrizd le az MX rekordot a használt email címben a válasz írásakor!)',
        ...
        '(Note: It depends on your installation how many dynamic objects you can use)' => '(Megjegyzés: A telepítéstől függ mennyi dinamikus objektumot használhat.)',
        ...
        'All incoming emails with this "Email" (To:) will be dispatched in the selected queue!' => 'Az összes bejövő e-mail ezzel az címzettel a kiválasztott várólistához lesz rendelve!',
        ...
        'Can\'t update password, must contain 2 lower and 2 upper characters!' => 'Nem sikerült modosítani a jelszót, legalább 2 kisbetűnek és 2 nagybetűnek kell benne szerepelnie!',
        ...
        'Create new groups to handle access permissions for different groups of agent (e. g. purchasing department, support department, sales department, ...).' => 'Hozzon létre új csoportot a különböző ügyintéző csoportok (pl. beszerző osztály, támogató osztály, eladó osztály, ...) hozzáférési jogainak kezeléséhez.',
        ...
        'Customer user will be needed to have a customer history and to login via customer panel.' => 'Ügyfél felhasználó létrehozása szükséges, hogy legyenek ügyfélhez tartozó előzmények és be lehessen lépni az ügyfél oldalon.',
        ...
        'Do dispatch or filter incoming emails based on email X-Headers! RegExp is also possible.' => 'A beérkező e-mailek az X-Fejlécek alapján legyen hozzárendelve! Szabályos kifejezések alkalmazhatók.',
        ...
        'For very complex stats it is possible to include a hardcoded file.' => 'Nagyon összetett statisztikáknál lehetség előre elkészített fájlok használata.',
        ...
        'Here you can define the value series. You have the possibility to select one or two elements. Then you can select the attributes of elements. Each attribute will be shown as single value series. If you don\'t select any attribute all attributes of the element will be used if you generate a stat. As well a new attribute is added since the last configuration.' => 'Itt kiválaszthatja a grafikonon megjelenő értékeket. Egy vagy két tulajdonságot jelölhet ki. Után kiválaszthatja a tulajdonság értékeit. Minden érték külön kerül ábrázolásra a grafikonon. Ha nem választ ki egyetlen értéket sem a tulajdonsághoz, akkor az összes érték használva lesz a statisztika létrehozásakor. Szintén hozzáadásra kerülnek a legutóbbi beállítás óta létrejött új értékek is.',
        'Here you can define the x-axis. You can select one element via the radio button. If you make no selection all attributes of the element will be used if you generate a stat. As well a new attribute is added since the last configuration.' => 'Itt definiálhatja az x-tengelyt. A választógomb segítségével tud választani. Ha nem választ semmit, akkor minden jellemző felhaszhálásra kerül a statisztika elkészítésénél. Ugyanúgy, ahogy egy új jellemző már hozzáadásra került a legutolsó konfiguráció óta.',
        ...
        'If a new hardcoded file is available this attribute will be shown and you can select one.' => 'Ha rendelkezésre áll egy újabb előre elkészített fájl akkor az itt megjelenik és választható közülük egyet.',
        ...
        'If a ticket will not be answered in this time, just only this ticket will be shown.' => 'Ha a jegy nem kerül megválaszolásra a megadott időn belül, csak ez a jegy lesz megjelenítve.',
        'If an agent locks a ticket and he/she will not send an answer within this time, the ticket will be unlock automatically. So the ticket is viewable for all other agents.' => 'Ha az ügyintéző zárolja a jegyet és nem küld választ ezen időn belül, a jegy zárolása megszűnik. Így a jegy látható lesz minden ügyintézőnek.',
        'If nothing is selected, then there are no permissions in this group (tickets will not be available for the user).' => 'Ha nincs semmi kiválasztva, akkor nincsenek jogosultságok ebben a csoportban (a jegyek nem lesznek elérhetők a felhasználónak).',
        ...
        'If you use RegExp, you also can use the matched value in () as [***] in \'Set\'.' => 'Ha szabályos kifejzéseket használ, használhatja a ()-ben levő egyező értéket mint [***] a \'Beállítás\'-nál.',
        'Image' => 'Kép',
        'Important' => 'Fontos',
        'Imported' => 'Importálva',
        ...
        'OTRS sends an notification email to the customer if the ticket is moved.' => 'Az OTRS értesítő levelet küld az ügyfélnek ha a jegy áthelyezésre került.',
        'OTRS sends an notification email to the customer if the ticket owner has changed.' => 'Az OTRS értesítő levelet küld az ügyfélnek ha a jegy tulajdonosa megváltozott.',
        'OTRS sends an notification email to the customer if the ticket state has changed.' => 'Az OTRS értesítő levelet küld az ügyfélnek ha a jegy állapota megváltozott.',
        ...
        'Options of the current user who requested this action (e. g. &lt;OTRS_CURRENT_USERFIRSTNAME&gt;)' => 'Opciók a jelenlegi felhasználó számára, aki kérte ezt a műveletet (e. g. &lt;OTRS_CURRENT_USERFIRSTNAME&gt;)',
        ...
        'Options of the current user who requested this action (e. g. <OTRS_CURRENT_UserFirstname>).' => 'A műveletet végző felhasználónak adatai (pl. <OTRS_CURRENT_UserFirstname>).',
        ...
        'Package' => 'Csomag',
        'Package not correctly deployed! You should reinstall the Package again!' => 'A csomag nincsen megfelelően telepítve! Telepítse újra a csomagot!',
        'Param 1' => '1. paraméter',
        'Param 2' => '2. paraméter',
        'Param 3' => '3. paraméter',
        'Param 4' => '4. paraméter',
        ...
        'Permission settings. You can select one or more groups to make the configurated stat visible for different agents.' => 'Jogosultság beállítások. Kiválaszthat egy vagy több csoportot, hogy a beállított statisztikát megtekinthetővé tegye a különböző ügyintézők számára.',
        ...
        'Send me a notification of an watched ticket like an owner of an ticket.' => 'Küldjön értesítést a figyelt jegyről úgy minta a jegy tulajdonosa lenne.',
        ...
        'Ticket responsible options (e. g. <OTRS_RESPONSIBLE_UserFirstname>).' => 'A jegy felelősének adatai (pl. <OTRS_RESPONSIBLE_UserFirstname>).',
        ...
        'To get the article attribute (e. g. (<OTRS_AGENT_From>, <OTRS_AGENT_To>, <OTRS_AGENT_Cc>, <OTRS_AGENT_Subject> and <OTRS_AGENT_Body>).' => 'Cikk jellemzői pl. (<OTRS_AGENT_From>, <OTRS_AGENT_To>, <OTRS_AGENT_Cc>, <OTRS_AGENT_Subject> and <OTRS_AGENT_Body>).',
        ...
        'With the input and select fields you can configurate the stat at your needs. Which elements of a stat you can edit depends on your stats administrator who configurated the stat.' => 'A bemeneti és kiválasztható mezőkkel kiválaszthatja a kívánt statisztikát. Az Ön által szerkeszthető statisztika értékek a statisztikát beállító adminisztrátortól függnek.',
        'Workflow Groups' => 'Workflow csoportok',
        'Yes means, send no agent and customer notifications on changes.' => 'Igen esetén nem küld értesítésekes sem az ügyintézőnek, sem az ügyfélnek a változásokról.',
        'Yes, save it with name' => 'Igen, elmentve ezen a néven',
        'You got new message!' => 'Új üzenete érkezett!',
        'You have to select two or more attributes from the select field!' => 'Legalább két értéket válasszon ki a mezőben!',
