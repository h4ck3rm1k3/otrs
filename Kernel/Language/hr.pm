...
# --
# $Id: hr.pm,v 1.11 2011/12/02 07:30:49 mg Exp $
# --
...
sub Data {
    ...
    # $$START$$
    # Last translation file sync: 2011-12-02 08:27:08
    ...
    $Self->{Translation} = {
        ...
        'Login failed! Your user name or password was entered incorrectly.' => 'Neuspješna prijava! Korisničko ime i/ili lozinka nisu valjani.',
        ...
        'Security Note: You should activate %s because application is already running!' => 'Sigurnosna napomena: Trebalo bi omogućiti %s, jer je aplikacija već pokrenuta!',
        'Unable to parse repository index document.' => 'Nije moguće raščlaniti indeks spremišta!',
        'No packages for your framework version found in this repository, it only contains packages for other framework versions.' => 'Nema paketa za verziju vašeg sustava, u spremištu su samo paketi za druge verzije.',
        ...
        'New account created. Sent login information to %s. Please check your email.' => 'Kreiran novi račun. Podaci za prijavu poslani %s. Molimo provjerite vašu E-poštu.',
        ...
        'Can\'t update password, your new passwords do not match. Please try again!' => 'Lozinka ne može biti ažurirana, novi unosi su različiti. Molimo pokušajte ponovno!',
        ...
        'Can\'t update password, it must contain at least 2 lowercase  and 2 uppercase characters!' => 'Lozinka ne može biti ažurirana. Mora sadržavati bar 2 velika i 2 mala slova.',
        'Can\'t update password, it must contain at least 1 digit!' => 'Lozinka ne može biti ažurirana. Mora sadržavati bar jednu znamenku.',
        'Can\'t update password, it must contain at least 2 characters!' => 'Lozinka ne može biti ažurirana. Mora sadržavati najmanje 2 znaka.',
        'Can\'t update password, this password has already been used. Please choose a new one!' => 'Lozinka ne može biti ažurirana. Unijeta lozinka je već u uporabi. Molimo izaberite neku drugu.',
        ...
        'Please insert a value in the selected input field or turn off the \'Fixed\' checkbox!' => 'Molimo Vas, unesite vrijednost u izabrano polje ili isključite oznaku "fiksirano"!',
        'The selected end time is before the start time!' => 'Izabrano vrijeme kraja je prije vremena početka!',
        'You have to select one or more attributes from the select field!' => 'Morate da izaberati jedan ili više atributa iz odabranog polja!',
        ...
        'Your reporting time interval is too small, please use a larger time scale!' => 'Vaš interval izvještaja je prekratak, molimo zadajte veći vremenski razmak!',
        ...
        'Your email with ticket number "<OTRS_TICKET>" is merged to "<OTRS_MERGE_TO_TICKET>".' => 'Vaša poruka E-pošte sa brojem kartice "<OTRS_TICKET>" je objedinjena sa karticom "<OTRS_MERGE_TO_TICKET>"!',
        ...
        'Send me a notification if there is a new ticket in "My Queues".' => 'Pošalji mi obavijest za novu karticu u "Mojim repovima".',
        ...
        'Send me a notification if a ticket is unlocked by the system.' => 'Pošalji mi obavijest ako sustav otključa karticu.)',
        ...
        'Send me the same notifications for my watched tickets that the ticket owners will get.' => 'Pošlji mi istu obavijest za moje promatrane kartice koju će dobiti i vlasnik.',
        ...
        'All open tickets, these tickets have already been worked on, but need a response' => 'Sve otvorene kartice, na kojima je već rađeno, ali zahtijevaju odgovor',
        ...
        'Select' => 'Izaberi',
        'Hint' => 'Savjet',
        'Customer will be needed to have a customer history and to login via customer panel.' => 'Potreban je korisnik da bi imali pristup dnevniku prijava na korisnički panel.',
        ...
        'This field is required and needs to be a valid email address.' => 'Ovo je obavezno polje i adresa E-pošte mora biti ispravna.',
        'This email address is not allowed due to the system configuration.' => 'Postavke sustava ne dopuštaju ovu adresu E-pošte.',
        ...
        'Just use this feature if you want to define group permissions for customers.' => 'Ovu funkciju koristite ako želite definirati grupne dozvole za korisnike.',
        ...
        'You can manage these groups via the configuration setting "CustomerGroupAlwaysGroups".' => 'Možete upravljati ovim grupama preko konfiguracijskih postavki "..."',
        'Filter for Groups' => 'Filtar za grupe',
        'Select the customer:group permissions.' => 'Izaberi dozvole za korisnik:grupa',
        'If nothing is selected, then there are no permissions in this group (tickets will not be available for the customer).' => 'Ako ništa nije izabrano, onda nema dozvola u ovoj grupi (kartice neće biti dostupne korisniku).',
        ...
        'rw' => '"rw"',
        'Full read and write access to the tickets in this group/queue.' => 'Pristup bez ograničenja za kartice u ovim grupama/repovima.',
        ...
        'To enable automatic execution select at least one value from minutes, hours and days!' => 'Da bi ste omogućili automatsko izvršavanje izaberite bar jednu vrijednost od minuta, sati i dana!',
        ...
        'CMD' => 'CMD',
        'This command will be executed. ARG[0] will be the ticket number. ARG[1] the ticket id.' => 'Ova naredba će biti izvršena. ARG[0] je broj kartice, a ARG[1] ID kartice.',
        'Delete tickets' => 'Obriši kartice',
        'Warning: All affected tickets will be removed from the database and cannot be restored!' => 'UPOZORENJE: Sve obuhvaćene kartice će biti nepovratno uklonjene iz baze!',
        ...
        'Warning: You used the DELETE option. All deleted tickets will be lost!' => 'UPOZORENJE: Upotrijebili ste opciju za brisanje. Svi obrisane kartice će biti izgubljene!',
        ...
        # Template: AdminGroup
        'WARNING: When you change the name of the group \'admin\', before making the appropriate changes in the SysConfig, you will be locked out of the administrations panel! If this happens, please rename the group back to admin per SQL statement.' => 'UPOZORENJE: Ako promijenite ime grupe \'admin\' prije adekvatnog podešavanja u sistemskoj konfiguraciji, izgubit ćete pristup administrativnom prostoru! Ukoliko se to dogodi, vratite ime grupi u "admin" pomoću SQL naredbe.',
        'Group Management' => 'Upravljanje grupama',
        'Add group' => 'Dodaj grupu',
        'The admin group is to get in the admin area and the stats group to get stats area.' => '"admin" grupa služi za pristup administrativnom prostoru a "stats" grupa prostoru statistike.',
        'Create new groups to handle access permissions for different groups of agent (e. g. purchasing department, support department, sales department, ...). ' => 'Kreirajte nove grupe da bi ste lakše upravljali dozvolama za različite zaposlenike (npr. prema odjelima)',
        ...
        'All incoming emails with one account will be dispatched in the selected queue!' => 'Sve dolazne poruke sa jednog naloga će biti usmerene u izabrani rep!',
        ...
        'To get the first 20 character of the subject (of the latest agent article).' => 'Vidjeti prvih 20 slova predmeta (posljednjeg članka zaposlenika).',
        'To get the first 5 lines of the body (of the latest agent article).' => '',
        'To get the first 20 character of the subject (of the latest customer article).' => 'Vidjeti prvih 20 slova predmeta (posljednjeg članka zaposlenika)',
        'To get the first 5 lines of the body (of the latest customer article).' => 'Vidjeti prvih 5 redaka poruke (posljednjeg članka zaposlenika).',
        ...
        'In this way you can directly edit the keyring configured in SysConfig.' => 'Na ovaj način možete direktno uređivati komplet ključeva podešen u sistemskim opcijama.',
        ...
        'Do you really want to reinstall this package? Any manual changes will be lost.' => 'Da li uistinu želite ponovno instalirati ovaj paket? Sve eventualne ručne promjene bit će izgubljene.',
        'Continue' => 'Nastavi',
        'Install' => 'Instaliraj',
        ...
        'Activating this feature might affect your system performance!' => 'Aktiviranje ove mogućnosti može narušiti performanse sustava!',
        ...
        'To dispatch or filter incoming emails based on email headers. Matching using Regular Expressions is also possible.' => 'Radi otpreme ili filtriranja dolaznih poruka na osnovu zaglavlja. Uporaba regularnih izraza je također moguća.',
        'If you want to match only the email address, use EMAILADDRESS:info@example.com in From, To or Cc.' => 'Ukoliko želite poklapanje samo sa adresama E-pošte, koristite EMAILADDRESS:info@example.com u "Od", "Za" ili "Cc".',
        'If you use Regular Expressions, you also can use the matched value in () as [***] in the \'Set\' action.' => 'Ukoliko koristite regularne izraze, možete također koristiti niz zahvaćen s () kao [***] u \'Set\' akciji.',
        ...
        'A response is default text to write faster answer (with default text) to customers.' => 'Odgovor je zadani tekst za brže pisanje (predložak teksta) odgovora korisnicima.',
        ...
        'If nothing is selected, then there are no permissions in this group (tickets will not be available for the role).' => 'Ukoliko ništa nije izabrano, onda nema dozvola u ovoj grupi (kartice neće biti dostupne za ovu ulogu).',
        ...
        'In this way you can directly edit the certification and private keys in file system.' => 'Na ovaj način možete izravno urediti vjerodajnice i privatne ključeve u sustavu datoteka.',
        'Hash' => 'Hash',
        'Create' => 'Otvori',
        ...
        'Secure mode must be disabled in order to reinstall using the web-installer.' => '"Siguran način" mora biti isključen radi reinstalacije putem weba.',
        ...
        'The syntax of your SQL query has a mistake. Please check it.' => 'Postoji pogreška u sintaksi vašeg SQL upita. Molimo provjerite.',
        ...
        'This config item is only available in a higher config level!' => 'Ova konfiguracijska stavka je dostupna samo na višoj razini konfiguriranja!',
        ...
        'All incoming email with this address in To or Cc will be dispatched to the selected queue.' => 'Sve dolazne poruke sa ovom adresom u polju "Za" ili "Cc" bit će otpremljene u odabrani rep.',
        ...
        'The display name and email address will be shown on mail you send.' => 'Ime i adresa E-pošte bit će prikazani na poruci koju ste poslali.',
        ...
        'If you remove the hook in the "Fixed" checkbox, the agent generating the stat can change the attributes of the corresponding element.' => 'Ako uklonite oznaku sa elementa "Fiksirano", zaposlenik koji radi statistiku će moći izmijeniti atribute tog elementa.',
        'Fixed' => 'Fiksirano',
        'Please select only one element or turn off the button \'Fixed\'.' => 'Molimo izaberite samo jedan element ili isključite tipku "fiksirano"!',
        ...
        'Permissions' => 'Dozvole',
        'You can select one or more groups to define access for different agents.' => 'Radi određivanja prava pristupa za zaposlenika, možete izabrati jednu ili više grupa.',
        'Some result formats are disabled because at least one needed package is not installed.' => '',
        'Please contact your administrator.' => 'Molimo, kontaktirajte vašeg administratora.',
        'Graph size' => 'Veličina grafa',
        'If you use a graph as output format you have to select at least one graph size.' => 'Ako koristite graf kao izlazni format morate odabrati najmanje jednu veličinu grafa.',
        ...
        'Scale' => 'Skaliranje',
        'minimal' => 'minimum',
        'Please remember, that the scale for value series has to be larger than the scale for the X-axis (e.g. X-Axis => Month, ValueSeries => Year).' => 'Molimo zapamtite, da skala za opsege vrednosti moda da bude veća od skale za X-os (npr X-os => mjesec; Vrijednost opsega => godina).',
        ...
        'With the input and select fields you can influence the format and contents of the statistic.' => 'Preko polja za unos i izbor možete utjecati na oblik i sadržaj statistike.',
        'Exactly what fields and formats you can influence is defined by the statistic administrator.' => 'Na koja polja i formate možete utjecati definirano je od strane administratora statistike.',
        ...
        'Need a valid email address or don\'t use a local email address.' => 'Ispravna adresa E-pošte je neophodna, ali ne koristite lokalnu adresu!',
        ...
        'To protect your privacy, active or/and remote content has blocked.' => 'Zbog zaštite vaše privatnosti, aktivni ili/i udaljeni sadržaj je blokiran.',
        ...
        # Template: FooterJS
        'If you now leave this page, all open popup windows will be closed, too!' => 'Ako napustite ovu stranicu, svi otvoreni prozori bit će zatvoreni!',
        'A popup of this screen is already open. Do you want to close it and load this one instead?' => 'Prikaz ovog ekrana je već otvoren. Želite li zatvoriti i učitati ovaj umjesto njega?',
        ...
        'In order to experience OTRS, you\'ll need to enable JavaScript in your browser.' => 'Kako bi ste koristili OTRS potrebno je aktivirati JavaScript u vašem web pregledniku.',
        ...
        'If you have set a root password for your database, it must be entered here. If not, leave this field empty. For security reasons we do recommend setting a root password. For more information please refer to your database documentation.' => 'Ako ste podesili "root" lozinku za vašu bazu podataka, ona mora biti unesena ovdje. Ako nema lozinke, ostavite polje prazno. Iz sigurnosnih razloga preporučujemo da je podesite. Za više informacija proučite dokumentaciju o bazi podataka.',
        'Currently only MySQL is supported in the web installer.' => 'Trenutno je samo MySQL podržan u Web Instalaciji.',
        'If you want to install OTRS on another database type, please refer to the file README.database.' => 'Ako želite instalirati OTRS na neki drugi sustav baze podataka, proučite informacije u datoteci README.database.',
        'Database-User' => 'Korisnik baze podataka',
        'New' => 'Nov',
        'A new database user with limited rights will be created for this OTRS system.' => 'Novi korisnik baze sa ograničenim pravima bit će  kreiran za ovaj OTRS sustav',
        ...
        'To be able to use OTRS you have to enter the following line in your command line (Terminal/Shell) as root.' => 'Da biste mogli koristiti OTRS morate unijeti slijedeću liniju u Vašu komandnu liniju (Terminal/Shell) kao "root".',
        ...
        'The identifier of the system. Each ticket number and each HTTP session ID contain this number.' => 'Sustavski identifikator. Svaki broj kartice i svaki ID HTTP sesije sadrži ovaj broj.',
        ...
        'Email addresses that are manually entered are checked against the MX records found in DNS. Don\'t use this option if your DNS is slow or does not resolve public addresses.' => 'Ručno unesena e-mail adresa se provjerava pomoću MX podatka pronađenog u DNS-u. Nemojte koristiti ovu opciju ako je vaš DNS spor ili ne može razriješiti javne adrese.',
        ...
        # SysConfig
        'ACL module that allows closing parent tickets only if all its children are already closed ("State" shows which states are not available for the parent ticket until all child tickets are closed).' => '"ACL" modul koji dozvoljava da nadređene kartice budu zatvorene samo ako su već zatvorene sve podređene kartice ("Status" pokazuje koji statusi nisu dostupni za karticu roditelj dok se ne zatvore sve kartice djeca).',
        'Activates a blinking mechanism of the queue that contains the oldest ticket.' => 'Aktivira mehanizam treptanja retka koji sadrži najstariju karticu.',
        'Activates lost password feature for agents, in the agent interface.' => 'Aktivira opciju izgubljene lozinke za zaposlene, na sučelju za njih.',
        ...
        'Activates the article filter in the zoom view to specify which articles should be shown.' => 'Aktivira filter za članke u proširenom pregledu radi definiranja koji članci trebaju biti prikazani.',
        'Activates the available themes on the system. Value 1 means active, 0 means inactive.' => 'Aktivira raspoložive teme - šablone u sustavu. Vrijednost 1 znači aktivno, 0 znači neaktivno.',
        'Activates the ticket archive system search in the customer interface.' => '',
        'Activates the ticket archive system to have a faster system by moving some tickets out of the daily scope. To search for these tickets, the archive flag has to be enabled in the ticket search.' => 'Aktivira arhivski sustav radi ubrzanja rada, uklanjanjem nekih kartica iz dnevnog praćenja. Za pronalazak kartica, označena arhiva mora biti omogućena za pretragu kartica.',
        'Activates time accounting.' => 'Aktivira mjerenje vremena.',
        'Add a note to this ticket' => '',
        'Adds a suffix with the actual year and month to the OTRS log file. A logfile for every month will be created.' => '',
        'Adds customers email addresses to recipients in the ticket compose screen of the agent interface.' => 'Dodaje korisničke e-mail adrese primaocima u prozoru za otvaranje kartice na sučelju zaposlenog.',
        ...
        'Agent interface article notification module to check S/MIME.' => 'Modul sučelja zaposlenih za obavještavanja o članku, provjera S/MIME',
        'Agent interface module to access fulltext search via nav bar.' => 'Modul sučelja zaposlenih za pristup tekstualnom pretraživanju preko navigacijske trake.',
        'Agent interface module to access search profiles via nav bar.' => 'Modul sučelja zaposlenih za pristup profilima pretraživanja preko navigacijske trake.',
        'Agent interface module to check incoming emails in the Ticket-Zoom-View if the S/MIME-key is available and true.' => 'Modul sučelja zaposlenih za provjeru dolaznih poruka u uvećanom pregledu kartice ako "S/MIME"-ključ postoji i dostupan je.',
        'Agent interface notification module to check the used charset.' => 'Modul sučelja zaposlenih za provjeru upotrijebljenog skupa znakova.',
        'Agent interface notification module to see the number of tickets an agent is responsible for.' => 'Modul sučelja zaposlenih za obvještavanje, pregled broja kartice za koje je agent odgovoran.',
        'Agent interface notification module to see the number of watched tickets.' => 'Modul sučelja zaposlenih za obvještavanje, pregled broja praćenih kartica.',
        'Agents <-> Groups' => 'Zaposlenici <-> Grupe',
        'Agents <-> Roles' => 'Zaposlenici <-> Uloge',
        'Allows adding notes in the close ticket screen of the agent interface.' => 'Dozvoljava dodavanje napomena u zatvoreni prozor kartice sučelja zaposlenog.',
        'Allows adding notes in the ticket free text screen of the agent interface.' => 'Dozvoljava dodavanje napomena u prozor slobodnog teksta sučelja zaposlenog.',
        'Allows adding notes in the ticket note screen of the agent interface.' => 'Dozvoljava dodavanje napomena u prozor napomene sučelja zaposlenog.',
        'Allows adding notes in the ticket owner screen of a zoomed ticket in the agent interface.' => 'Dozvoljava dodavanje napomena u prozor vlasnika kartice na uvećanom prikazu u sučelju zaposlenog.',
        'Allows adding notes in the ticket pending screen of a zoomed ticket in the agent interface.' => 'Dozvoljava dodavanje napomena u prozor na čekanju uvećanog prikaza u sučelju zaposlenog.',
        'Allows adding notes in the ticket priority screen of a zoomed ticket in the agent interface.' => 'Dozvoljava dodavanje napomena u prozor prioriteta na uvećanom prikazu u sučelju zaposlenog.',
        'Allows adding notes in the ticket responsible screen of the agent interface.' => 'Dozvoljava dodavanje napomena u prozor odgovornog za karticu sučelja zaposlenog.',
        ...
        'Allows choosing between showing the attachments of a ticket in the browser (inline) or just make them downloadable (attachment).' => 'Dozvoljava izbor između prikaza priloga u pregledniku ili samo omogućava njihovo preuzimanje.',
        'Allows choosing the next compose state for customer tickets in the customer interface.' => 'Dozvoljava izbor slijedećeg stanja za korisničku karticu u korisničkom sučelju.',
        'Allows customers to change the ticket priority in the customer interface.' => 'Dozvoljava korisnicima da promjene prioritet kartice u korisničkom sučelju.',
        'Allows customers to set the ticket SLA in the customer interface.' => 'Dozvoljava korisnicima da postave SLA za karticu u korisničkom sučelju.',
        'Allows customers to set the ticket priority in the customer interface.' => 'Dozvoljava korisnicima da postave prioritet kartice u korisničkom sučelju.',
        'Allows customers to set the ticket queue in the customer interface. If this is set to \'No\', QueueDefault should be configured.' => 'Dozvoljava korisnicima da postave red kartice u korisničkom sučelju. Ako je postavljeno na "Ne", onda treba postaviti "QueueDefault".',
        'Allows customers to set the ticket service in the customer interface.' => 'Dozvoljava korisnicima da postave servis za karticu u korisničkom sučelju.',
        ...
        'Automatically lock and set owner to current Agent after selecting for an Bulk Action.' => 'Automatsko zaključavanje i postavljanje vlasnika na aktualnog zaposlenog nakon izbora masovne akcije.',
        ...
        'Builds an article index right after the article\'s creation.' => 'Generira indeks članaka odmah po kreiranju članka.',
        ...
        'Controls if customers have the ability to sort their tickets.' => 'Kontrolira da li korisnici imaju mogućnost sortiranja svojih kartica.',
        ...
        'Customer item (icon) which shows the open tickets of this customer as info block.' => 'Korisnička stavka (ikona) koja pokazuje otvorene kartice ovog korisnika kao info blok.',
        ...
        'Default ticket ID used by the system in the agent interface.' => 'Zadani ID kartice koji koristi sustav u sučelju zaposlenih.',
        'Default ticket ID used by the system in the customer interface.' => 'Zadani ID kartice koji koristi sustav u korisničkom sučelju.',
        ...
        'Defines a default list of words, that are ignored by the spell checker.' => 'Definira zadani popis riječi, koje su zanemarene provjerom pravopisa.',
        ...
        'Defines the default priority of new customer tickets in the customer interface.' => 'Određuje zadani prioritet za nove korisničke karticue u korisničkom interfejsu.',
        'Defines the default priority of new tickets.' => 'Određuje zadani prioritet za nove karticue.',
        'Defines the default queue for new customer tickets in the customer interface.' => 'Određuje zadani red za nove korisničke karticue u korisničkom interfejsu.',
        ...
        'Required permissions to use the ticket forward screen in the agent interface.' => 'Potrebne dozvole za upotrebu prozora za prosleđivanje kartice u interfejsu zaposlenog.',
        ...
        'Required permissions to use the ticket merge screen of a zoomed ticket in the agent interface.' => 'Potrebne dozvole za upotrebu prozora za spajanje pri uvećanom prikazu kartice u interfejsu zaposlenog.',
        ...
        'Required permissions to use the ticket owner screen of a zoomed ticket in the agent interface.' => 'Potrebne dozvole za upotrebu prozora vlasnika tuketa pri uvećanom prikazu kartice u interfejsu zaposlenog.',
        'Required permissions to use the ticket pending screen of a zoomed ticket in the agent interface.' => 'Potrebne dozvole za upotrebu prozora čekanja pri uvećanom prikazu kartice u interfejsu zaposlenog.',
        ...
        'Required permissions to use the ticket priority screen of a zoomed ticket in the agent interface.' => 'Potrebne dozvole za upotrebu prozora prioriteta pri uvećanom prikazu kartice u interfejsu zaposlenog.',
        ...
        'Resets and unlocks the owner of a ticket if it was moved to another queue.' => 'Resetuje i otključava vlasnika kartice ako je premešten u drugi red.',
        'Responses <-> Queues' => 'Odgovori <-> Repovi',
        'Restores a ticket from the archive (only if the event is a state change, from closed to any open available state).' => 'Restaurira karticu iz arhive (samo ako je događaj promena statusa od zatvorenog na bilo koji dostupan otvoreni status).',
        ...
        'Types' => 'Tipovi',
        'Update Ticket "Seen" flag if every article got seen or a new Article got created.' => 'Ažuriraj o?naku viđenih kartice ako su svi pregledani ili je kreiran novi članak.',
        'Update and extend your system with software packages.' => 'Ažuriraj i nadogradi sistem softverskim paketima.',
        'Updates the ticket escalation index after a ticket attribute got updated.' => 'Ažuriraj indeks eskalacije kartice posle ažuriranja atributa kartice.',
        ...
        'When tickets are merged, a note will be added automatically to the ticket which is no longer active. In this text area you can define this text (This text cannot be changed by the agent).' => 'Kada su kartice spojeni, kartici koji nije aktivan će automatski biti dodana beleška. U prostoru za tekst možete da definišete ovaj tekst (Zaposlenici ne mogu mijenjati ovaj tekst).',
        'When tickets are merged, the customer can be informed per email by setting the check box "Inform Sender". In this text area, you can define a pre-formatted text which can later be modified by the agents.' => 'Kada su kartice spojeni, korisnik može biti informiran E-poštom postavljanjem polje za potvrdu "Obavijesti pošiljaoca". U prostoru za tekst, možete definirati unaprijed formatirani tekst koji kasnije biti modificiran od strane zaposlenika.',
        ...
        '(Checks MX recordes of used email addresses by composing an answer. Don\'t use CheckMXRecord if your OTRS machine is behinde a dial-up line $!)' => '(Proverite "MX" zapise upotrebljenih adresa E-pošte kreiranjem odgovora. Nemojte koristiti ovu funkciju ako je vaš OTRS server na "dial-up" liniji!)',
        ...
        'Adds a suffix with the actual year and month to the otrs log file. A logfile for every month will be created.' => 'Dodaje sufiks s aktualnom godinom i mjesecom u OTRS datoteku dnevnika. Bit će kreiran dnevnik za svaki mjesec.',
        ...
        'All Customer variables like defined in config option CustomerUser.' => 'Sve korisničke varijable kao što su definirane u konfiguracijskim opcijama za korisnika.',
        'All customer tickets.' => 'Svi kartice za korisnika.',
        'All email addresses get excluded on replaying on composing an email.' => 'Sve adrese E-pošte će biti isključene pri kreiranju odgovora.',
        'All incoming emails with this "Email" (To:) will be dispatched in the selected queue!' => 'Sve poruke E-pošte s ovim primateljem (Za:) bit će otpremljene u izabrani rep!',
        ...
        'Allows defining services and SLAs for tickets (e. g. email, desktop, network, ...), and escalation attribrutes for SLAs (if ticket service/SLA feature is enabled).' => 'Dozvoljava definiranje servisa i SLA za kartice (npr E-pošta, radna površina, mreža, ...), i eskalacijske atribute za SLA (ako je aktivirana usluga/SLA za karticu).',
        'Answer' => 'Odgovor',
        ...
        'Article free text options shown in the close ticket screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' => 'Opcije slobodnog teksta članka prikazane na zatvorenom ekranu kartice na sučelju zaposlenog. Moguće postavke: 0 = isključeno, 1 = uključeno, 2 = uključeno i obavezno.',
        'Article free text options shown in the email ticket screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' => 'Opcije slobodnog teksta članka prikazane na e-mail ekranu kartice na sučelju zaposlenog. Moguće postavke: 0 = isključeno, 1 = uključeno, 2 = uključeno i obavezno.',
        'Article free text options shown in the phone ticket screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' => 'Opcije slobodnog teksta članka prikazane na ekranu telefonske kartice na sučelju zaposlenog. Moguće postavke: 0 = isključeno, 1 = uključeno, 2 = uključeno i obavezno.',
        'Article free text options shown in the ticket compose screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' => 'Opcije slobodnog teksta članka prikazane na ekranu za pisanje kartice na sučelju zaposlenog. Moguće postavke: 0 = isključeno, 1 = uključeno, 2 = uključeno i obavezno.',
        'Article free text options shown in the ticket free text screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' => 'Opcije slobodnog teksta članka prikazane na ekranu slobodnog teksta kartice na sučelju zaposlenog. Moguće postavke: 0 = isključeno, 1 = uključeno, 2 = uključeno i obavezno.',
        'Article free text options shown in the ticket note screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' => 'Opcije slobodnog teksta članka prikazane na ekranu napomene kartice na sučelju zaposlenog. Moguće postavke: 0 = isključeno, 1 = uključeno, 2 = uključeno i obavezno.',
        'Article free text options shown in the ticket owner screen of a zoomed ticket in the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' => 'Opcije slobodnog teksta članka prikazane na ekranu vlasnika kartice na sučelju zaposlenog pri uvećanom prikazu. Moguće postavke: 0 = isključeno, 1 = uključeno, 2 = uključeno i obavezno.',
        'Article free text options shown in the ticket pending screen of a zoomed ticket in the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' => 'Opcije slobodnog teksta članka prikazane na ekranu čekanja kartice na sučelju zaposlenog pri uvećanom prikazu. Moguće postavke: 0 = isključeno, 1 = uključeno, 2 = uključeno i obavezno.',
        'Article free text options shown in the ticket phone outbound screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' => 'Opcije slobodnog teksta članka prikazane na ekranu odlazne telefonske kartice na sučelju zaposlenog. Moguće postavke: 0 = isključeno, 1 = uključeno, 2 = uključeno i obavezno.',
        'Article free text options shown in the ticket priority screen of a zoomed ticket in the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' => 'Opcije slobodnog teksta članka prikazane na ekranu prioriteta kartice na sučelju zaposlenog. Moguće postavke: 0 = isključeno, 1 = uključeno, 2 = uključeno i obavezno.',
        'Article free text options shown in the ticket responsible screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' => 'Opcije slobodnog teksta članka prikazane na ekranu odgovornog za karticu na sučelju zaposlenog. Moguće postavke: 0 = isključeno, 1 = uključeno, 2 = uključeno i obavezno.',
        ...
        'Checks MX recordes of used email addresses by composing an answer. Don\'t use CheckMXRecord if your OTRS machine is behind a dial-up line!' => 'Proverite "MX" zapise upotrebljenih adresa E-pošte kreiranjem odgovora. Nemojte koristiti ovu funkciju ako je vaš OTRS server na "dial-up" liniji.',
        ...
        'Defines the default selection of the free key field number 1 for articles (if more than one option is provided).' => 'Određuje zadani izbor slobodnog ključa polja broj 1 za članke (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free key field number 1 for tickets (if more than one option is provided).' => 'Određuje zadani izbor slobodnog ključa polja broj 1 za karticue (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free key field number 10 for tickets (if more than one option is provided).' => 'Određuje zadani izbor slobodnog ključa polja broj 10 za karticue (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free key field number 11 for tickets (if more than one option is provided).' => 'Određuje zadani izbor slobodnog ključa polja broj 11 za karticue (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free key field number 12 for tickets (if more than one option is provided).' => 'Određuje zadani izbor slobodnog ključa polja broj 12 za karticue (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free key field number 13 for tickets (if more than one option is provided).' => 'Određuje zadani izbor slobodnog ključa polja broj 13 za karticue (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free key field number 14 for tickets (if more than one option is provided).' => 'Određuje zadani izbor slobodnog ključa polja broj 14 za karticue (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free key field number 15 for tickets (if more than one option is provided).' => 'Određuje zadani izbor slobodnog ključa polja broj 15 za karticue (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free key field number 16 for tickets (if more than one option is provided).' => 'Određuje zadani izbor slobodnog ključa polja broj 16 za karticue (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free key field number 2 for articles (if more than one option is provided).' => 'Određuje zadani izbor slobodnog ključa polja broj 2 za članke (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free key field number 2 for tickets (if more than one option is provided).' => 'Određuje zadani izbor slobodnog ključa polja broj 2 za karticue (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free key field number 3 for articles (if more than one option is provided).' => 'Određuje zadani izbor slobodnog ključa polja broj 3 za članke (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free key field number 3 for tickets (if more than one option is provided).' => 'Određuje zadani izbor slobodnog ključa polja broj 3 za karticue (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free key field number 4 for tickets (if more than one option is provided).' => 'Određuje zadani izbor slobodnog ključa polja broj 4 za karticue (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free key field number 5 for tickets (if more than one option is provided).' => 'Određuje zadani izbor slobodnog ključa polja broj 5 za karticue (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free key field number 6 for tickets (if more than one option is provided).' => 'Određuje zadani izbor slobodnog ključa polja broj 6 za karticue (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free key field number 7 for tickets (if more than one option is provided).' => 'Određuje zadani izbor slobodnog ključa polja broj 7 za karticue (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free key field number 8 for tickets (if more than one option is provided).' => 'Određuje zadani izbor slobodnog ključa polja broj 8 za karticue (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free key field number 9 for tickets (if more than one option is provided).' => 'Određuje zadani izbor slobodnog ključa polja broj 9 za karticue (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free text field number 1 for articles (if more than one option is provided).' => 'Određuje zadani izbor slobodnog tekst polja broj 1 za članke (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free text field number 1 for tickets (if more than one option is provided).' => 'Određuje zadani izbor slobodnog tekst polja broj 1 za karticue (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free text field number 10 for tickets (if more than one option is provided).' => 'Određuje zadani izbor slobodnog tekst polja broj 10 za karticue (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free text field number 11 for tickets (if more than one option is provided).' => 'Određuje zadani izbor slobodnog tekst polja broj 11 za karticue (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free text field number 12 for tickets (if more than one option is provided).' => 'Određuje zadani izbor slobodnog tekst polja broj 12 za karticue (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free text field number 13 for tickets (if more than one option is provided).' => 'Određuje zadani izbor slobodnog tekst polja broj 13 za karticue (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free text field number 14 for tickets (if more than one option is provided).' => 'Određuje zadani izbor slobodnog tekst polja broj 14 za karticue (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free text field number 15 for tickets (if more than one option is provided).' => 'Određuje zadani izbor slobodnog tekst polja broj 15 za karticue (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free text field number 16 for tickets (if more than one option is provided).' => 'Određuje zadani izbor slobodnog tekst polja broj 16 za karticue (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free text field number 2 for articles (if more than one option is provided).' => 'Određuje zadani izbor slobodnog tekst polja broj 2 za članke (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free text field number 2 for tickets (if more than one option is provided).' => 'Određuje zadani izbor slobodnog tekst polja broj 2 za karticue (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free text field number 3 for articles (if more than one option is provided).' => 'Određuje zadani izbor slobodnog tekst polja broj 3 za članke (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free text field number 3 for tickets (if more than one option is provided).' => 'Određuje zadani izbor slobodnog tekst polja broj 3 za karticue (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free text field number 4 for tickets (if more than one option is provided).' => 'Određuje zadani izbor slobodnog tekst polja broj 4 za karticue (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free text field number 5 for tickets (if more than one option is provided).' => 'Određuje zadani izbor slobodnog tekst polja broj 5 za karticue (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free text field number 6 for tickets (if more than one option is provided).' => 'Određuje zadani izbor slobodnog tekst polja broj 6 za karticue (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free text field number 7 for tickets (if more than one option is provided).' => 'Određuje zadani izbor slobodnog tekst polja broj 7 za karticue (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free text field number 8 for tickets (if more than one option is provided).' => 'Određuje zadani izbor slobodnog tekst polja broj 8 za karticue (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free text field number 9 for tickets (if more than one option is provided).' => 'Određuje zadani izbor slobodnog tekst polja broj 9 za karticue (ako ima više od jedne mogućnosti).',
        'Defines the free key field number 1 for tickets to add a new ticket attribute.' => 'Određuje slobodno polje ključa broj 1 za karticue radi dodavanja novog atributa kartice.',
        ...
        'Defines the free text field number 1 for tickets to add a new ticket attribute.' => 'Određuje slobodno tekst polje broj 1 za karticue radi dodavanja novog atributa kartice.',
        'Defines the free text field number 10 for tickets to add a new ticket attribute.' => 'Određuje slobodno tekst polje broj 10 za karticue radi dodavanja novog atributa kartice.',
        'Defines the free text field number 11 for tickets to add a new ticket attribute.' => 'Određuje slobodno tekst polje broj 11 za karticue radi dodavanja novog atributa kartice.',
        'Defines the free text field number 12 for tickets to add a new ticket attribute.' => 'Određuje slobodno tekst polje broj 12 za karticue radi dodavanja novog atributa kartice.',
        'Defines the free text field number 13 for tickets to add a new ticket attribute.' => 'Određuje slobodno tekst polje broj 13 za karticue radi dodavanja novog atributa kartice.',
        'Defines the free text field number 14 for tickets to add a new ticket attribute.' => 'Određuje slobodno tekst polje broj 14 za karticue radi dodavanja novog atributa kartice.',
        'Defines the free text field number 15 for tickets to add a new ticket attribute.' => 'Određuje slobodno tekst polje broj 15 za karticue radi dodavanja novog atributa kartice.',
        'Defines the free text field number 16 for tickets to add a new ticket attribute.' => 'Određuje slobodno tekst polje broj 16 za karticue radi dodavanja novog atributa kartice.',
        ...
        'Defines the free text field number 2 for tickets to add a new ticket attribute.' => 'Određuje slobodno tekst polje broj 2 za karticue radi dodavanja novog atributa kartice.',
        ...
        'Defines the free text field number 3 for ticket to add a new ticket attribute.' => 'Određuje slobodno tekst polje broj 3 za karticue radi dodavanja novog atributa kartice.',
        'Defines the free text field number 4 for tickets to add a new ticket attribute.' => 'Određuje slobodno tekst polje broj 4 za karticue radi dodavanja novog atributa kartice.',
        'Defines the free text field number 5 for tickets to add a new ticket attribute.' => 'Određuje slobodno tekst polje broj 5 za karticue radi dodavanja novog atributa kartice.',
        'Defines the free text field number 6 for tickets to add a new ticket attribute.' => 'Određuje slobodno tekst polje broj 6 za karticue radi dodavanja novog atributa kartice.',
        'Defines the free text field number 7 for tickets to add a new ticket attribute.' => 'Određuje slobodno tekst polje broj 7 za karticue radi dodavanja novog atributa kartice.',
        'Defines the free text field number 8 for tickets to add a new ticket attribute.' => 'Određuje slobodno tekst polje broj 8 za karticue radi dodavanja novog atributa kartice.',
        'Defines the free text field number 9 for tickets to add a new ticket attribute.' => 'Određuje slobodno tekst polje broj 9 za karticue radi dodavanja novog atributa kartice.',
        ...
        'Defines the http link for the free text field number 1 for tickets (it will be used in every ticket view).' => 'Određuje "http" vezu za polje slobodnog teksta broj 1 za karticue (biše korišteno u svakom pregledu kartice).',
        'Defines the http link for the free text field number 10 for tickets (it will be used in every ticket view).' => 'Određuje "http" vezu za polje slobodnog teksta broj 10 za karticue (biše korišteno u svakom pregledu kartice).',
        'Defines the http link for the free text field number 11 for tickets (it will be used in every ticket view).' => 'Određuje "http" vezu za polje slobodnog teksta broj 11 za karticue (biše korišteno u svakom pregledu kartice).',
        'Defines the http link for the free text field number 12 for tickets (it will be used in every ticket view).' => 'Određuje "http" vezu za polje slobodnog teksta broj 12 za karticue (biše korišteno u svakom pregledu kartice).',
        'Defines the http link for the free text field number 13 for tickets (it will be used in every ticket view).' => 'Određuje "http" vezu za polje slobodnog teksta broj 13 za karticue (biše korišteno u svakom pregledu kartice).',
        'Defines the http link for the free text field number 14 for tickets (it will be used in every ticket view).' => 'Određuje "http" vezu za polje slobodnog teksta broj 14 za karticue (biše korišteno u svakom pregledu kartice).',
        'Defines the http link for the free text field number 15 for tickets (it will be used in every ticket view).' => 'Određuje "http" vezu za polje slobodnog teksta broj 15 za karticue (biše korišteno u svakom pregledu kartice).',
        'Defines the http link for the free text field number 16 for tickets (it will be used in every ticket view).' => 'Određuje "http" vezu za polje slobodnog teksta broj 16 za karticue (biše korišteno u svakom pregledu kartice).',
        'Defines the http link for the free text field number 2 for tickets (it will be used in every ticket view).' => 'Određuje "http" vezu za polje slobodnog teksta broj 2 za karticue (biše korišteno u svakom pregledu kartice).',
        'Defines the http link for the free text field number 3 for tickets (it will be used in every ticket view).' => 'Određuje "http" vezu za polje slobodnog teksta broj 3 za karticue (biše korišteno u svakom pregledu kartice).',
        'Defines the http link for the free text field number 4 for tickets (it will be used in every ticket view).' => 'Određuje "http" vezu za polje slobodnog teksta broj 4 za karticue (biše korišteno u svakom pregledu kartice).',
        'Defines the http link for the free text field number 5 for tickets (it will be used in every ticket view).' => 'Određuje "http" vezu za polje slobodnog teksta broj 5 za karticue (biše korišteno u svakom pregledu kartice).',
        'Defines the http link for the free text field number 6 for tickets (it will be used in every ticket view).' => 'Određuje "http" vezu za polje slobodnog teksta broj 6 za karticue (biše korišteno u svakom pregledu kartice).',
        'Defines the http link for the free text field number 7 for tickets (it will be used in every ticket view).' => 'Određuje "http" vezu za polje slobodnog teksta broj 7 za karticue (biše korišteno u svakom pregledu kartice).',
        'Defines the http link for the free text field number 8 for tickets (it will be used in every ticket view).' => 'Određuje "http" vezu za polje slobodnog teksta broj 8 za karticue (biše korišteno u svakom pregledu kartice).',
        'Defines the http link for the free text field number 9 for tickets (it will be used in every ticket view).' => 'Određuje "http" vezu za polje slobodnog teksta broj 9 za karticue (biše korišteno u svakom pregledu kartice).',
        ...
        'Don\'t work with UserID 1 (System account)! Create new users!' => 'Molimo da ne koristite "UserID 1" (račun sustava) za rad! Kreirajte korisničke račune!',
        ...
        'If a ticket is closed and the customer sends a follow up the ticket will be locked for the old owner.' => 'Ako je karticu zatvoren, a korisnik pošalje nastavak, karticu će biti zaključan za starog vlasnika.',
        'If a ticket will not be answered in this time, just only this ticket will be shown.' => 'Ako neće biti odgovoreno na karticu u ovom vremenu, onda će samo ovaj karticu biti prikazan.',
        'If an agent locks a ticket and he/she will not send an answer within this time, the ticket will be unlock automatically. So the ticket is viewable for all other agents.' => 'Ako zaposlenik zaključa karticu i ne odgovori za ovo vrijeme, kartica će automatski biti otključana. Ta kartica je onda vidljiva svim drugim zaposlenicima.',
        'If nothing is selected, then there are no permissions in this group (tickets will not be available for the user).' => 'Ako ništa nije izabrano, onda nema ni dozvola u ovoj grupi (kartice neće biti dostupni za korisnika).',
        ...
        'Login failed! Your username or password was entered incorrectly.' => 'Neuspješna prijava! Vaše korisničko ime i/ili lozinka su netočno unijeti.',
        'Lookup' => 'Pronalaženje',
        ...
        'OTRS sends an notification email to the customer if the ticket is moved.' => 'OTRS šalje obaveštenje korisniku ako je karticu premešten.',
        'OTRS sends an notification email to the customer if the ticket owner has changed.' => 'OTRS šalje obavijest korisniku ako je promijenjen vlasnik kartice.',
        'OTRS sends an notification email to the customer if the ticket state has changed.' => 'OTRS šalje E-poštu sa obaveštenjem korisniku ukoliko se promijeni status kartice.',
        ...
        'Send me a notification if a customer sends a follow up and I\'m the owner of this ticket.' => 'Obavijesti me ukoliko korisnik pošalje nastavak, a ja sam vlasnik ove kartice.',
        'Sent new password to: ' => 'Pošalji novu lozinku za: ',
        'Sent new password to: %s' => 'Poslata nova lozinka za %s.',
        'Sent password reset instructions to %s. Please check your email.' => 'Uputa za reset lozinke poslana za %s. Molimo provjerite vašu E-poštu.',
        ...
        'Site' => 'Stranica',
        'Solution' => 'Rješenje',
        'Some result formats are disabled because at least one needed package is not installed. Please contact your administrator.' => 'Neki su formati rezultata onemogućeni jer neki od paketa nije instaliran. Molimo kontaktirajte vašeg administratora.',
        ...
        'Take care that you also updated the default states in you Kernel/Config.pm!' => 'Nemojte zaboraviti ažurirati i zadane statuse u "Kernel/Config.pm" datoteci!',
        ...
        'The identify of the system. Each ticket number and each http session id starts with this number.' => 'Identitet sistema. Svaki broj kartice i svaki ID "HTTP" sesije počinje sa ovim brojem.',
        ...
        'This email address already exists. Please log in or reset your password..' => 'Ova adresa E-pošte već postoji. Molimo, prijavite se ili resetujte vašu lozinku',
        ...
        'Warning! This tickets will be removed from the database! This tickets are lost!' => 'Pažnja! Ovi kartice će biti uklonjeni iz baze i trajno izgubljeni!',
        ...
        'With the input and select fields you can configurate the stat at your needs. Which elements of a stat you can edit depends on your stats administrator who configurated the stat.' => 'Unosom i izborom polja možete konfigurirati statistiku prema vašim potrebama. Koje elemente statistike možete mijenjati ovisi o konfiguraciji statistike.',
        'Workflow Groups' => 'Grupe pravilnika rada',
        'Yes, save it with name' => 'Da, sačuvaj sa imenom',
        'You as the customer have the ability to let us support staff people jump around as you wish because it\'s all about you. We stop eating if you wish us to do. Your way to communicate with us is this thing called \'ticket\'. Please command us.' => 'Bi kao korisnik imate privilegiju da budete u centru pažnje osoblja tehničke podrške. Učinićemo sve kako bi Vi bili zadovoljni. Način da efikasno komunicirate s nama je ova stvar koja se zove "kartica". Molimo vas, prenesite nam Vaš problem.',
        ...
        'Your email with ticket number "<OTRS_TICKET>" is bounced to "<OTRS_BOUNCE_TO>". Contact this address for further information.' => 'Vaša E-pošta sa karticom broj "<OTRS_TICKET>" je preusmjerena za "<OTRS_BOUNCE_TO>". Tamo ćete pronaći dodatne informacije.',
        'Your own Ticket' => 'Vaš karticu',
        'Your way to communicate with us is this thing called \'ticket\'.' => 'Vaš način komuniciranja s nama je ova stvar zvana "kartica".',
