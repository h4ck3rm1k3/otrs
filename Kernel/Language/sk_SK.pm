...
# --
# $Id: sk_SK.pm,v 1.85 2011/12/02 07:30:50 mg Exp $
# --
...
sub Data {
    ...
    # $$START$$
    # Last translation file sync: 2011-12-02 08:27:20
    ...
    $Self->{Translation} = {
        ...
        'Ak je požiadavka zatvorená a klient pošle nasledujúcu požiadavku =>  požiadavka bude zamknutá pre starého majiteľa.' => 'Will be the sender address of this queue for email answers.',
        'Ak je váš účet ' => 'PostMaster Filter Management',
        'Ak nebude na požiadavku odpovedané do určitého času =>  bude táto požiadavka zobrazená!' => 'If a ticket is closed and the customer sends a follow up the ticket will be locked for the old owner.',
        'Ak používate RegExp =>  môžete tiež používať prepojené hodnoty v () ako [***] v \'Set\'.' => 'Queue <-> Auto Responses Management',
        'Ak zástupca uzamkne požiadavku a on/ona nepošle odpoveď do určitého času =>  bude požiadavka automaticky odomknutá a tak zobraziteľná pre všetkých zástupcov.' => 'If a ticket will not be answered in this time =>  just only this ticket will be shown.',
        ...
        'Fulltextové vyhľadávanie v článku (napr. Mar*in" alebo "Baue*")"' => '(e. g. 10*5155 or 105658*)',
        ...
        'Možnosti aktuálneho používateľa =>  ktorý požaduje tieto akcie (napr. <OTRS_CURRENT_UserFirstname>)' => 'Options of the current customer user data (e. g. <OTRS_CUSTOMER_DATA_UserFirstname>)',
        'Možnosti majiteľa požiadavky (napr. <OTRS_OWNER_UserFirstname>)' => 'Options of the current user who requested this action (e. g. <OTRS_OWNER_UserFirstname>)',
        'Možnosti údajov aktuálnohe klientského užívateľa (napr. <OTRS_CUSTOMER_DATA_UserFirstname>)' => 'Package Manager',
        'Musíte napísať emailovú adresu (napr. klient@príklad.com) do Príjemca:!' => 'Bounce ticket',
        ...
        'OTRS posiela klientom oznámenie e-mailom =>  ak bola požiadavka premiestnená.' => 'OTRS sends an notification email to the customer if the ticket state has changed.',
        'OTRS posiela klientom oznámenie e-mailom =>  ak sa zmenil majiteľ požiadavky.' => 'Responses <-> Queue Management',
        'OTRS posiela klientom oznámenie e-mailom =>  ak sa zmenil stav požiadavky.' => 'OTRS sends an notification email to the customer if the ticket owner has changed.',
        ...
        'Povolenie zmeniť majiteľa požiadavky v tejto skupine/rade.' => 'priority',
        'Povolenie zmeniť prioritu požiadavky v tejto skupine/rade.' => 'Role',
        'Pozdrav pre e-mailovú odpoveď.' => 'The signature for email answers.',
        'Pozor! Táto požiadavka bude vymazaná z databázy. Tieto požiadavky sú stratené!' => 'Modules',
        ...
        'Reakcia je prednastavený text pre rýchlejšie písanie odpovedí klientom.' => 'Don\'t forget to add a new response a queue!',
        ...
        'Týmto spôsobom možene priamo meniť osvedčenie a osobný kľúč v systéme súborov.' => 'System State Management',
        ...
        'Verzia' => 'Vendor',
        'Vitajte v %' => 'of',
        'Vybaviť =>  alebo filtrovať prichádzujúce e-maly =>  na báze e-mailu X-header! Reg-Exp je tiež možný!' => 'If you use RegExp =>  you also can use the matched value in () as [***] in \'Set\'.',
        ...
        'Vytvoriť funkciu a dať ju do skupiny. Potom pridať funkciu užívateľom.' => 'It\'s useful for a lot of users and groups.',
        'Vytvoriť odpoveď na požiadavku.' => 'Attach',
        'Vytvoriť v rade.' => 'Output',
        'Vytvoriť účet' => 'Welcome %s',
        'Váš e-mail s číslom požiadavky <OTRS_POŽIADAVKA> je pripojený k <OTRS_PRIPOJIŤ_K_POŽIADAVKE>' => 'Queue ID',
        'Výsledok z' => 'Save Search-Profile as Template?',
        'Všetky požiadavky' => 'Queues',
        'Všetky prichádzajúce e-maily s jedným účtom budú vybavené vo vybranom rade.' => 'If your account is trusted =>  the already existing x-otrs header at arrival time (for priority =>  ...) will be used! PostMaster filter will be used anyway.',
        'Všetky prichádzajúce e-maily s príjemcom =>  budú vybavené v radoch.' => 'User Management',
