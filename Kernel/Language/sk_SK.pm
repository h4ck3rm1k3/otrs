...
# --
# $Id: sk_SK.pm,v 1.24 2007/10/02 10:45:42 mh Exp $
# --
...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'The recommended charset for your language is %s!' =>
            'Odporúèaná znaková sada pre vá¹ jazyk je %',
        'Passwords doesn\'t match! Please try it again!' =>
            'Heslá sa nezhoduju! Prosím skúste znova!',
        'Password is already in use! Please use an other password!' =>
            'Heslo je u¾ pou¾ívané. Prosím pou¾ite iné heslo!',
        ...
        'There is no account with that login name.' =>
            'Neexistuje ¾iadny úèet s týmto ú¾ívateµským menom',
        'Login failed! Your username or password was entered incorrectly.' =>
            'Prihlásenie zlyhalo! Va¹e pou¾ívateµské meno alebo heslo bolo vlo¾ené nesprávne.',
        'Please contact your admin' => 'Prosím kontaktujte vá¹ho administrátora.',
        'Logout successful. Thank you for using OTRS!' =>
            'Odhlásenie úspe¹né. Ïakujeme za pou¾ívanie ORTS!',
        ...
        'Don\'t work with UserID 1 (System account)! Create new users!' =>
            'Nepracujte s pou¾ívateµským èíslom 1 (systémový úèet)! Vytvorte nového pou¾ívateµa.',
        ...
        'Session has timed out. Please log in again.' =>
            'Relácia timeout. Prosím =>  prihláste sa znova.',
        ...
        'Max. shown Tickets a page in Overview.' =>
            'Maximálny poèet po¾iadaviek zobrazovaných v prehµade.',
        ...
        'This message was written in a character set other than your own.' =>
            'Táto správa bola napísaná v inej znakovej sade =>  ako je va¹a.',
        ...
        'Send me a notification if a customer sends a follow up and I\'m the owner of this ticket.'
            => 'Po¹li mi oznámenie =>  ak klient po¹le overenie a ja som vlastník tejto po¾iadavky.',
        'Ticket lock timeout notification' => 'Po¾iadavka blokuje èasový limit oznámenia.',
        'Send me a notification if a ticket is unlocked by the system.' =>
            'Po¹li mi oznámenie =>  ak je po¾iadavka odblokovaná systémom.',
        'Move notification' => 'Premiestni hlásenie',
        'Send me a notification if a ticket is moved into one of "My Queues".' => '',
        'Your queue selection of your favourite queues. You also get notified about those queues via email if enabled.'
            => 'Vá¹ výber z obµúbených radov. Tie¾ mô¾ete by» oboznámený s po¾iadavkou cez e-mail =>  ak je to mo¾né.',
        'Custom Queue'            => 'Klientské rady.',
        'QueueView refresh time'  => '?',
        'Screen after new ticket' => 'Okno po novej po¾iadavke.',
        'Select your screen after creating a new ticket.' =>
            'Vyberte si okno zobrazujúce sa po vytvorení novej po¾iadavky.',
        ...
        'Read only access to the ticket in this group/queue.' =>
            'Èítaj iba prístup k po¾iadavkám v tejto skupine/rade.',
        'rw'                                                             => '',
        ...
        'Don\'t forget to add a new user to groups and/or roles!' =>
            'Nezabudnite prida» nového pou¾ívateµa do skupín a/alebo úloh!',
        ...
        'Set customer user and customer id of a ticket' =>
            'Nastavi» klientského u¾ívateµa a klientské id po¾iadavky',
        ...
        '(The identify of the system. Each ticket number and each http session id starts with this number)'
            => 'Identifikácia systému. Ka¾dé èíslo po¾iadavky a ka¾dá http zaèína týmto èíslo.',
        'System FQDN'                                 => '',
        ...
        '(Logfile just needed for File-LogModule!)' =>
            'Súbor záznamov je potrebný pre Súbor Log Module!',
        ...
        'Hlásenia sú poslané zástupcovi alebo zákazníkovi.' =>
            'Config options (e. g. <OTRS_CONFIG_HttpType>)',
        'Náhµad'          => 'Download',
        ...
        'Skupiny'     => 'Misc',
        'DB Host'     => 'DB ',
        'Vá¹ e-mail s èíslom po¾iadavky <OTRS_PO®IADAVKA> je pripojený k <OTRS_PRIPOJI«_K_PO®IADAVKE>'
            => 'Queue ID',
        'mo¾nosti konfigurácie (napr. <OTRS_CONFIG_HttpType>)' =>
            'Ticket owner options (e. g. <OTRS_OWNER_UserFirstname>)',
        'Meno'                        => 'Lastname',
        'Stiahnu»'                    => 'Rebuild',
        'bit'                         => 'Key',
        ...
        'Chyba pravopisu'                      => 'or',
        'Can\'t update password =>  need min. 1 digit!' =>
            'Nemo¾no aktualizova» heslo =>  potrebujete minimálne 1 èíslicu.',
        'Hodnota' => 'Set',
        'Can\'t update password =>  passwords doesn\'t match! Please try it again!' =>
            'Nemo¾no aktualizova» heslo =>  heslá nezhodujú.',
        ...
        'Can\'t update password =>  need min. 8 characters!' =>
            'Nemo¾no aktualizova» heslo =>  potrebujete minimálne 8 písmen.',
        'Ak zástupca uzamkne po¾iadavku a on/ona nepo¹le odpoveï do urèitého èasu =>  bude po¾iadavka automaticky odomknutá a tak zobraziteµná pre v¹etkých zástupcov.'
            => 'If a ticket will not be answered in this time =>  just only this ticket will be shown.',
        'poèet úderov'                                  => 'Site',
        ...
        'ID radu'                                       => 'Move Ticket',
        'OTRS posiela klientom oznámenie e-mailom =>  ak bola po¾iadavka premiestnená.' =>
            'OTRS sends an notification email to the customer if the ticket state has changed.',
        'èas'                                         => 'Users',
        ...
        'Can\'t update password =>  need 2 lower and 2 upper characters!' =>
            'Nemo¾no aktualizova» heslo =>  potrebujete 2 malé a 2 veµké písmená',
        ...
        'prednastavený'                      => 'Prio',
        'hlásenie majiteµa klienta' =>
            'If an agent locks a ticket and he/she will not send an answer within this time =>  the ticket will be unlock automatically. So the ticket is viewable for all other agents.',
        'OTRS posiela klientom oznámenie e-mailom =>  ak sa zmenil stav po¾iadavky.' =>
            'OTRS sends an notification email to the customer if the ticket owner has changed.',
        'Spusti!'                          => 'x',
        ...
        'Send me a notification if a ticket is moved into one of My Queues"."' =>
            'Po¹li mi oznámenie =>  ak je po¾iadavka premiestnená do jedného z mojich radov.',
        ...
        'ArticleID'              => 'ID èlánku',
        'Mo¾nosti majiteµa po¾iadavky (napr. <OTRS_OWNER_UserFirstname>)' =>
        ...
        '(Ticket identifier. Some people want to set this to e. g. \'Ticket#\',\'Call#\' or \'MyTicket#\')'
            => '(Identifikátor po¾iadavky. Niektorí µudia to chcú nastavi» napríklad: \'Ticket#\', \'Call#\' alebo \'MyTicket#\')',
        ...
        'Options of the ticket data (e. g. <OTRS_TICKET_Number> =>  <OTRS_TICKET_ID> =>  <OTRS_TICKET_Queue> =>  <OTRS_TICKET_State>)'
            => 'Mo¾nosti údajov po¾iadavky (napr. <OTRS_TICKET_Number> =>  <OTRS_TICKET_ID> =>  <OTRS_TICKET_Queue> =>  <OTRS_TICKET_State>)',
        ...
        'This window must be called from compose window' =>
            'Toto okno musí by» vyvolané z okna na vytváranie.',
        'Zamknú»'                            => 'Traceback',
        'You need min. one selected Ticket!' => '',
        'Vybavi» =>  alebo filtrova» prichádzujúce e-maly =>  na báze e-mailu X-header! Reg-Exp je tie¾ mo¾ný!'
            => 'If you use RegExp =>  you also can use the matched value in () as [***] in \'Set\'.',
        ...
        'pozri aj'                                                           => 'SysConfig',
        'Ak je po¾iadavka zatvorená a klient po¹le nasledujúcu po¾iadavku =>  po¾iadavka bude zamknutá pre starého majiteµa.'
            => 'Will be the sender address of this queue for email answers.',
        ...
        'Send me a notification if there is a new ticket in My Queues"."' =>
            'Po¹li mi notifikáciu =>  ak je nová po¾iadavka v MyQueue ?',
        'Rie¹enie' => 'Modified',
        'Don\'t forget to add a new user to groups!' =>
            'Nezabudnite prida» nového pou¾ívateµa do skupín!',
        'Ak pou¾ívate RegExp =>  mô¾ete tie¾ pou¾íva» prepojené hodnoty v () ako [***] v \'Set\'.'
            => 'Queue <-> Auto Responses Management',
        ...
        'If nothing is selected =>  then there are no permissions in this group (tickets will not be available for the user).'
            => 'Ak nie je niè vybrané =>  nie je dovolené pracova» v tejto skupine (po¾iadavky nie sú dostupné pre u¾ívateµa)',
        ...
        'Pozor! Táto po¾iadavka bude vymazaná z databázy. Tieto po¾iadavky sú stratené!' =>
            'Modules',
        'profil'                                              => 'Search-Template',
        'Config options (e. g. &lt;OTRS_CONFIG_HttpType&gt;)' => '',
        'Posla»'                                              => 'GenericAgent',
        'Mo¾nosti údajov aktuálnohe klientského u¾ívateµa (napr. <OTRS_CUSTOMER_DATA_UserFirstname>)'
            => 'Package Manager',
        ...
        'Správa skupín' =>
            'The admin group is to get in the admin area and the stats group to get stats area.',
        'Fulltextové vyhµadávanie v èlánku (napr. Mar*in" alebo "Baue*")"' =>
            '(e. g. 10*5155 or 105658*)',
        'kill all sessions'                 => '',
        'to get the from line of the email' => 'zobrazi» ',
        '¾iadna * nie je mo¾ná'             => 'Search Result',
        'kµúè'                              => 'Fingerprint',
        'OTRS posiela klientom oznámenie e-mailom =>  ak sa zmenil majiteµ po¾iadavky.' =>
            'Responses <-> Queue Management',
        'V¹etky prichádzajúce e-maily s jedným úètom budú vybavené vo vybranom rade.' =>
            'If your account is trusted =>  the already existing x-otrs header at arrival time (for priority =>  ...) will be used! PostMaster filter will be used anyway.',
        ...
        'Mo¾nosti aktuálneho pou¾ívateµa =>  ktorý po¾aduje tieto akcie (napr. <OTRS_CURRENT_UserFirstname>)'
            => 'Options of the current customer user data (e. g. <OTRS_CUSTOMER_DATA_UserFirstname>)',
        'Text poznámky'               => 'Close type',
        'parameter 5'                 => 'Param 6',
        'zobrazenie stavu po¾iadavky' => 'Open Tickets',
        'Can\'t update password =>  invalid characters!' =>
            'Nemo¾no aktualizova» heslo =>  neplatné znaky.',
        '(pracovná jednotka)'     => 'A message must be spell checked!',
        'stupòovanie po¾iadaviek' => 'Your own Ticket',
        'Sajné'                   => 'Hash',
        'výber'                   => 'Results',
        'Adresa odosielateµa tohto radu pre e-mailovú odpoveï.' =>
            'The salutation for email answers.',
        ...
        'Ak nebude na po¾iadavku odpovedané do urèitého èasu =>  bude táto po¾iadavka zobrazená!' =>
            'If a ticket is closed and the customer sends a follow up the ticket will be locked for the old owner.',
        ...
        'Musíte napísa» emailovú adresu (napr. klient@príklad.com) do Príjemca:!' =>
            'Bounce ticket',
        ...
        'Vytvori» funkciu a da» ju do skupiny. Potom prida» funkciu u¾ívateµom.' =>
            'It\'s useful for a lot of users and groups.',
