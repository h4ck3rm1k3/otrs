...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'Change your password.' => 'Verander je wachtwoord.',
        ...
        'Login failed! Your user name or password was entered incorrectly.' => 'Inloggen mislukt. Je gebruikersnaam of wachtwoord is niet correct.',
        ...
        'Dear %s,' => 'Geachte %s,',
        'Hello %s,' => 'Beste %s,',
        'This email address already exists. Please log in or reset your password.' => 'Dit e-mail adres bestaat al. Log in of reset je wachtwoord.',
        'New account created. Sent login information to %s. Please check your email.' => 'Nieuw account aangemaakt. Login informatie gestuurd aan %s. Bekijk je e-mail.',
        'Please press Back and try again.' => 'Druk op Terug en probeer opnieuw.',
        'Sent password reset instructions to %s. Please check your email.' => 'Wachtwoord reset instructies zijn verstuurd aan %s. Bekijk je e-mail.',
        'Sent new password to %s. Please check your email.' => 'Nieuw wachtwoord gestuurd aan %s. Bekijk je e-mail.',
        ...
        'Select the separator character used in CSV files (stats and searches). If you don\'t select a separator here, the default separator for your language will be used.' => 'Selecteer het scheidingsteken voor CSV bestanden. Als je geen scheidingsteken kiest, zal het standaard scheidingsteken voor jouw taal gebruikt worden.',
        ...
        'Send new ticket notifications' => 'Stuur een notificatie bij nieuwe tickets',
        'Ticket follow up notification' => 'Stuur een notificatie bij nieuwe reacties',
        ...
        'Send ticket lock timeout notifications' => 'Stuur een notificatie bij het automatisch ontgrendelen van een ticket',
        'Ticket move notification' => 'Stuur een notificatie als een ticket wordt verplaatst',
        ...
        'Send ticket move notifications' => 'Stuur een notificatie bij het verplaatsen van een ticket',
        ...
        'Ticket watch notification' => 'Gevolgde ticket notificaties',
        'Send me the same notifications for my watched tickets that the ticket owners will get.' => 'Stuur mij dezelfde notificaties voor gevolgde tickets die naar ticket eigenaars gaan.',
        'Send ticket watch notifications' => 'Stuur notificaties voor gevolgde tickets',
        'Out Of Office Time' => 'Out of Office periode',
        ...
        'Response' => 'Antwoord',
        'Auto response from' => 'Reply versturen van',
        'Reference' => 'Referentie',
        'You can use the following tags' => 'Je kan de volgende tags gebruiken',
        ...
        'Note' => 'Notitie',
        'Customer will be needed to have a customer history and to login via customer panel.' => 'Klanten zijn nodig om een historie te kunnen inzien en om in te loggen via de klant interface.',
        ...
        'Just use this feature if you want to define group permissions for customers.' => 'Gebuik alleen als je groep-permissies voor klanten wilt gebruiken.',
        ...
        'You can manage these groups via the configuration setting "CustomerGroupAlwaysGroups".' => 'Je kan deze groepen beheren via de optie "CustomerGroupAlwaysGroups".',
        ...
        'Your message was sent to' => 'Je bericht is verstuurd aan',
        ...
        'Send agent/customer notifications on changes' => 'Stuur gebruikers/klanten notificatie bij wijzigingen',
        'CMD' => 'Commando',
        ...
        'Save' => 'Opslaan',
        'Results' => 'Resultaten',
        '%s Tickets affected! What do you want to do?' => '%s tickets gevonden! Wat wil je doen?',
        'Warning: You used the DELETE option. All deleted tickets will be lost!' => 'Waarschuwing: je hebt voor VERWIJDEREN gekozen.',
        ...
        'Filter for Notification' => 'Filter op notificaties',
        'Notifications are sent to an agent or a customer.' => 'Notificaties worden verstuurd naar een gebruiker of een klant',
        'Notification' => 'Notificatie',
        'Edit Notification' => 'Bewerk Notificatie',
        'e. g.' => 'bijv.',
        'Options of the current customer data' => 'Attributen van de klant',

        # Template: AdminNotificationEvent
        'Add notification' => 'Notificatie toevoegen',
        'Delete this notification' => 'Notificatie verwijderen',
        'Add Notification' => 'Notificatie Toevoegen',
        ...
        'Include attachments to notification' => 'Voeg bijlagen toe aan notificatie',
        'To get the first 20 character of the subject (of the latest agent article).' => 'Om de eerste 20 karakters van het onderwerp van de nieuwste agent-interactie te tonen',
        'To get the first 5 lines of the body (of the latest agent article).' => 'Om de eerste vijf regels van de tekst van de nieuwste agent-interactie te tonen',
        ...
        'Do you really want to reinstall this package? Any manual changes will be lost.' => 'Wil je dit pakket echt herinstalleren? Eventuele handmatige aanpassingen gaan verloren.',
        'Continue' => 'Doorgaan',
        'Install' => 'Installeer',
        ...
        'The logfile is too large, you need to reset it' => 'Het logbestand is te groot, je moet het resetten',
        'Range' => 'Bereik',
        'Interface' => 'Interface',
        'Requests' => 'Verzoeken',
        ...
        'If you use Regular Expressions, you also can use the matched value in () as [***] in the \'Set\' action.' => 'Als je regular expressions gebruikt, kan je ook de gematchte waarde tussen haakjes () gebruiken als [***] in de \'Set\' actie.',
        ...
        'Value' => 'Waarde',
        'Set Email Headers' => 'Set E-mail Headers',
        ...
        'Specifies if follow up to closed tickets would re-open the ticket, be rejected or lead to a new ticket.' => 'Bepaalt of follow ups op gesloten tickets zorgen voor heropenen voor het ticket, geweigerd worden, of een nieuw ticket genereren.',
        'Ticket lock after a follow up' => 'Ticket-vergrendeling na een follow up',
        'If a ticket is closed and the customer sends a follow up the ticket will be locked to the old owner.' => 'Als een ticket is gesloten en de klant een follow up stuurt wordt het ticket gekoppeld aan de oude eigenaar.',
        ...
        'Manage Queue-Auto Response Relations' => 'Beheer Wachtrij - Automatische Antwoord koppelingen',
        ...
        'Manage Response-Queue Relations' => 'Beheer Wachtrij - Antwoord koppelingen',
        'Filter' => 'Filter',
        ...
        'Your email address is' => 'Je e-mailadres is',

        # Template: AdminResponseAttachment
        'Manage Responses <-> Attachments Relations' => 'Beheer Antwoord <-> Bijlage',
        'Change %s Relations for %s' => 'Bewerk %s relaties voor %s',
        'Toggle active for all' => 'Actief aan/uit',
        ...
        'If secure mode is not activated, activate it via SysConfig because your application is already running.' => 'Activeer de SecureMode via de Systeemconfiguratie. Het systeem is al geïnstalleerd.',

        # Template: AdminSelectBox
        'SQL Box' => 'SQL Console',
        'Here you can enter SQL to send it directly to the application database.' => 'Hier kan je SQL statements invoeren die direct door de database worden uitgevoerd.',
        ...
        'Agent sessions' => 'Agent-sessies',
        'Customer sessions' => 'Klantsessies',
        'Unique agents' => 'Unieke agents',
        ...
        'Error: this file could not be found.' => 'Fout: dit bestand wordt niet gevonden.',
        'Error: this directory could not be found.' => 'Fout: deze directory wordt niet gevonden.',
        ...
        'go to link delete screen' => 'ga naar koppeling-verwijder-venster',
        ...
        'Edit your preferences' => 'Bewerk je voorkeuren',
        ...
        'Stat#' => 'Rapport#',
        'Do you really want to delete this stat?' => 'Wil je dit rapport echt verwijderen?',
        ...
        'Most of the stats can be cached. This will speed up the presentation of this stat.' => 'De meeste rapporten kunnen worden gecached, dit versnelt het genereren van het rapport.',
        ...
        'Here you can define the value series. You have the possibility to select one or two elements. Then you can select the attributes of elements. Each attribute will be shown as single value series. If you don\'t select any attribute all attributes of the element will be used if you generate a stat, as well as new attributes which were added since the last configuration.' => 'Hier kan je de waarden op de Y-as kiezen. Je kan één of twee elementen kiezen. Vervolgens kan je de getoonde attributen van de elementen kiezen. Ieder attribuut wordt getoond als een eigen waarde. Als je geen waarde kiest worden alle attributen van het element gebruikt bij het genereren van het rapport.',
        ...
        'Here you can define the x-axis. You can select one element via the radio button. If you make no selection all attributes of the element will be used if you generate a stat, as well as new attributes which were added since the last configuration.' => 'Hier kan je de X-as definiëren. Je kan een element kiezen met de radio-button. Als je geen selectie maakt worden alle attributen van het element getoond bij het aanmaken van het rapport.',
        ...
        'With the input and select fields you can influence the format and contents of the statistic.' => 'Met deze velden kan je het formaat en de inhoud van het rapport beïnvloeden.',
        ...
        'Optional' => 'Optioneel',
        'Inform involved Agents' => 'Informeer betrokken agents',
        ...
        'You need a To: recipient!' => 'Je hebt een adres nodig bij Aan:',
        ...
        'Need a valid email address or don\'t use a local email address.' => 'Een e-mail adres is verplicht. Je kan geen lokale adressen gebruiken.',
        'Address book' => 'Adresboek',
        ...
        'Need a valid mail address or don\'t use a local email address.' => 'Een e-mail adres is verplicht. Je kan geen lokale adressen gebruiken.',
        ...
        'You need a to: recipient!.' => 'Je moet een adres invullen bij Aan:',
        'Need a valid email address or don\'t use a local address!' => 'Een e-mail adres is verplicht. Je kan geen lokale adressen gebruiken.',
        ...
        'Email Text Plain View' => 'Rauwe tekst van bericht',
        'Plain' => 'Zonder opmaak',
        ...
        'Incoming message' => 'Binnenkomende interactie',
        'Outgoing message' => 'Uitgaande interactie',
        'Internal message' => 'Intern bericht',
        'Resize' => 'Grootte wijzigen',
        'Show or hide the content.' => 'Toon of verberg de inhoud.',

        # Template: AttachmentBlocker
        'To protect your privacy, active or/and remote content has blocked.' => 'Om je privacy te beschermen is actieve inhoud geblokkeerd.',
        ...
        'Your User Name' => 'Je Gebruikersnaam',
        'A new password will be sent to your email address.' => 'Een nieuw wachtwoord wordt naar je e-mailadres verzonden.',
        'Create Account' => 'Maak account',
        'How we should address you' => 'Hoe moeten we je adresseren?',
        'Your First Name' => 'Je Voornaam',
        'Please supply a first name' => 'Voer je voornaam in',
        'Your Last Name' => 'Je Achternaam',
        'Please supply a last name' => 'Voer je achternaam in',
        'The User Name you wish to have' => 'Je gebruikersnaam naar keuze',
        ...
        'You have not created a ticket yet.' => 'Je hebt nog geen tickets aangemaakt.',
        'You as the customer have the ability to let us support staff people jump around as you wish because it\'s all about you. We stop eating if you wish us to do. Your way to communicate with us is this thing called \'ticket\'. Please command us.' => 'Jij als onze klant hebt de mogelijkheid om alles van ons gedaan te krijgen, het gaat immers om jou. De sleutel is het aanmaken van dat ding wat we \'ticket\' noemen. Maak er eentje.',
        'Create your first Ticket' => 'Maak je eerste ticket aan',
        ...
        # Template: FooterJS
        'If you now leave this page, all open popup windows will be closed, too!' => 'Als je deze pagina verlaat worden alle openstaande popup-vensters ook gesloten.',
        ...
        # Template: Header
        'You are logged in as' => 'Je bent ingelogd als',

        # Template: HeaderSmall

        # Template: Installer
        'JavaScript not available' => 'JavaScript is niet beschikbaar',
        'In order to experience OTRS, you\'ll need to enable JavaScript in your browser.' => 'Om OTRS te kunnen gebruiken, moet JavaScript geactiveerd zijn in je browser.',
        ...
        'Does your SMTP host need authentication?' => 'Heeft je SMTP host authenticatie nodig?',
        ...
        'If you want to install OTRS on another database type, please refer to the file README.database.' => 'Als je OTRS op een ander DBMS wilt installeren, kijk in README.database voor instructies.',
        ...
        'Email addresses that are manually entered are checked against the MX records found in DNS. Don\'t use this option if your DNS is slow or does not resolve public addresses.' => 'E-mailadressen die handmatig worden ingevoerd worden gecontroleerd tegen de MX records uit DNS. Niet gebruiken als je DNS traag is of geen publieke adressen kan resolven.',
        ...
        'The browser you are using is too old.' => 'Je browser is te oud.',
        'OTRS runs with a huge lists of browsers, please upgrade to one of these.' => 'OTRS kan overweg met een grote hoeveelheid browsers. Gebruik een van deze.',
        'Please see the documentation or ask your admin for further information.' => 'Zie de documentatie of vraag je beheerder voor meer informatie.',
        ...
        'Link auto responses to queues.' => 'Koppel automatische antwoorden aan wachtrijen.',
        ...
        'Types' => 'Typen',
        'Update and extend your system with software packages.' => 'Voeg features toe aan je systeem door het installeren van pakketten.',
