...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'With the input and select fields you can influence the format and contents of the statistic.' => 'Met deze velden kunt u het formaat en de inhoud van het rapport beënvloeden.',
