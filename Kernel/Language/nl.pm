...
# --
# $Id: nl.pm,v 1.152.2.8 2011/06/30 18:55:07 mb Exp $
# --
...
use vars qw($VERSION);
$VERSION = qw($Revision: 1.152.2.8 $) [1];
...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'New message!' => 'Nieuw bericht.',
        'Please answer this ticket(s) to get back to the normal queue view!' => 'Beantwoord eerst onderstaande ge�scaleerde tickets om terug te kunnen komen in de normale wachtrij.',
        ...
        'Don\'t use the Superuser account to work with OTRS! Create new Agents and work with these accounts instead.' => 'Werk niet met het SuperUser account. Maak gebruikersaccounts aan.',
        ...
        'Preview' => 'Voorbeeld',
        'Package not correctly deployed! You should reinstall the Package again!' => 'Pakket is niet goed ge�nstalleerd! Installeer het pakket opnieuw.',
        ...
        'Can\'t update password, this password has already been used. Please choose a new one!' => 'Dit wachtwoord is al eerder gebruikt. Kies een nieuw wachtwoord.',
        ...
        'If you use a checkbox you have to select some attributes of the select field!' => 'Als u een attribuut selecteert moet u ook ��n of meerdere waarden van dit attribuut selecteren.',
        ...
        'You have to select one or more attributes from the select field!' => 'Kies ��n of meer attributen.',
        'The selected Date isn\'t valid!' => 'De geselecteerde datum is niet geldig.',
        'Please select only one or two elements via the checkbox!' => 'Kies ��n of meer elementen met de keuzebox.',
        'If you use a time scale element you can only select one element!' => 'Als u een tijdselement kiest kunt u maar ��n element selecteren.',
        ...
        'There are more escalated tickets!' => 'Er zijn nog meer ge�scaleerde tickets.',
        ...
        'Ticket is locked by another agent.' => 'Ticket is vergrendeld door een andere gebruiker.',
        ...
        'Escalated Tickets' => 'Ge�scaleerde tickets',
        ...
        'All escalated tickets' => 'Alle ge�scaleerde tickets',
        ...
        'To enable automatic execution select at least one value from minutes, hours and days!' => 'Om automatisch uit te voeren selecteer ten minste ��n waarde bij minuten, uren en dagen.',
        ...
        'Select a different language' => 'Selecteer een taal',
        ...
        'Uninstall' => 'De�nstalleer',
        'Package not correctly deployed! You should reinstall the package again!' => 'Pakket is niet correct ge�nstalleerd. Installeer het pakket opnieuw.',
        ...
        'If you want to match only the email address, use EMAILADDRESS:info@example.com in From, To or Cc.' => 'Als u alleen wilt filteren op het e-mailadres, gebruik dan EMAILADDRESS:info@example.local in Van, Aan of CC.',
        ...
        'Value' => 'Waarde',
        'The field needs to be a valid regular expression or a literal word.' => 'Het veld moet een geldige regular expression zijn, of een letterlijk woord.',
        ...
        'If there is not added a customer contact, either email-external or phone, to a new ticket before the time defined here expires, the ticket is escalated.' => 'Als er geen klant naam, het externe e-mail of telefoon, bekend is voor de hier ingestelde tijd dan wordt het ticket ge�scaleerd.',
        'If there is an article added, such as a follow-up via email or the customer portal, the escalation update time is reset. If there is no customer contact, either email-external or phone, added to a ticket before the time defined here expires, the ticket is escalated.' => 'Als er iets wordt toegevoegd aan het ticket, b.v. een reactie per e-mail of via het web, dan zal de escalatie update tijd worden gereset. Als er geen klantencontact plaatsvindt, per e-mail of telefoon, voor de hier gedefini�erde tijd, dan wordt het ticket ge�scaleerd.',
        'If the ticket is not set to closed before the time defined here expires, the ticket is escalated.' => 'Als het ticket niet is afgesloten voor de hier gedefini�erde tijd, dan wordt het ticket ge�scaleerd.',
        ...
        'There are no roles defined. Please use the \'Add\' button to create a new role.' => 'Er zijn geen rollen gedefini�erd. Maak een nieuwe aan.',
        'Add Role' => 'Nieuwe rol',
        ...
        'You can select one or more groups to define access for different agents.' => 'U kunt ��n of meerdere groepen defini�ren die deze rapportage kunnen gebruiken.',
        'Some result formats are disabled because at least one needed package is not installed.' => 'Sommige formaten worden niet getoond omdat de juiste bibliotheken niet zijn ge�nstalleerd. Vraag uw beheerder.',
        'Please contact your administrator.' => 'Neem contact op met uw beheerder.',
        'Graph size' => 'Grootte',
        'If you use a graph as output format you have to select at least one graph size.' => 'Als u een afbeelding als vorm heeft gekozen moet u tenminste ��n grootte selecteren.',
        ...
        'You have the possibility to select one or two elements.' => 'U kunt ��n of twee elementen kiezen.',
        ...
        'Here you can define the x-axis. You can select one element via the radio button.' => 'Hier kunt u de X-as defini�ren. U kunt een element kiezen met de radio-button.',
        ...
        'With the input and select fields you can influence the format and contents of the statistic.' => 'Met deze velden kunt u het formaat en de inhoud van het rapport be�nvloeden.',
        'Exactly what fields and formats you can influence is defined by the statistic administrator.' => 'Welke velden en formaten beschikbaar zijn is gedefini�erd in het rapport zelf.',
        ...
        'Show one article' => 'Toon ��n interactie',
        ...
        'New' => 'Nieuw',
        'A new database user with limited rights will be created for this OTRS system.' => 'Een nieuwe database gebruiker met beperkte permissies wordt aangemaakt voor deze OTRS omgeving.',
        ...
        'Create and manage response templates.' => 'Aanmaken en beheren van voorgedefini�erde antwoorden.',
        ...
        'Overview Escalated Tickets' => 'Overzicht ge�scaleerde tickets',
        ...
        'Send me a notification if a customer sends a follow up and I\'m the owner of the ticket or the ticket is unlocked and is in one of my subscribed queues.' => 'Stuur mij een melding als een reactie op een ticket binnenkomt en ik de eigenaar van het ticket ben, of het ticket ontgrendeld is en in ��n van \'Mijn wachtrijen\' staat.',
        ...
        'A message should have a To: recipient!' => 'Geef teminste ��n geadresseerde (aan:) op.',
        ...
        'All email addresses get excluded on replaying on composing an email.' => 'OTRS zal nooit mail sturen aan alle hier gedefini�erde adressen.',
        ...
        'All tickets which are escalated!' => 'Alle ge�scaleerde tickets',
        ...
        'Here you can define the value series. You have the possibility to select one or two elements. Then you can select the attributes of elements. Each attribute will be shown as single value series. If you don\'t select any attribute all attributes of the element will be used if you generate a stat, as well as new attributes which were added since the last configuration.' => 'Hier kunt u de waarden op de Y-as kiezen. U kunt ��n of twee elementen kiezen. Vervolgens kunt u de getoonde attributen van de elementen kiezen. Ieder attribuut wordt getoond als een eigen waarde. Als u geen waarde kiest worden alle attributen van het element gebruikt bij het genereren van het rapport.',
        'Here you can define the value series. You have the possibility to select one or two elements. Then you can select the attributes of elements. Each attribute will be shown as single value series. If you don\'t select any attribute all attributes of the element will be used if you generate a stat. As well a new attribute is added since the last configuration.' => 'Hier kunt u de Y-as defini�ren. U heeft de mogelijkheid om ��n of twee elementen te selecteren. Daarna kunt u de attributen kiezen. Als u geen attribuut selecteerd zullen alle attributen gebruikt worden.',
        'Here you can define the x-axis. You can select one element via the radio button. If you make no selection all attributes of the element will be used if you generate a stat, as well as new attributes which were added since the last configuration.' => 'Hier kunt u de X-as defini�ren. U kunt een element kiezen met de radio-button. Als u geen selectie maakt worden alle attributen van het element getoond bij het aanmaken van het rapport.',
        'Here you can define the x-axis. You can select one element via the radio button. Then you you have to select two or more attributes of the element. If you make no selection all attributes of the element will be used if you generate a stat. As well a new attribute is added since the last configuration.' => 'Hier kunt u de waarden voor de X-as defini�ren. U kunt een element kiezen via de radiobutton. Daarna kunt u twee of meer attributen van dit element kiezen. Als u g��n selectie maakt worden alle attributen van dit element gebruikt in de rapportage.',
        ...
        'If nothing is selected, then there are no permissions in this group (tickets will not be available for the user).' => 'Als er geen selectie is gemaakt dan zijn er geen permissies voor deze groep (Tickets zullen dus niet beschikbaar zijn voor de gebruiker).',
        ...
        'Permission settings. You can select one or more groups to make the configurated stat visible for different agents.' => 'U kunt ��n of meer groepen selecteren om de rapoorten voor de gebruikers beschikbaar te maken.',
        ...
        'Show' => 'Toon',
        'Solution' => 'Oplossing',
        'Some result formats are disabled because at least one needed package is not installed. Please contact your administrator.' => 'Sommige formaten worden niet getoond omdat de juiste bibliotheken niet zijn ge�nstalleerd. Vraag uw beheerder.',
        ...
        'You need min. one selected Ticket!' => 'Selecteer tenminste ��n ticket.',
