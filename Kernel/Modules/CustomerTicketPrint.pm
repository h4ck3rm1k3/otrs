...
# --
# $Id: CustomerTicketPrint.pm,v 1.19 2008/02/22 19:54:21 martin Exp $
# --
...
sub new {
    ...
    for ( qw(ParamObject DBObject TicketObject LayoutObject LogObject QueueObject ConfigObject MainObject)) {
        if ( !$Self->{$_} ) {
