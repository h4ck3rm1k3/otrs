...
# --
# $Id: AdminDynamicFieldTextArea.pm,v 1.3 2011/08/22 20:09:10 cr Exp $
# --
...
package Kernel::Modules::AdminDynamicFieldTextArea;
...
sub _ShowScreen {
    ...
    $Output .= $Self->{LayoutObject}->Output(
        TemplateFile => 'AdminDynamicFieldTextArea',
        Data         => {
            %Param,
