...
# --
# $Id: AdminGenericInterfaceOperationSolMan.pm,v 1.3 2011/07/08 16:46:35 cr Exp $
# --
...
package Kernel::Modules::AdminGenericInterfaceOperationSolMan;
...
sub _AddAction {
    ...
    my $RedirectURL
        = "Action=AdminGenericInterfaceOperationSolMan;Subaction=Change;WebserviceID=$WebserviceID;";
    $RedirectURL
...
sub _ChangeAction {
    ...
    $OperationConfig->{RemoteSystemGuid}
    ...
    my $RedirectURL
        = "Action=AdminGenericInterfaceOperationSolMan;Subaction=Change;WebserviceID=$WebserviceID;Operation=$GetParam{Operation}";
...
sub _ShowScreen {
    ...
    $TemplateData{RemoteSystemGuid} = $Param{OperationConfig}->{RemoteSystemGuid};
    ...
    $Output .= $Self->{LayoutObject}->Output(
        TemplateFile => 'AdminGenericInterfaceOperationSolMan',
        Data         => {
            %Param,
            %TemplateData,
