...
# --
# $Id: AdminQueue.pm,v 1.54 2009/07/23 18:15:52 martin Exp $
# --
...
sub new {
    ...
    for (qw(ParamObject DBObject QueueObject LayoutObject ConfigObject LogObject MainObject EncodeObject)) {
        if ( !$Self->{$_} ) {
