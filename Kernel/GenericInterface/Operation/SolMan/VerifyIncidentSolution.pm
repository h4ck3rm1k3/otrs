# --
# Kernel/GenericInterface/Operation/SolMan/VerifyIncidentSolution.pm - GenericInterface SolMan VerifyIncidentSolution operation backend
# Copyright (C) 2001-2011 OTRS AG, http://otrs.org/
# --
# $Id: VerifyIncidentSolution.pm,v 1.1 2011/04/14 09:27:31 mg Exp $
# --
...
package Kernel::GenericInterface::Operation::SolMan::VerifyIncidentSolution;
...
Kernel::GenericInterface::Operation::SolMan::RejectIncidentSolution - GenericInterface SolMan VerifyIncidentSolution Operation backend
...
perform VerifyIncidentSolution Operation. This will return the created ticket number.
