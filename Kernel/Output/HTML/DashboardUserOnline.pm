...
# --
# $Id: DashboardUserOnline.pm,v 1.1 2009/07/11 11:33:38 martin Exp $
# --
...
sub Run {
    ...
    my %Summary;
    if ( $Self->{Filter} eq 'Agent' ) {
        $Summary{ 'Customer::Style' } = 'text-decoration:none';
    }
    else {
        $Summary{ 'Agent::Style' } = 'text-decoration:none';
    }
