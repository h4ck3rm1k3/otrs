...
# --
# $Id: auto_build.sh,v 1.51.2.1 2009/01/08 10:56:43 martin Exp $
# --
...
echo "auto_build.sh - build automatically OTRS tar, rpm and src-rpm <\$Revision: 1.51.2.1 $>"
...
mkdir var/packages/
wget 'http://ftp.otrs.org/pub/otrs/packages/Support-1.0.7.opm'
