...
# --
# $Id: auto_build.sh,v 1.102 2011/11/18 10:01:06 mg Exp $
# --
...
echo "auto_build.sh - build automatically OTRS tar, rpm and src-rpm <\$Revision: 1.102 $>"
...
SUPPORT_PACKAGE="http://ftp2.otrs.org/pub/otrs/packages/Support-1.3.1.opm"
