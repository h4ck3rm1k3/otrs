...
# --
# $Id: auto_build.sh,v 1.58 2009/04/07 06:22:12 martin Exp $
# --
...
echo "auto_build.sh - build automatically OTRS tar, rpm and src-rpm <\$Revision: 1.58 $>"
...
mkdir var/packages/
wget 'http://ftp.otrs.org/pub/otrs/packages/Support-1.0.14.opm'
