...
# --
# $Id: auto_build.sh,v 1.51.2.2 2009/01/20 11:58:49 martin Exp $
# --
...
echo "auto_build.sh - build automatically OTRS tar, rpm and src-rpm <\$Revision: 1.51.2.2 $>"
...
mkdir var/packages/
wget 'http://ftp.otrs.org/pub/otrs/packages/Support-1.0.13.opm'
