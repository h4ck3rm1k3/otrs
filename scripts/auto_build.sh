...
# --
# $Id: auto_build.sh,v 1.105 2011/12/02 07:33:23 mg Exp $
# --
...
echo "auto_build.sh - build automatically OTRS tar, rpm and src-rpm <\$Revision: 1.105 $>"
...
SUPPORT_PACKAGE="http://ftp2.otrs.org/pub/otrs/packages/Support-1.3.2.opm"
