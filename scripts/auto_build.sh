...
# --
# $Id: auto_build.sh,v 1.82 2010/11/05 09:40:39 mg Exp $
# --
...
echo "auto_build.sh - build automatically OTRS tar, rpm and src-rpm <\$Revision: 1.82 $>"
...
#RPM_BUILD="rpmbuild"
RPM_BUILD="rpm"
SUPPORT_PACKAGE="http://ftp.otrs.org/pub/otrs/packages/Support-1.2.4.opm"
