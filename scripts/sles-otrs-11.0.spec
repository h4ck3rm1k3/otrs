...
# --
# $Id: sles-otrs-11.0.spec,v 1.1.2.1 2010/02/01 12:56:56 mb Exp $
# --
...
Provides:     otrs
Requires:     perl perl-DBI perl-Net-DNS apache2 apache2-mod_perl mysql mysql-client perl-DBD-mysql procmail perl-libwww-perl perl-ldap perl-ldap-ssl perl-IO-Socket-SSL
Autoreqprov:  on
Release:      01
...
%changelog
* Mon Feb 1 2010 - mb@otrs.org
- Init file for SLES 11