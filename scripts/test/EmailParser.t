...
# --
# $Id: EmailParser.t,v 1.5.2.9 2008/05/22 17:16:43 martin Exp $
# --
...
$Self->Is(
    $Self->{EmailParserObject}->GetCharset(),
    'us-ascii',
    "#9 GetCharset() - ascii charset should be found",
);
...
$Self->Is(
    $MD5,
    '74023dce97d94bfd45e9d3c9b4096b10',
    "#12 md5 body check",
);
...
$MD5 = md5_hex( $Attachments[4]->{Content} ) || '';
$Self->Is(
    $MD5,
    'f287d0dd6d0f90da4ac69348b09ec281',
    "#12 md5 check",
