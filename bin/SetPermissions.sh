...
# --
# $Id: SetPermissions.sh,v 1.23 2004/12/04 18:29:34 martin Exp $
# --
...
echo "SetPermissions.sh <\$Revision: 1.23 $> - set OTRS file permissions"
...
echo "chmod -R og+w $OTRSDEST/Kernel/"
chmod -R og+w $OTRSDEST/Kernel/
